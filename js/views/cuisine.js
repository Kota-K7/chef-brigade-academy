...
const regions = [
  {
    ...
    top: "25%",
    left: "32%",
    desc_fr: "Célèbre pour ses riches pâturages et ses vergers de pommiers. La cuisine normande est dominée par les produits laitiers (beurre doux, crème fraîche double, fromage Camembert) et les pommes, souvent cuisinées avec du cidre ou distillées en Calvados. Plat classique : la Sole Normande (poisson poché à la crème et aux moules).",
    desc_en: "Famous for lush green dairy pastures and apple orchards. Normandy cuisine is defined by heavy cream, raw butter, world-class cheese (Camembert), and apple cooking techniques. Signature dish: Sole Normande.",
    desc_ja: "フランス北西部の沿岸地域。冷涼な気候を活かしたリンゴの栽培（シードル、カルヴァドス）と、フランス最高峰の乳製品（バター、生クリーム、カマンベールチーズ）の産地として高名。魚介類にも恵まれ、料理は生クリームを贅沢に使ったコク深い味付けが特徴です。代表料理：ソール・ノルマンド（舌平目のノルマンディー風煮込み）。"
  },
  {
    id: "reg_bourgogne",
    number: "B",
    ...
    top: "48%",
    left: "58%",
    desc_fr: "Le cœur de la gastronomie classique française et des vins de prestige (pinot noir, chardonnay). Cette région est réputée pour ses viandes de Charolais, ses escargots, et sa moutarde de Dijon. Les sauces sont traditionnellement enrichies de vin rouge réduit. Plats classiques : le Bœuf Bourguignon (ragout de bœuf au vin rouge, lards, champignons) et les Escargots à la persillade.",
    desc_en: "The historic heartland of French wine, Charolais cattle, escargot, and Dijon mustard. Reduced red wine is heavily featured in regional sauces. Signature dishes: Bœuf Bourguignon and Escargots de Bourgogne.",
    desc_ja: "名高き特級ワインと古典フランス料理の中心地。広大な牧草地で育つ最高級のシャロレー牛、ディジョンマスタード、エスカルゴが名産。ワイン煮込み料理の発祥地であり、煮詰めた赤ワインを使った濃厚なソースが基本です。代表料理：ブフ・ブルギニョン（牛肉 of 赤ワイン煮込み）、エスカルゴのブルゴーニュ風（パセリバター焼き）。"
  },
  {
    id: "reg_provence",
    number: "P",
    ...
    top: "80%",
    left: "72%",
    desc_fr: "Région baignée de soleil, influencée par la mer Méditerranée. Contrairement au reste de la France, la cuisine provençale n'utilise presque pas de beurre, mais se base sur l'huile d'olive, l'ail, la tomate, les poivrons, les aubergines et les herbes de Provence (thym, romarin). Plat classique : la Bouillabaisse (soupe de poissons safranée de Marseille).",
    desc_en: "Sun-drenched Mediterranean cooking. Unlike northern France, Provence avoids butter, using olive oil, garlic, fresh tomatoes, zucchini, eggplants, and aromatic wild herbs instead. Signature dish: Bouillabaisse.",
    desc_ja: "地中海に面した温暖な南仏地域。乳製品主体の北部とは対照的に、オリーブオイル、にんにく、トマト、ハーブ類（タイム、ローズマリー）を主役とする、健康的で明るい地中海料理。魚介や夏野菜の旨味を引き出す調理法が魅力です。代表料理：ブイヤベース（プロヴァンス風高級魚スープ）、ラタトゥイユ（夏野菜の煮込み）。"
  },
  {
    id: "reg_alsace",
    number: "A",
    ...
    top: "32%",
    left: "82%",
    desc_fr: "Région située à la frontière allemande, combinant des ingrédients robustes et des vins blancs fruités (Riesling, Gewurztraminer). Elle est célèbre pour ses techniques de salaison, ses charcuteries de porc, et ses flammekueches (tartes flambées). Plat classique : la Choucroute Garnie (chou fermenté mijoté avec du lard, des saucisses et des pommes de terre).",
    desc_en: "Bordering Germany, Alsace combines hearty Germanic staples with dry, aromatic French white wines (Riesling). Noted for curing meats, sausages, and sauerkraut. Signature dish: Choucroute Garnie.",
    desc_ja: "ドイツ国境沿いに位置する北東の地方。地元のリースリング白ワインと合わせる、肉厚な豚肉のスモーク、ハム、自家製ソーセージ、塩漬けキャベツ（シュークルート）が名物。ドイツの質実剛健さとフランスの洗練が融合した独特の郷土料理です。代表料理：シュークルート・ガルニ（キャベツと豚肉・ソーセージの温かい煮込み）。"
  }
];
