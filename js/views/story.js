...
async function renderChapterSelector(container) {
  ...
  // Bind start button
  container.querySelector('.play-episode-btn').addEventListener('click', (e) => {
...
function runSequenceEngine(container, episode) {
  ...
  function startBattle(step) {
    ...
    let enemyHp = step.enemyHp;
    const maxEnemyHp = step.enemyHp;
    let playerHp = 10;
        ...
        battlePane.innerHTML = `
          <div class="battle-defeat">
            ...
            <div style="display: flex; gap: 1rem; margin-top: 1rem; width: 100%;">
              ...
              <button class="action-btn exit-battle-btn" style="flex: 1; background: #374151;">一時退却</button>
            </div>
          </div>
        `;
