(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const m of o.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&r(m)}).observe(document,{childList:!0,subtree:!0});function t(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(n){if(n.ep)return;n.ep=!0;const o=t(n);fetch(n.href,o)}})();let Xe=null,et="",tt=0,De=null,ye=null;function ne(e,a=1){ct(e,a)}function ct(e,a=1,t=null,r=null,n=0){if(!("speechSynthesis"in window)){console.warn("Speech synthesis not supported on this browser.");return}window.speechSynthesis.cancel();const o=e.replace(/["'➔]/g,"").trim();et=o,tt=n,De=t,ye=r;const m=o.substring(n);if(!m.trim()){ye&&ye();return}const i=new SpeechSynthesisUtterance(m);i.lang="fr-FR",i.rate=a;const c=window.speechSynthesis.getVoices().find(p=>p.lang==="fr-FR"||p.lang.startsWith("fr"));c&&(i.voice=c),i.onboundary=p=>{if(p.name==="word"&&De){const y=tt+p.charIndex;De(y,et.length)}},i.onend=()=>{Xe===i&&ye&&ye()},i.onerror=p=>{console.warn("SpeechSynthesis error:",p),ye&&ye()},Xe=i,window.speechSynthesis.speak(i)}function qt(){"speechSynthesis"in window&&window.speechSynthesis.pause()}function At(){"speechSynthesis"in window&&window.speechSynthesis.resume()}function Ne(){"speechSynthesis"in window&&window.speechSynthesis.cancel()}"speechSynthesis"in window&&(window.speechSynthesis.getVoices(),window.speechSynthesis.onvoiceschanged=()=>{window.speechSynthesis.getVoices()});function Pt(){var j,P,d,l,f,_,x;const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Tableau de Bord",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Welcome back, Commis. Here is your kitchen curriculum status.",e.appendChild(t);const r=new Date().toISOString().split("T")[0],n=Object.values(C.srs),o=n.filter(h=>h.dueDate<=r).length,m=n.length,i=document.createElement("div");i.className="dashboard-grid";const u=document.createElement("div");u.style.display="flex",u.style.flexDirection="column",u.style.gap="1.5rem";const c=document.createElement("div");c.className="card",c.style.padding="1.5rem",c.innerHTML=`
  ...
  `,u.appendChild(c);const p=document.createElement("div");p.className="card",p.style.padding="1.5rem";const y=((j=C.meta)==null?void 0:j.featured)||null;p.innerHTML=`
    ...
    `:"<p>No data loaded.</p>"}
  `,y&&p.querySelectorAll(".audio-btn").forEach(h=>{h.addEventListener("click",k=>{k.stopPropagation();const S=k.target.closest(".audio-btn").getAttribute("data-text");ne(S)})}),u.appendChild(p),i.appendChild(u);const s=document.createElement("div");s.style.display="flex",s.style.flexDirection="column",s.style.gap="1.5rem";const b=document.createElement("div");b.className="streak-card",b.innerHTML=`
  ...
  `,s.appendChild(b);const v=document.createElement("div");v.className="card",v.style.padding="1.5rem";const g=((d=(P=C.meta)==null?void 0:P.counts)==null?void 0:d.vocabulary)||0,w=((f=(l=C.meta)==null?void 0:l.counts)==null?void 0:f.grammar)||0,A=((x=(_=C.meta)==null?void 0:_.counts)==null?void 0:x.cuisine)||0;return v.innerHTML=`
  ...
  `,s.appendChild(v),i.appendChild(s),e.appendChild(i),e}function Ie(e){const a=Mt(e);return B[a]||""}function Mt(e){return e?e.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]/g," ").replace(/\s+/g," ").trim():""}const U=(e,a,t)=>`
...
`;function _e(e,a){const t=["L","M","M","J","V","S","D"];let r="";for(let n=0;n<7;n++){const o=24+n*28,m=n===e,i=m?"#e76f51":"#ffffff",u=m?"#ffffff":"#1c2833";r+=`
    ...
    ${r}
  `,a)}function ze(e,a){const t=["Avant-hier","Hier","Aujourd'hui","Demain","Après-demain"],r=["一昨日","昨日","今日","明日","明後日"];let n="";for(let m=0;m<5;m++){const i=25+m*47,u=m===e,c=u?"#e76f51":"#1c2833",p=u?7:4,y=u?8:7,s=u?"#e76f51":"#7f8c8d",b=u?"bold":"normal";n+=`
      <circle cx="${i}" cy="65" r="${p}" fill="${c}" />
      <text x="${i}" y="51" text-anchor="middle" font-size="${y}" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="${b}" fill="${s}">${t[m]}</text>
      <text x="${i}" y="81" text-anchor="middle" font-size="7" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="${b}" fill="${s}">${r[m]}</text>
  ...
  `,"NIGHT (la nuit)")};B.a=B.a;B.à=B.a;B.contre=B.contre;B.derriere=B.derriere;B.derrière=B.derriere;B["a cote de"]=B.a_cote_de;B["a coté de"]=B.a_cote_de;B["à côté de"]=B.a_cote_de;B["en face de"]=B.en_face_de;B["au dessus de"]=B.au_dessus_de;B["au-dessus de"]=B.au_dessus_de;B["au dessous de"]=B.au_dessous_de;B["au-dessous de"]=B.au_dessous_de;B["autour de"]=B.autour_de;B["au milieu de"]=B.au_milieu_de;B["pres de"]=B.pres_de;B["près de"]=B.pres_de;B["loin de"]=B.loin_de;B["jusqu a"]=B.jusqu_a;B["jusqu à"]=B.jusqu_a;B["jusqu'a"]=B.jusqu_a;B["jusqu'à"]=B.jusqu_a;B.lundi=_e(0,"MONDAY (lundi)");B.mardi=_e(1,"TUESDAY (mardi)");B.mercredi=_e(2,"WEDNESDAY (mercredi)");B.jeudi=_e(3,"THURSDAY (jeudi)");B.vendredi=_e(4,"FRIDAY (vendredi)");B.samedi=_e(5,"SATURDAY (samedi)");B.dimanche=_e(6,"SUNDAY (dimanche)");B["avant hier"]=ze(0,"DAY BEFORE YESTERDAY (avant-hier)");B.hier=ze(1,"YESTERDAY (hier)");B["aujourd hui"]=ze(2,"TODAY (aujourd'hui)");B.demain=ze(3,"TOMORROW (demain)");B["apres demain"]=ze(4,"DAY AFTER TOMORROW (après-demain)");B["l apres midi"]=B["apres midi"];function Bt(){var o;const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Vocabulaire Professionnel",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Essential culinary terminology for kitchen brigade communications. Filter by category, tag, or difficulty level.",e.appendChild(t);const r=document.createElement("div");r.className="loading-placeholder",r.innerText="Chargement du vocabulaire... (Loading vocabulary...)",e.appendChild(r);const n=((o=C.settings)==null?void 0:o.targetLevel)||"ALL";return se("knowledge",n).then(()=>{r.remove(),Ft(e,n)}),e}function Ft(e,a){var v,g;const t=((v=C.settings)==null?void 0:v.includeGeneral)||!1,n=(((g=C.db)==null?void 0:g.knowledge)||[]).filter(w=>w.french&&w.japanese).filter(w=>t||w.is_professional),o=["ALL",...new Set(n.map(w=>w.category))],m=["ALL",...new Set(n.flatMap(w=>w.tags||[]))],i=["ALL","A1","A2","B1","B2","C1","C2"];let u="ALL",c="ALL",p=a;const y=document.createElement("div");y.className="card",y.style.padding="1.2rem",y.style.marginBottom="2rem",y.style.display="flex",y.style.flexDirection="column",y.style.gap="1rem",y.innerHTML=`
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
      ...
      <div>
        ...
        <select id="vocab-level-select" style="padding: 0.5rem; font-size: 0.9rem; border-radius: var(--radius-sm); border: 1px solid rgba(0,0,0,0.1); width: 100%; background: var(--color-bg);">
          ${i.map(w=>`<option value="${w}" ${w===p?"selected":""}>${w==="ALL"?"ALL LEVELS":w}</option>`).join("")}
        </select>
      </div>
    </div>
  `,e.appendChild(y);const s=document.createElement("div");s.className="card-grid",e.appendChild(s);function b(){var P;s.innerHTML="";const j=(((P=C.db)==null?void 0:P.knowledge)||[]).filter(d=>d.french&&d.japanese).filter(d=>t||d.is_professional).filter(d=>{const l=u==="ALL"||d.category===u,f=c==="ALL"||d.tags&&d.tags.includes(c),_=p==="ALL"||d.level===p;return l&&f&&_});if(j.length===0){s.innerHTML='<p style="color: var(--color-text-muted); grid-column: 1 / -1; text-align: center; padding: 2rem;">Aucun terme trouvé correspondant à vos critères de filtrage.</p>';return}j.forEach(d=>{const l=document.createElement("div");l.className="card";const f=fe(d.id),_=C.srs[d.id],x=!!_,h=d.examples&&d.examples[0]?d.examples[0].fr:"",k=d.examples&&d.examples[0]?d.examples[0].ja:"",S=Ie(d.french),T=S?`<div class="preposition-illustration-container" style="height: 130px; background-color: #fcfbfa; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; margin: 0.8rem 0; overflow: hidden; border: 1px solid rgba(0,0,0,0.03);">${S}</div>`:"";let L="";if(d.gender){const z=d.gender==="m"?"Masculin":d.gender==="f"?"Féminin":d.gender==="m/f"?"M/F":d.gender;L=`<span style="font-size: 0.72rem; font-weight: 600; padding: 0.1rem 0.45rem; border-radius: 4px; display: inline-block; ${d.gender==="m"?"background-color: rgba(0, 0, 91, 0.05); color: var(--color-primary); border: 1px solid rgba(0, 0, 91, 0.12);":d.gender==="f"?"background-color: rgba(220, 38, 38, 0.05); color: var(--color-secondary); border: 1px solid rgba(220, 38, 38, 0.12);":"background-color: rgba(90, 106, 128, 0.05); color: var(--color-text-muted); border: 1px solid rgba(90, 106, 128, 0.12);"}">${z}</span>`}let $="";if(d.verb_group){let z="";d.verb_group===1||d.verb_group==="1"?z="1er groupe (-er)":d.verb_group===2||d.verb_group==="2"?z="2e groupe (-ir)":d.verb_group===3||d.verb_group==="3"?z="3e groupe (Irrégulier)":z=`${d.verb_group}e groupe`,$=`<span style="font-size: 0.72rem; font-weight: 600; padding: 0.1rem 0.45rem; border-radius: 4px; display: inline-block; background-color: rgba(107, 156, 104, 0.07); color: var(--color-success); border: 1px solid rgba(107, 156, 104, 0.15);">${z}</span>`}l.innerHTML=`
          ...
          <div>
            ...
            <div class="term-context" style="margin-top: 1rem;">
              <div class="context-fr" style="display: flex; align-items: flex-start; gap: 0.4rem; font-style: italic; color: var(--color-secondary);">
                ...
                <button class="audio-btn" data-text="${h}" title="Listen context sentence" style="background: none; border: none; font-size: 0.9rem; cursor: pointer; color: var(--color-text-muted); padding: 0.15rem; margin-top: 0.15rem;">🔊</button>
              </div>
              <div class="context-ja">${k}</div>
            </div>
            
            ${d.tags&&d.tags.length>0?`
              <div style="margin-top: 1rem; display: flex; flex-wrap: wrap; gap: 0.3rem;">
                ${d.tags.map(z=>`<span class="tag-badge" style="background-color: rgba(197, 168, 128, 0.08); color: var(--color-accent); font-size: 0.75rem; padding: 0.1rem 0.5rem; border-radius: 12px;">#${z}</span>`).join("")}
              </div>
            `:""}
          </div>
          ...
          <div style="border-top: 1px solid rgba(0,0,0,0.05); padding-top: 1rem; font-size: 0.8rem; display: flex; flex-direction: column; gap: 0.5rem;">
            ${x?`
              <div style="display: flex; justify-content: space-between; color: var(--color-text-muted);">
                <span>Interval: <strong>${_.interval} days</strong></span>
                <span>Due: <strong>${_.dueDate}</strong></span>
              </div>
      ...
      `;const q=l.querySelector(".flip-translation-container");q.addEventListener("click",z=>{z.stopPropagation(),q.querySelector(".flip-translation-card").classList.toggle("flipped")}),l.querySelector(".fav-btn").addEventListener("click",z=>{z.stopPropagation(),be(d.id);const E=z.target,H=fe(d.id);E.classList.toggle("active",H),E.innerText=H?"★":"☆"}),l.querySelectorAll(".audio-btn").forEach(z=>{z.addEventListener("click",E=>{E.stopPropagation();const H=E.target.closest(".audio-btn").getAttribute("data-text");ne(H)})}),l.querySelectorAll(".srs-action-btn").forEach(z=>{z.addEventListener("click",E=>{E.stopPropagation();const H=E.target.getAttribute("data-action"),M=E.target.getAttribute("data-id");H==="start"?He(M,4):H==="memorized"?He(M,5):H==="reset"&&He(M,0),b()})}),s.appendChild(l)})}y.querySelector("#vocab-category-select").addEventListener("change",w=>{u=w.target.value,b()}),y.querySelector("#vocab-tag-select").addEventListener("change",w=>{c=w.target.value,b()}),y.querySelector("#vocab-level-select").addEventListener("change",async w=>{var h;p=w.target.value,s.innerHTML=`<div style="grid-column: 1 / -1; text-align: center; padding: 2rem; color: var(--color-text-muted);">Chargement (Loading level ${p})...</div>`,await se("knowledge",p);const j=(((h=C.db)==null?void 0:h.knowledge)||[]).filter(k=>k.french&&k.japanese).filter(k=>t||k.is_professional),P=["ALL",...new Set(j.map(k=>k.category))],d=["ALL",...new Set(j.flatMap(k=>k.tags||[]))],l=y.querySelector("#vocab-category-select"),f=l.value;l.innerHTML=P.map(k=>`<option value="${k}" ${k===f?"selected":""}>${k}</option>`).join(""),u=l.value;const _=y.querySelector("#vocab-tag-select"),x=_.value;_.innerHTML=d.map(k=>`<option value="${k}" ${k===x?"selected":""}>${k==="ALL"?"ALL TAGS":"#"+k}</option>`).join(""),c=_.value,b()}),b()}function Ht(){var o;const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Grammaire de la Cuisine",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="French grammar concepts framed through recipe instructions and professional dialogues.",e.appendChild(t);const r=document.createElement("div");r.className="loading-placeholder",r.innerText="Chargement de la grammaire... (Loading grammar...)",e.appendChild(r);const n=((o=C.settings)==null?void 0:o.targetLevel)||"ALL";return se("knowledge",n).then(()=>{r.remove(),Rt(e,n)}),e}function Rt(e,a){var n;const r=(((n=C.db)==null?void 0:n.knowledge)||[]).filter(o=>o.grammar).map(o=>({id:o.id,category:o.category,french:o.french,level:o.level,topic:o.grammar.topic,explanation_en:o.grammar.explanation_en,explanation_ja:o.grammar.explanation_ja,examples:o.examples||[]})).filter(o=>a==="ALL"||o.level===a);if(r.length===0){const o=document.createElement("p");o.style.color="var(--color-text-muted)",o.innerText="Aucune leçon de grammaire chargée pour ce niveau.",e.appendChild(o);return}r.forEach(o=>{const m=document.createElement("div");m.className="grammar-card";const i=fe(o.id),u=o.topic.match(/\(([^)]+)\)/),c=u?u[1]:o.topic,p=Ie(o.french||""),y=p?`<div class="preposition-illustration-container" style="height: 130px; background-color: #fcfbfa; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; margin: 0.8rem 0; overflow: hidden; border: 1px solid rgba(0,0,0,0.03);">${p}</div>`:"";m.innerHTML=`
    ...
    `;const s=m.querySelector(".grammar-header"),b=m.querySelector(".grammar-body"),v=m.querySelector(".toggle-icon");s.addEventListener("click",g=>{if(g.target.classList.contains("fav-btn")||g.target.closest(".audio-btn"))return;const w=b.classList.toggle("open");v.innerText=w?"▲":"▼"}),m.querySelector(".fav-btn").addEventListener("click",g=>{g.stopPropagation(),be(o.id);const w=g.target,A=fe(o.id);w.classList.toggle("active",A),w.innerText=A?"★":"☆"}),m.querySelectorAll(".audio-btn").forEach(g=>{g.addEventListener("click",w=>{w.stopPropagation();const A=w.target.closest(".audio-btn").getAttribute("data-text");ne(A)})}),e.appendChild(m)})}function It(){const e=document.createElement("div");e.className="reference-container-view";const a=document.createElement("h2");a.className="section-title",a.innerText="Référence Grammaticale (Grammar Reference)",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Explore structured conjugations, classifications, and auxiliary usage patterns in culinary French.",e.appendChild(t);const r=document.createElement("div");return r.className="loading-placeholder",r.innerText="Chargement des références... (Loading references...)",e.appendChild(r),fetch("data/grammar_reference.json").then(n=>{if(!n.ok)throw new Error("Could not load reference data");return n.json()}).then(n=>{r.remove(),Dt(e,n)}).catch(n=>{r.innerText="Erreur lors du chargement des données. (Error loading reference data.)",console.error(n)}),e}function Dt(e,a){const t=document.createElement("div");t.className="ref-layout";const r=document.createElement("div");r.className="ref-sidebar";const n=document.createElement("div");n.className="ref-content-panel",a.forEach((o,m)=>{const i=document.createElement("button");i.className=`ref-menu-btn ${m===0?"active":""}`,i.innerHTML=`
    ...
    `,i.addEventListener("click",()=>{document.querySelectorAll(".ref-menu-btn").forEach(u=>u.classList.remove("active")),i.classList.add("active"),nt(n,o),window.innerWidth<=768&&n.scrollIntoView({behavior:"smooth"})}),r.appendChild(i)}),t.appendChild(r),t.appendChild(n),e.appendChild(t),a.length>0&&nt(n,a[0])}function nt(e,a){e.innerHTML="",e.style.animation="fadeIn 0.3s ease";const t=document.createElement("div");t.className="ref-topic-header",t.innerHTML=`
    <h3 class="ref-topic-title">${a.title_fr}</h3>
    <div class="ref-topic-subtitle">
      <span>${a.title_en}</span> &bull; <span>${a.title_ja}</span>
    </div>
  `,e.appendChild(t);const r=document.createElement("div");r.className="ref-definition-box",r.innerHTML=`
    <p class="ref-def-fr"><strong>Définition :</strong> ${a.definition_fr}</p>
    <p class="ref-def-ja"><strong>定義 :</strong> ${a.definition_ja}</p>
  `,e.appendChild(r),a.sections.forEach(n=>{const o=document.createElement("div");if(o.className="ref-section-container",n.type==="table"){const m=document.createElement("h4");m.className="ref-sec-title",m.innerText=n.title,o.appendChild(m);const i=document.createElement("div");i.className="ref-table-wrapper";const u=document.createElement("table");u.className="ref-table";const c=[],p=document.createElement("tr");if(n.headers.forEach((y,s)=>{const b=document.createElement("th");y==="発音"?(c.push(s),b.innerText="音声",b.style.textAlign="center"):b.innerText=y,p.appendChild(b)}),u.appendChild(p),n.rows.forEach(y=>{const s=document.createElement("tr");y.forEach((b,v)=>{const g=document.createElement("td");if(c.includes(v)){const w=y[v-1]?y[v-1].split("(")[0].trim():"";g.innerHTML=`<button class="ref-table-audio-btn" data-speak="${w}" title="Listen pronunciation">🔊</button>`,g.style.textAlign="center"}else g.innerText=b,v===1&&(n.title.includes("Conjugaison")||n.title.includes("Présent")||n.title.includes("Exemple"))&&(g.style.position="relative",g.innerHTML=`
                <span style="margin-right: 1.5rem;">${b}</span>
                <button class="ref-table-audio-btn" data-speak="${b.split("(")[0].trim()}" title="Listen pronunciation">🔊</button>
              `);s.appendChild(g)}),u.appendChild(s)}),i.appendChild(u),o.appendChild(i),n.example){const y=document.createElement("div");y.className="ref-table-attached-ex",y.innerHTML=`
        ...
        `,o.appendChild(y)}}else if(n.type==="examples"){const m=document.createElement("h4");m.className="ref-sec-title",m.innerText=n.title,o.appendChild(m);const i=document.createElement("div");i.className="ref-examples-list",n.examples.forEach(u=>{const c=document.createElement("div");c.className="ref-example-item",c.innerHTML=`
          <div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
            <span class="ref-ex-fr">➔ ${u.fr}</span>
            <button class="audio-btn" data-speak="${u.fr}">🔊</button>
          </div>
          <div class="ref-ex-ja">${u.ja}</div>
        `,i.appendChild(c)}),o.appendChild(i)}else if(n.type==="illustrations_grid"){const m=document.createElement("h4");m.className="ref-sec-title",m.innerText=n.title,o.appendChild(m);const i=document.createElement("div");i.className="ref-illustrations-grid",i.style.display="grid",i.style.gridTemplateColumns="repeat(auto-fill, minmax(180px, 1fr))",i.style.gap="1rem",i.style.marginTop="1rem",n.items.forEach(u=>{const c=document.createElement("div");c.className="ref-illustration-card",c.style.border="1px solid rgba(0,0,0,0.06)",c.style.borderRadius="8px",c.style.padding="0.8rem 0.5rem",c.style.backgroundColor="#fcfbfa",c.style.display="flex",c.style.flexDirection="column",c.style.alignItems="center",c.style.transition="transform 0.2s ease, box-shadow 0.2s ease",c.addEventListener("mouseenter",()=>{c.style.transform="translateY(-2px)",c.style.boxShadow="0 4px 12px rgba(0,0,0,0.05)"}),c.addEventListener("mouseleave",()=>{c.style.transform="none",c.style.boxShadow="none"});const p=Ie(u.word);c.innerHTML=`
        ...
        `,i.appendChild(c)}),o.appendChild(i)}else if(n.type==="info"){const m=document.createElement("div");m.className="ref-info-box",m.innerHTML=`
        <h4 class="ref-info-title">💡 ${n.title}</h4>
        <p class="ref-info-fr">${n.content_fr}</p>
        <p class="ref-info-ja">${n.content_ja}</p>
      `,o.appendChild(m)}e.appendChild(o)}),e.querySelectorAll(".audio-btn, .ref-table-audio-btn").forEach(n=>{n.addEventListener("click",o=>{o.stopPropagation();const m=n.getAttribute("data-speak");ne(m),n.style.transform="scale(1.2)",setTimeout(()=>n.style.transform="none",150)})})}function Nt(e){var t;e.innerHTML='<div style="text-align: center; padding: 2rem; color: var(--color-text-muted);">Chargement de la théorie... (Loading theory...)</div>';const a=((t=C.settings)==null?void 0:t.targetLevel)||"ALL";se("knowledge",a).then(()=>{var m;e.innerHTML="";const n=(((m=C.db)==null?void 0:m.knowledge)||[]).filter(i=>i.cuisine).map(i=>({id:i.id,level:i.level,category:i.category||"Theory",topic:i.cuisine.topic,content_fr:i.cuisine.content_fr,content_en:i.cuisine.content_en,content_ja:i.cuisine.content_ja})).filter(i=>a==="ALL"||i.level===a);if(n.length===0){e.innerHTML='<p style="color: var(--color-text-muted);">Aucun document de théorie culinaire disponible pour ce niveau.</p>';return}const o=document.createElement("div");o.style.display="flex",o.style.flexDirection="column",o.style.gap="2rem",n.forEach(i=>{const u=document.createElement("div");u.className="card",u.style.display="block",u.style.padding="2rem";const c=fe(i.id),p=i.topic.match(/^([^(]+)/),y=p?p[1].trim():i.topic;u.innerHTML=`
        ...
        <div class="term-header" style="border-bottom: 1px solid rgba(197, 168, 128, 0.15); padding-bottom: 0.8rem; margin-bottom: 1.5rem;">
          ...
          <button class="fav-btn ${c?"active":""}" data-id="${i.id}" style="font-size: 1.3rem;">
            ${c?"★":"☆"}
          </button>
        </div>
  ...
  `,a.appendChild(t);const r=document.createElement("div");r.className="meat-type-tabs",r.style.marginTop="0.5rem",r.style.borderBottom="none",a.appendChild(r);const n=document.createElement("div");n.className="meat-display-area",a.appendChild(n),e.appendChild(a);const o={primary:{title:"主要食肉 (Primary Meats)",subCategories:[{key:"beef",label:"🐂 Bœuf (牛)",cuts:dt,img:"assets/beef_cuts.png",placeholder:"Coupe+de+Boeuf",pdf:"beef_maff_guide.pdf",pdfText:"📄 日本農水省 牛肉部位基準 (PDF)"},{key:"porc",label:"🐖 Porc (豚)",cuts:ut,img:"assets/porc_cuts.png",placeholder:"Coupe+de+Porc",pdf:"pork_maff_guide.pdf",pdfText:"📄 日本農水省 豚肉部位基準 (PDF)",quote:'"Tout est bon dans le cochon" (豚はすべてが使える食材である)'},{key:"volaille",label:"🐓 Volaille (鶏)",cuts:mt,img:"assets/poultry_cuts.png",placeholder:"Coupe+de+Volaille",pdf:"poultry_maff_guide.pdf",pdfText:"📄 日本農水省 鶏肉部位基準 (PDF)",quote:'"La volaille est la reine des cuisines et la directrice des banquets" (鶏肉は厨房の女王であり、宴の演出家である)'}]},livestock:{title:"その他の家畜肉 (Other Livestock)",subCategories:[{key:"agneau",label:"🐏 Agneau (羊)",cuts:pt,img:"assets/agneau_cuts.png",placeholder:"Agneau"},{key:"veau",label:"🐂 Veau (仔牛)",cuts:gt,img:"assets/veal_cuts.png",placeholder:"Veau"},{key:"canard",label:"🦆 Canard (鴨)",cuts:ft,img:"assets/canard_cuts.png",placeholder:"Canard"}]},game:{title:"ジビエ (Game Meats)",subCategories:[{key:"chevreuil",label:"🦌 Chevreuil (鹿)",cuts:ht,img:"assets/game_cuts.png",placeholder:"Chevreuil"},{key:"sanglier",label:"🐗 Sanglier (猪)",cuts:yt,img:"assets/game_cuts.png",placeholder:"Sanglier"},{key:"pigeon",label:"🕊️ Pigeon (鳩)",cuts:bt,img:"assets/game_cuts.png",placeholder:"Pigeon"},{key:"lievre",label:"🐇 Lièvre (野ウサギ)",cuts:_t,img:"assets/game_cuts.png",placeholder:"Lievre"}]},seafood:{title:"魚介類 (Seafood)",subCategories:[{key:"poisson",label:"🐟 Poisson (魚)",cuts:vt,img:"assets/seafood_cuts.png",placeholder:"Poisson"},{key:"crustaces",label:"🦞 Crustacés (甲殻類)",cuts:xt,img:"assets/seafood_cuts.png",placeholder:"Crustaces"},{key:"coquillages",label:"🐚 Coquillages (貝類)",cuts:kt,img:"assets/seafood_cuts.png",placeholder:"Coquillages"},{key:"mollusques",label:"🐙 Mollusques (軟体類)",cuts:wt,img:"assets/seafood_cuts.png",placeholder:"Mollusques"}]},cheese_wine:{title:"チーズ・ワイン (Cheese & Wine)",subCategories:[{key:"fromages_fr",label:"🇫🇷 France (仏チーズ)",cuts:We,img:"assets/cheese_wine.png",placeholder:"Fromages"},{key:"fromages_world",label:"🌐 Monde (世界チーズ)",cuts:Ge,img:"assets/cheese_wine.png",placeholder:"Fromages",hidePins:!0},{key:"fromages_classif",label:"🔬 Classification (製法分類)",cuts:Ct,img:"assets/cheese_wine.png",placeholder:"Fromages",hidePins:!0},{key:"vins",label:"🍷 Vins (ワイン)",cuts:Qe,img:"assets/cheese_wine.png",placeholder:"Vins"}]},vegetables:{title:"野菜 (Vegetables)",subCategories:[{key:"legumes",label:"🥦 Légumes (野菜全般)",cuts:St,img:"assets/vegetables.png",placeholder:"Legumes"}]},herbs_spices:{title:"ハーブ・スパイス (Herbs & Spices)",subCategories:[{key:"herbes",label:"🌿 Herbes (香草)",cuts:Lt,img:"assets/herbs_spices.png",placeholder:"Herbes"},{key:"epices",label:"🌶️ Épices (香辛料)",cuts:jt,img:"assets/herbs_spices.png",placeholder:"Epices"}]},fruits_mushrooms:{title:"果物・きのこ (Fruits & Mushrooms)",subCategories:[{key:"fruits",label:"🍎 Fruits (果物)",cuts:Tt,img:"assets/fruits_mushrooms.png",placeholder:"Fruits"},{key:"champignons",label:"🍄 Champignons (きのこ)",cuts:$t,img:"assets/fruits_mushrooms.png",placeholder:"Champignons"}]}};function m(i){const u=o[i];r.innerHTML="",u.subCategories.forEach((c,p)=>{const y=document.createElement("button");y.className=`meat-tab-btn ${p===0?"active":""}`,y.setAttribute("data-sub",c.key),y.innerText=c.label,y.style.fontSize="0.8rem",y.style.padding="0.3rem 0.8rem",y.addEventListener("click",s=>{r.querySelectorAll(".meat-tab-btn").forEach(b=>b.classList.remove("active")),y.classList.add("active"),rt(c,n)}),r.appendChild(y)}),u.subCategories.length<=1?r.style.display="none":r.style.display="flex",rt(u.subCategories[0],n)}t.querySelectorAll(".meat-tab-btn").forEach(i=>{i.addEventListener("click",u=>{t.querySelectorAll(".meat-tab-btn").forEach(p=>p.classList.remove("active")),i.classList.add("active");const c=i.getAttribute("data-category");m(c)})}),m("primary")}function rt(e,a){a.innerHTML="";const t=document.createElement("div");t.style.display="flex",t.style.flexDirection="column",t.style.gap="1.5rem";let r="";e.quote&&(r+=`
  ...
  `,e.appendChild(a);let t=document.getElementById("map-floating-tooltip");t||(t=document.createElement("div"),t.id="map-floating-tooltip",t.style.position="fixed",t.style.pointerEvents="none",t.style.zIndex="9999",t.style.padding="0.5rem 0.8rem",t.style.background="rgba(10, 25, 49, 0.95)",t.style.border="1px solid var(--color-accent)",t.style.borderRadius="var(--radius-sm)",t.style.color="#fff",t.style.fontSize="0.75rem",t.style.boxShadow="0 4px 12px rgba(0, 0, 0, 0.15)",t.style.display="none",t.style.fontFamily="var(--font-main)",t.style.lineHeight="1.3",document.body.appendChild(t));const r=a.querySelectorAll(".segment-btn");r.forEach(c=>{c.addEventListener("click",p=>{r.forEach(y=>y.classList.remove("active")),p.target.classList.add("active"),I.activeMap=p.target.getAttribute("data-map"),I.selectedRegionId=null,I.selectedItemId=null,m()})});const n=a.querySelectorAll(".theme-tab-btn");n.forEach(c=>{c.addEventListener("click",p=>{n.forEach(y=>y.classList.remove("active")),p.target.classList.add("active"),I.activeTheme=p.target.getAttribute("data-theme"),I.selectedItemId=null,m()})}),o().then(()=>{m()});async function o(){try{const c=["data/regions_administrative.json","data/regions_cultural.json","data/dishes.json","data/cheeses.json","data/wines.json"],p=await Promise.all(c.map(y=>fetch(y)));for(const y of p)if(!y.ok)throw new Error(`Failed to load ${y.url}`);ve=await p[0].json(),xe=await p[1].json(),Ae=await p[2].json(),Pe=await p[3].json(),Me=await p[4].json(),console.log("Map engine data loaded successfully.")}catch(c){console.error("Failed to load map JSON datasets:",c),ve=[],xe=[]}}function m(){if(!(ve.length>0&&xe.length>0)){a.querySelector("#regions-list-group").innerHTML='<p style="font-size:0.8rem;color:var(--color-text-muted);padding:1rem;">読み込み中...</p>';return}const p=a.querySelector("#legacy-map-illustration"),y=a.querySelector("#classic-map-decorations"),s=a.querySelector("#interactive-france-svg");I.activeMap==="cultural"?(p.style.display="block",y.style.display="none",s.setAttribute("viewBox","0 0 600 600")):(p.style.display="none",y.style.display="block",s.setAttribute("viewBox","0 0 1000 1000"));const b=I.activeMap==="admin"?ve:xe,v=a.querySelector("#map-paths-group"),g=I.activeMap==="cultural";v.innerHTML=b.map(d=>{const l=I.selectedRegionId===d.region_id,f=Zt[d.region_id]||"rgba(197, 168, 128, 0.1)",_=g?"none":f,x=g?"none":"rgba(92, 64, 51, 0.65)",h=g?0:1,k=l?"rgba(197, 168, 128, 0.45)":_,S=l?"var(--color-primary)":x,T=l?3.2:g?0:2.2;return`
        <path 
          class="region-path ${l?"active":""}" 
          d="${d.geometry}" 
          id="${d.region_id}" 
          data-id="${d.region_id}"
          style="fill: ${k}; fill-opacity: ${l?.65:h}; stroke: ${S}; stroke-width: ${T}; cursor: pointer; transition: fill 0.25s, fill-opacity 0.25s, stroke 0.25s;"
        />
      `}).join("");const w=a.querySelector("#map-labels-group");g?w.innerHTML="":w.innerHTML=b.map(d=>{const l=d.french_name,f=l.length>20?11.5:l.length>12?12.5:14.5,_=f*.65,x=Math.max(90,l.length*_+20),h=f+8,k=d.label_y-h/2-1,S=d.label_y+f/3+.5;return`
        ...
        `}).join("");const A=a.querySelector("#map-pins-group");if(A.innerHTML="",I.activeTheme!=="overview"){let d=[],l="var(--color-accent)";I.activeTheme==="cheeses"?(d=Pe,l="#EAA812"):I.activeTheme==="wines"?(d=Me,l="#A91B3E"):I.activeTheme==="dishes"&&(d=Ae,l="#2F80ED");const f=b.map(_=>_.region_id);A.innerHTML=d.map(_=>{const x=Oe(_.region,I.activeMap);if(!x||!f.includes(x))return"";const h=b.find($=>$.region_id===x);if(!h)return"";const k=I.activeMap==="cultural"?6:10;let S=_.pin.x*k,T=_.pin.y*k;if(I.activeMap==="admin"){S=S*.15+h.label_x*.85,T=T*.15+h.label_y*.85;const $=_.id.length*5%12-6;S+=$,T+=_.id.length*11%12-6}else{const $=_.id.length*3%6-3;S+=$,T+=_.id.length*5%6-3}const L=I.selectedItemId===_.id;return`
          <g class="map-pin-marker" data-item-id="${_.id}" data-region-id="${x}" style="cursor:pointer; z-index: 10;">
            <circle cx="${S}" cy="${T}" r="${L?"9":"6"}" fill="${l}" stroke="#fff" stroke-width="1.5" />
            ${L?`<circle cx="${S}" cy="${T}" r="14" fill="none" stroke="${l}" stroke-width="1.5" stroke-dasharray="2,2" opacity="0.8" />`:""}
          </g>
        `}).join("")}const j=a.querySelector("#sidebar-list-title");if(I.activeTheme==="overview")j.innerText="🗺️ 地方リスト (Régions)";else{const d={dishes:"🍽️ 郷土料理",cheeses:"🧀 特産チーズ",wines:"🍷 地方ワイン"};j.innerText=`${d[I.activeTheme]} リスト`}const P=a.querySelector("#regions-list-group");if(P.innerHTML="",I.activeTheme==="overview")P.innerHTML=b.map(d=>{const l=I.selectedRegionId===d.region_id,f=d.code||"";return`
        ...
        `}).join("");else{let d=[];I.activeTheme==="cheeses"?d=Pe:I.activeTheme==="wines"?d=Me:I.activeTheme==="dishes"&&(d=Ae);const l=b.map(_=>_.region_id),f=d.filter(_=>{const x=Oe(_.region,I.activeMap);return x&&l.includes(x)});P.innerHTML=f.map(_=>{const x=I.selectedItemId===_.id,h=Oe(_.region,I.activeMap),k=b.find(T=>T.region_id===h),S=k?k.japanese_name.replace("地域圏","").replace("地方",""):"";return`
          <button class="list-item-btn item-btn ${x?"active":""}" data-item-id="${_.id}" data-region-id="${h}">
            <span>
              <strong>${_.name_fr}</strong> 
              <br><span style="font-size:0.75rem; color:var(--color-text-muted); font-weight:normal;">${_.name_ja}</span>
            </span>
        ...
        `}).join("")}u(),i()}function i(){a.querySelectorAll(".region-path").forEach(s=>{s.addEventListener("mouseenter",b=>{const v=b.target.getAttribute("data-id"),w=(I.activeMap==="admin"?ve:xe).find(A=>A.region_id===v);w&&(t.innerHTML=`
          ...
          `,t.style.display="block")}),s.addEventListener("mousemove",b=>{t.style.left=b.clientX+15+"px",t.style.top=b.clientY+15+"px"}),s.addEventListener("mouseleave",()=>{t.style.display="none"}),s.addEventListener("click",b=>{const v=b.target.getAttribute("data-id");I.selectedRegionId=v,I.selectedItemId=null,m()})}),a.querySelectorAll(".list-item-btn").forEach(s=>{s.addEventListener("click",b=>{const v=b.target.closest(".list-item-btn");v.classList.contains("item-btn")?(I.selectedItemId=v.getAttribute("data-item-id"),I.selectedRegionId=v.getAttribute("data-region-id")):(I.selectedRegionId=v.getAttribute("data-id"),I.selectedItemId=null),m()})}),a.querySelectorAll(".map-pin-marker").forEach(s=>{s.addEventListener("click",b=>{const v=b.target.closest(".map-pin-marker");I.selectedItemId=v.getAttribute("data-item-id"),I.selectedRegionId=v.getAttribute("data-region-id"),m()})})}function u(){const c=a.querySelector("#map-detail-drawer"),p=a.querySelector("#map-region-title"),y=a.querySelector("#map-region-sub"),s=a.querySelector("#drawer-main-content"),b=a.querySelector("#map-audio-title-btn");if(b.style.display="none",I.selectedItemId){let v=null,g="";if(I.activeTheme==="cheeses"?(v=Pe.find(w=>w.id===I.selectedItemId),g="特産チーズ (Fromage AOP)"):I.activeTheme==="wines"?(v=Me.find(w=>w.id===I.selectedItemId),g="地方ワイン (AOC Wine)"):I.activeTheme==="dishes"&&(v=Ae.find(w=>w.id===I.selectedItemId),g="郷土料理 (Plat Régional)"),v){p.innerText=`${v.name_fr} (${v.name_ja})`,y.innerText=`${g} • ${v.region}`;let w="";if(v.properties){w+='<div style="display:flex; flex-wrap:wrap; gap:0.6rem; margin-bottom:0.5rem;">';for(const[j,P]of Object.entries(v.properties)){let d=j;j==="sweetness"?d="甘み":j==="alcohol"?d="アルコール":j==="body"?d="ボディ":j==="saltiness"?d="塩気":j==="aroma"?d="香り":j==="rarity"?d="希少性":j==="type"&&(d="タイプ"),w+=`
          ...
          `:""}
        `,b.style.display="inline-block",b.onclick=()=>ne(v.name_fr);const A=a.querySelector("#map-audio-desc-btn");A&&(A.onclick=()=>ne(v.science||v.desc||"")),c.style.display="block";return}}if(I.selectedRegionId){const g=(I.activeMap==="admin"?ve:xe).find(w=>w.region_id===I.selectedRegionId);if(g){p.innerText=`${g.french_name} (${g.japanese_name})`,y.innerText=`${g.english_name} Region`;let w=en(g.region_id);s.innerHTML=`
          <div>
            <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.3rem;">
              <h4 style="font-size:0.75rem; text-transform:uppercase; color:var(--color-accent); font-weight:600;">Français</h4>
              <button class="audio-btn" id="map-audio-desc-btn" style="background:none; border:none; font-size:0.95rem; cursor:pointer; color:var(--color-accent);">🔊</button>
  ...
  `,e.appendChild(r);const n=document.createElement("div");n.className="cuisine-content-wrapper",e.appendChild(n),r.querySelectorAll(".cuisine-tab-btn").forEach(m=>{m.addEventListener("click",i=>{r.querySelectorAll(".cuisine-tab-btn").forEach(c=>c.classList.remove("active")),i.target.classList.add("active");const u=i.target.getAttribute("data-tab");o(u)})});function o(m){n.innerHTML="",m==="theory"?Nt(n):m==="ingredients"?Kt(n):m==="map"&&Xt(n)}return o("theory"),e}function de(e){const a=[...e];for(let t=a.length-1;t>0;t--){const r=Math.floor(Math.random()*(t+1));[a[t],a[r]]=[a[r],a[t]]}return a}function it(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/[-\s]+/g," ")}function ot(e,a){if(a==="ALL")return e;const r={meat:["meat","beef","pork","poultry"],sauces:["sauce","sauces","stocks"],cuts:["cutting","cuts","vegetables"],science:["science"],map:["map","region","regional_culture"],grammar:["grammar","greetings","dialogue","verbs"],vocabulary:["vocabulary","vegetables","cooking","ingredients"]}[a]||[a];return e.filter(n=>n.tags&&n.tags.some(o=>r.some(m=>o.toLowerCase().includes(m.toLowerCase()))))}function nn(){if(document.getElementById("quiz-dynamic-styles"))return;const e=document.createElement("style");e.id="quiz-dynamic-styles",e.innerHTML=`
    .quiz-mode-selector {
      display: flex;
  ...
  `,document.head.appendChild(e)}function rn(){var m;const e=[],a=((m=C.db)==null?void 0:m.knowledge)||[],t=a.filter(i=>i.french&&i.japanese),r=a.filter(i=>i.grammar),n=a.filter(i=>i.cuisine);function o(i,u,c,p){const s=i.filter(v=>v.id!==c).map(p).sort(()=>.5-Math.random()),b=[...new Set(s)].filter(Boolean).slice(0,u);for(;b.length<u;)b.push("Autre option "+(b.length+1));return b}return t.forEach(i=>{var s,b,v,g,w;let u="vocabulary";(s=i.tags)!=null&&s.includes("meat")?u="meat":(b=i.tags)!=null&&b.includes("sauces")||(v=i.tags)!=null&&v.includes("sauce")?u="sauces":(g=i.tags)!=null&&g.includes("cutting")?u="cuts":(w=i.tags)!=null&&w.includes("science")&&(u="science");const c=o(t,3,i.id,A=>A.japanese),p=i.examples&&i.examples[0]?i.examples[0].fr:"";e.push({id:`dyn_vocab_fr_ja_${i.id}`,type:"choice",category:u,question:`Que signifie le mot français "${i.french}" ? / What does the French word "${i.french}" mean?`,question_fr:`Que signifie le mot français "${i.french}" ?`,question_en:`What does the French word "${i.french}" mean?`,context:i.definition_fr||`Usage: ${p}`,options:de([i.japanese,...c]),answer:i.japanese});const y=o(t,3,i.id,A=>A.french);e.push({id:`dyn_vocab_ja_fr_${i.id}`,type:"choice",category:u,question:`Quel est le mot français pour "${i.japanese}" ? / What is the French word for "${i.japanese}"?`,question_fr:`Quel est le mot français pour "${i.japanese}" ?`,question_en:`What is the French word for "${i.japanese}"?`,context:i.definition_fr||`Usage: ${p}`,options:de([i.french,...y]),answer:i.french})}),r.forEach(i=>{if(!i.grammar.topic||!i.examples||i.examples.length===0)return;const u=o(r,3,i.id,c=>c.grammar.topic);e.push({id:`dyn_gram_topic_${i.id}`,type:"choice",category:"grammar",question:`De quel concept de grammaire s'agit-il : "${i.grammar.explanation_ja}" ? / Which grammar concept is this: "${i.grammar.explanation_en}"?`,question_fr:"De quel concept de grammaire s'agit-il ?",question_en:`Which grammar concept is this: "${i.grammar.explanation_en}"?`,context:`Niveau : ${i.level}. Indispensable pour la cuisine.`,options:de([i.grammar.topic,...u]),answer:i.grammar.topic}),i.examples.forEach((c,p)=>{const s=r.flatMap(b=>b.examples||[]).filter(b=>b.fr!==c.fr).sort(()=>.5-Math.random()).map(b=>b.ja).slice(0,3);for(;s.length<3;)s.push("Option de traduction "+(s.length+1));e.push({id:`dyn_gram_ex_${i.id}_${p}`,type:"choice",category:"grammar",question:`Traduisez la phrase : "${c.fr}" / Translate the sentence: "${c.fr}"`,question_fr:`Traduisez la phrase : "${c.fr}"`,question_en:`Translate the sentence: "${c.fr}"`,context:`Grammaire: ${i.grammar.topic} (${i.level})`,options:de([c.ja,...s]),answer:c.ja})})}),n.forEach(i=>{var p,y,s,b,v,g;if(!i.cuisine.topic||!i.cuisine.content_ja)return;const u=o(n,3,i.id,w=>w.cuisine.topic);let c="sauces";(p=i.tags)!=null&&p.includes("knife-cuts")||(y=i.tags)!=null&&y.includes("cuts")?c="cuts":(s=i.tags)!=null&&s.includes("meat")?c="meat":((b=i.tags)!=null&&b.includes("molecular")||(v=i.tags)!=null&&v.includes("chemistry")||(g=i.tags)!=null&&g.includes("science"))&&(c="science"),e.push({id:`dyn_cuis_topic_${i.id}`,type:"choice",category:c,question:`De quel concept culinaire s'agit-il : "${i.cuisine.content_ja.substring(0,120)}..." ? / Which culinary concept is described: "${i.cuisine.content_en.substring(0,120)}..."?`,question_fr:"De quel concept culinaire s'agit-il ?",question_en:"Which culinary concept is described here?",context:`Niveau : ${i.level}. Mots-clés : ${i.tags.join(", ")}`,options:de([i.cuisine.topic,...u]),answer:i.cuisine.topic})}),e}function an(){var n;const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Vérification des Connaissances",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Test your professional French vocabulary, kitchen commands, and classical cuisine theory.",e.appendChild(t);const r=document.createElement("div");return r.className="loading-placeholder",r.innerText="Chargement du quiz... (Loading quiz...)",e.appendChild(r),nn(),(n=C.settings)!=null&&n.targetLevel,Promise.all([Je(),se("vocabulary","ALL"),se("grammar","ALL"),se("cuisine","ALL"),fetch("rpg/questions_db.json").then(o=>o.json()).then(o=>{C.questionsDb=o}).catch(o=>{console.error("Failed to load questions_db in quiz:",o),C.questionsDb=[]})]).then(()=>{r.remove(),on(e)}),e}function on(e){let a="multiple",t="ALL";const r=document.createElement("div");r.className="quiz-mode-selector",r.innerHTML=`
  ...
  `,e.appendChild(r);const n=document.createElement("div");n.className="quiz-category-filter-wrapper",n.style.margin="1rem auto 1.5rem auto",n.style.display="flex",n.style.justifyContent="center",n.style.alignItems="center",n.style.gap="0.8rem",n.innerHTML=`
  ...
  `,e.appendChild(n),n.querySelector("#quiz-cat-select").addEventListener("change",s=>{t=s.target.value,i()});const m=document.createElement("div");m.className="quiz-game-wrapper",e.appendChild(m),r.querySelectorAll(".mode-tab-btn").forEach(s=>{s.addEventListener("click",b=>{r.querySelectorAll(".mode-tab-btn").forEach(v=>v.classList.remove("active")),b.target.classList.add("active"),a=b.target.getAttribute("data-mode"),i()})});function i(){m.innerHTML="",a==="multiple"?u():a==="association"?c():a==="spelling"&&y()}function u(){var d;const s=((d=C.db)==null?void 0:d.quizzes)||[],b=rn();let v=[...s,...b];if(t!=="ALL"&&(v=v.filter(l=>l.category===t)),v.length===0){m.innerHTML=`
      ...
      `;return}const g=de(v).slice(0,10);let w=0,A=0,j=!1;function P(){if(m.innerHTML="",j=!1,w>=g.length){const S=Math.round(A/g.length*100);let T="Apprenti (Apprentice)";S>=90?T="Chef de Partie (Station Chef)":S>=70&&(T="Commis de Cuisine (Line Cook)"),m.innerHTML=`
          <div class="quiz-card" style="text-align: center;">
            ...
            <p style="font-size: 1.1rem; margin-bottom: 1.5rem;">Your Score: <strong>${A} / ${g.length}</strong> (${S}%)</p>
            <div style="background-color: rgba(197, 168, 128, 0.1); border: 1px solid var(--color-accent); padding: 1.5rem; border-radius: var(--radius-md); margin-bottom: 2rem;">
              ...
              <div style="font-family: var(--font-serif); font-size: 1.5rem; color: var(--color-primary); font-weight: 700; margin-top: 0.3rem;">${T}</div>
            </div>
            <button class="next-btn" id="restart-choice-btn" style="margin: 0 auto; display: block;">Restart Session</button>
          </div>
        `,m.querySelector("#restart-choice-btn").addEventListener("click",()=>{u()});return}const l=g[w],f=document.createElement("div");f.className="quiz-card",f.innerHTML=`
        <div class="quiz-meta">
        ...
        <div class="quiz-options">
          ${l.options.map((S,T)=>`
            <button class="quiz-btn" data-index="${T}">${S}</button>
          `).join("")}
        </div>
      ...
      `;const _=f.querySelector(".quiz-hint-flip-container");_&&_.addEventListener("click",()=>{const S=_.querySelector(".q-en-hint-text"),T=S.style.display==="none";S.style.display=T?"block":"none",_.querySelector(".q-en-card").innerText=T?"💡 Hide English Hint":"💡 Translate (Show English Hint)"});const x=f.querySelectorAll(".quiz-btn"),h=f.querySelector(".quiz-feedback"),k=f.querySelector("#next-q-btn");x.forEach(S=>{S.addEventListener("click",T=>{if(j)return;j=!0;const $=T.target.innerText===l.answer;x.forEach(q=>{q.disabled=!0,q.innerText===l.answer&&q.classList.add("correct")}),$?A++:(T.target.classList.add("incorrect"),st(l.id)),h.style.display="block",k.style.display="block"})}),k.addEventListener("click",()=>{w++,P()}),m.appendChild(f)}P()}function c(){var w,A;let s=[];if(C.questionsDb&&C.questionsDb.length>0){const j=C.questionsDb.filter(P=>P.type==="matching");s=ot(j,t)}if(s.length===0){const j=((w=C.settings)==null?void 0:w.includeGeneral)||!1;let d=(((A=C.db)==null?void 0:A.vocabulary)||[]).filter(l=>j||l.is_professional);if(t!=="ALL"&&(t==="meat"?d=d.filter(l=>{var f;return((f=l.tags)==null?void 0:f.includes("meat"))||/viande|boeuf/i.test(l.french)}):t==="sauces"?d=d.filter(l=>{var f;return((f=l.tags)==null?void 0:f.includes("sauce"))||/sauce|fond/i.test(l.french)}):t==="cuts"?d=d.filter(l=>{var f;return((f=l.tags)==null?void 0:f.includes("cutting"))||/coupe|tailler/i.test(l.french)}):t==="science"?d=d.filter(l=>{var f;return((f=l.tags)==null?void 0:f.includes("science"))||/réaction|émulsion/i.test(l.french)}):t==="map"&&(d=d.filter(l=>{var f;return((f=l.tags)==null?void 0:f.includes("map"))||/région|ville/i.test(l.french)}))),d.length>=4){const l=de(d).slice(0,4);s=[{id:"dyn_match_vocab",tags:["vocabulary"],text:"Associez les paires correctes. (正しいペアを結びつけてください。)",pairs:l.map(f=>({left:f.french,right:f.japanese})),explanation:"単語のペアを正しくマッチさせました。"}]}}if(s.length===0){m.innerHTML=`
        <div class="quiz-card" style="text-align: center; padding: 2rem;">
      ...
      `;return}const b=de(s).slice(0,5);let v=0;function g(){if(m.innerHTML="",v>=b.length){m.innerHTML=`
          <div class="quiz-card" style="text-align: center;">
            <h3 style="font-family: var(--font-serif); font-size: 2rem; color: var(--color-primary); margin-bottom: 1rem;">Session Terminée !</h3>
        ...
        `,m.querySelector("#restart-assoc-btn").addEventListener("click",()=>{c()});return}const j=b[v],P=de(j.pairs.map(_=>_.left)),d=de(j.pairs.map(_=>_.right)),l=j.tags&&j.tags.length>0?j.tags[0]:"association",f=document.createElement("div");f.className="quiz-card",f.innerHTML=`
        <div class="quiz-meta" style="margin-bottom: 1rem;">
          <span>Question ${v+1} of ${b.length}</span>
        ...
        <div class="matching-board">
          <div class="matching-column" id="left-column">
            ${P.map((_,x)=>`
              <div class="drag-card" draggable="true" data-val="${_}" id="drag-${v}-${x}">
                <span>${_}</span>
      ...
      `,m.appendChild(f),p(f,j,()=>{const _=f.querySelector(".quiz-feedback"),x=f.querySelector("#matching-completion-panel");_.style.display="block",x.style.display="block"}),f.querySelector("#next-assoc-btn").addEventListener("click",()=>{v++,g()})}g()}function p(s,b,v){let g=null,w=null,A=0;const j=b.pairs.length,P=s.querySelectorAll(".drag-card"),d=s.querySelectorAll(".drop-zone");P.forEach(_=>{_.addEventListener("dragstart",x=>{g=x.target.closest(".drag-card").getAttribute("data-val"),x.target.closest(".drag-card").classList.add("dragging")}),_.addEventListener("dragend",x=>{x.target.closest(".drag-card").classList.remove("dragging")}),_.addEventListener("click",x=>{const h=x.target.closest(".drag-card");h.classList.contains("matched")||(P.forEach(k=>k.style.borderColor="rgba(10,25,49,0.08)"),w=h.getAttribute("data-val"),h.style.borderColor="var(--color-accent)")})}),d.forEach(_=>{_.addEventListener("dragover",x=>{x.preventDefault(),_.classList.contains("matched")||_.classList.add("hovered")}),_.addEventListener("dragleave",()=>{_.classList.remove("hovered")}),_.addEventListener("drop",x=>{x.preventDefault(),_.classList.remove("hovered");const h=_.getAttribute("data-val");b.pairs.find(S=>S.left===g&&S.right===h)?f(g,_):l(g)}),_.addEventListener("click",()=>{if(_.classList.contains("matched")||!w)return;const x=_.getAttribute("data-val");b.pairs.find(k=>k.left===w&&k.right===x)?(f(w,_),w=null):(l(w),w=null,P.forEach(k=>k.style.borderColor="rgba(10,25,49,0.08)"))})});function l(_){const x=Array.from(P).find(h=>h.getAttribute("data-val")===_);x&&(x.style.animation="shake-anim 0.4s ease-in-out",setTimeout(()=>x.style.animation="",400))}function f(_,x){const h=Array.from(P).find(k=>k.getAttribute("data-val")===_);h.classList.add("matched"),h.style.borderColor="var(--color-success)",h.draggable=!1,x.classList.add("matched"),A++,A===j&&v()}}function y(){var d,l;let s=[];if(C.questionsDb&&C.questionsDb.length>0){const f=C.questionsDb.filter(_=>_.type==="typing");s=ot(f,t)}if(s.length===0){const f=((d=C.settings)==null?void 0:d.includeGeneral)||!1;let x=(((l=C.db)==null?void 0:l.vocabulary)||[]).filter(h=>f||h.is_professional);t!=="ALL"&&(t==="meat"?x=x.filter(h=>{var k;return((k=h.tags)==null?void 0:k.includes("meat"))||/viande|boeuf/i.test(h.french)}):t==="sauces"?x=x.filter(h=>{var k;return((k=h.tags)==null?void 0:k.includes("sauce"))||/sauce|fond/i.test(h.french)}):t==="cuts"?x=x.filter(h=>{var k;return((k=h.tags)==null?void 0:k.includes("cutting"))||/coupe|tailler/i.test(h.french)}):t==="science"?x=x.filter(h=>{var k;return((k=h.tags)==null?void 0:k.includes("science"))||/réaction|émulsion/i.test(h.french)}):t==="map"&&(x=x.filter(h=>{var k;return((k=h.tags)==null?void 0:k.includes("map"))||/région|ville/i.test(h.french)}))),s=x.map(h=>({id:h.id,text:`${h.definition_fr}
(Hint Japanese: ${h.japanese})`,acceptedAnswers:[h.french,h.french.toLowerCase()],explanation:`${h.french}: ${h.japanese}`,tags:[h.category]}))}if(s.length===0){m.innerHTML=`
        <div class="quiz-card" style="text-align: center; padding: 2rem;">
      ...
      `;return}const b=de(s).slice(0,10);let v=0,g=0,w=!1;function A(f){const _=f.trim(),h=_.split("").map(S=>/[a-zA-ZàâäéèêëïîôöùûüçÀÂÄÉÈÊËÏÎÔÖÙÛÜÇ]/.test(S)?S.toUpperCase():null).filter(S=>S!==null).join(", "),k=`${_}. ${h}.`;if(typeof window.speechSynthesis<"u"){window.speechSynthesis.cancel();const S=new SpeechSynthesisUtterance(k);S.lang="fr-FR",S.rate=.8,window.speechSynthesis.speak(S)}}function j(f){return f.split(" ").map(_=>{const x=_.replace(/['".,?!();]/g,""),h=x.length;if(h===0)return _;let k="";if(h===1)k="_";else if(h===2)k=x[0]+" _";else if(h===3)k=x[0]+" _ "+x[2];else if(h===4)k=x[0]+" _ _ "+x[3];else if(h===5)k=x[0]+" _ "+x[2]+" _ "+x[4];else{let S=[];for(let T=0;T<h;T++)T===0||T===h-1?S.push(x[T]):T%3===2?S.push("_"):S.push(x[T]);k=S.join(" ")}return k}).join("   ")}function P(){if(m.innerHTML="",w=!1,v>=b.length){const M=Math.round(g/b.length*100);let J="Apprenti (Apprentice)";M>=90?J="Chef de Partie (Station Chef)":M>=70&&(J="Commis de Cuisine (Line Cook)"),m.innerHTML=`
          <div class="quiz-card" style="text-align: center;">
            <h3 style="font-family: var(--font-serif); font-size: 2rem; color: var(--color-primary); margin-bottom: 1rem;">Session Terminée !</h3>
            <p style="font-size: 1.1rem; margin-bottom: 1.5rem;">Your Score: <strong>${g} / ${b.length}</strong> (${M}%)</p>
            <div style="background-color: rgba(197, 168, 128, 0.1); border: 1px solid var(--color-accent); padding: 1.5rem; border-radius: var(--radius-md); margin-bottom: 2rem;">
              <div style="font-size: 0.8rem; text-transform: uppercase; color: var(--color-text-muted); letter-spacing: 1px;">Assigned Rank</div>
        ...
        `,m.querySelector("#restart-spelling-btn").addEventListener("click",()=>{y()});return}const f=b[v],_=document.createElement("div");_.className="quiz-card";const x=f.tags&&f.tags.length>0?f.tags[0]:"orthographe";_.innerHTML=`
        <div class="quiz-meta" style="margin-bottom: 1.2rem;">
          <span>Question ${v+1} of ${b.length}</span>
          <span class="grammar-badge" style="background-color: var(--color-secondary);">${x}</span>
        </div>
      ...
      `,m.appendChild(_);const h=_.querySelector("#spelling-input-field"),k=_.querySelector("#spelling-submit-btn"),S=_.querySelector("#spelling-next-btn"),T=_.querySelector("#spelling-feedback-panel"),L=_.querySelector("#spelling-feedback-title"),$=_.querySelector("#spelling-feedback-msg"),q=_.querySelector("#spelling-hint-voice-btn"),z=_.querySelector("#spelling-hint-text-btn"),E=_.querySelector("#spelling-text-hint-display"),H=f.acceptedAnswers&&f.acceptedAnswers.length>0?f.acceptedAnswers[0]:"";q.addEventListener("click",M=>{M.preventDefault(),A(H)}),z.addEventListener("click",M=>{M.preventDefault();const J=j(H);E.innerText=J,E.style.display="block"}),setTimeout(()=>h.focus(),150),h.addEventListener("keydown",M=>{M.key==="Enter"&&k.click()}),k.addEventListener("click",()=>{if(w)return;w=!0;const M=h.value,J=it(M),K=f.acceptedAnswers.some(ie=>it(ie)===J),te=f.acceptedAnswers[0];h.disabled=!0,k.style.display="none",S.style.display="block",T.style.display="block",K?(g++,h.style.borderColor="var(--color-success)",h.style.backgroundColor="#E8F5E9",T.style.backgroundColor="#E8F5E9",T.style.color="var(--color-success)",L.innerText="✓ Félicitations ! (Correct)",$.innerText=`You correctly spelled: "${te}"`):(h.style.borderColor="var(--color-error)",h.style.backgroundColor="#FFEBEE",T.style.backgroundColor="#FFEBEE",T.style.color="var(--color-error)",L.innerText="✗ Incorrect",$.innerHTML=`Correct spelling is: <strong>${te}</strong>.<br><em style="font-size:0.85rem;">You typed: "${M}"</em>`,st(f.id))}),S.addEventListener("click",()=>{v++,P()})}P()}i()}function $e(){const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Coups de Cœur (Favorites)",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Your bookmarked vocabulary terms, grammar guides, and culinary theories.",e.appendChild(t);const r=Array.from(C.favorites);if(r.length===0)return e.innerHTML+=`
      <div class="alert alert-info">
        <p>No favorites saved yet. Browse Vocabulary, Grammar, or Cuisine and click the star (☆) button to save items here.</p>
      </div>
    `,e;const n=document.createElement("div");return n.className="loading-placeholder",n.innerText="Chargement des favoris... (Loading favorites...)",e.appendChild(n),Ye().then(()=>{n.remove(),sn(e,r)}),e}function sn(e,a){var i,u,c;const t=(((i=C.db)==null?void 0:i.vocabulary)||[]).filter(p=>a.includes(p.id)),r=(((u=C.db)==null?void 0:u.grammar)||[]).filter(p=>a.includes(p.id)),n=(((c=C.db)==null?void 0:c.cuisine)||[]).filter(p=>a.includes(p.id)),o=document.createElement("div");o.className="card-grid",e.appendChild(o);function m(){o.innerHTML="",t.forEach(p=>{const y=document.createElement("div");y.className="card",y.innerHTML=`
        <div>
      ...
      `,y.querySelector(".fav-btn").addEventListener("click",s=>{be(p.id),$e(),e.innerHTML="",e.appendChild($e())}),o.appendChild(y)}),r.forEach(p=>{var s,b;const y=document.createElement("div");y.className="card",y.innerHTML=`
        <div>
        ...
        <div class="term-context" style="margin-top: 0.5rem;">
          ...
          <div class="context-ja">${((b=p.examples[0])==null?void 0:b.ja)||""}</div>
        </div>
      `,y.querySelector(".fav-btn").addEventListener("click",v=>{be(p.id),e.innerHTML="",e.appendChild($e())}),o.appendChild(y)}),n.forEach(p=>{const y=document.createElement("div");y.className="card",y.innerHTML=`
        <div>
      ...
      `,y.querySelector(".fav-btn").addEventListener("click",s=>{be(p.id),e.innerHTML="",e.appendChild($e())}),o.appendChild(y)})}m()}function ln(){const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Pont d'Études (SRS Review Deck)",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Review and grade yourself on items scheduled for active recall today.",e.appendChild(t);const r=document.createElement("div");return r.className="loading-placeholder",r.innerText="Chargement des révisions... (Loading reviews...)",e.appendChild(r),Ye().then(()=>{r.remove(),cn(e)}),e}function cn(e){var u,c,p,y;const a=new Date().toISOString().split("T")[0],r=[...(((u=C.db)==null?void 0:u.vocabulary)||[]).map(s=>({...s,type:"vocabulary",front:s.french})),...(((c=C.db)==null?void 0:c.grammar)||[]).map(s=>({...s,type:"grammar",front:s.topic})),...(((p=C.db)==null?void 0:p.cuisine)||[]).map(s=>({...s,type:"cuisine",front:s.topic})),...(((y=C.db)==null?void 0:y.quizzes)||[]).map(s=>({...s,type:"quiz",front:s.question_fr||s.question||""}))].filter(s=>{const b=C.srs[s.id];return C.wrongAnswers.includes(s.id)||b&&b.dueDate<=a}),n=r.length;let o=0;const m=document.createElement("div");m.className="srs-review-container",e.appendChild(m);function i(){if(m.innerHTML="",r.length===0||o>=r.length){m.innerHTML=`
    ...
    `;v.innerHTML=w;let A="";s.type==="vocabulary"?A=`
      ...
      `;const j=v.querySelector(".flip-translation-container");j&&j.addEventListener("click",P=>{P.stopPropagation(),j.querySelector(".flip-translation-card").classList.toggle("flipped")}),v.querySelectorAll(".audio-btn").forEach(P=>{P.addEventListener("click",d=>{d.stopPropagation();const l=d.target.closest(".audio-btn").getAttribute("data-text");ne(l)})}),v.querySelectorAll(".srs-score-btn").forEach(P=>{P.addEventListener("click",d=>{const l=parseInt(d.target.getAttribute("data-score"));He(s.id,l),l>=4&&b&&Cn(s.id),o++,i()})})}),m.appendChild(v)}i()}function dn(){const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Recherche Globale",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Search terms across the entire curriculum: Vocabulary, Grammar, and Culinary Theory.",e.appendChild(t);const r=document.createElement("div");r.className="search-box-wrapper",r.style.marginBottom="2rem",r.style.position="relative";const n=document.createElement("input");n.type="text",n.placeholder="Chargement de la base de données... (Loading database...)",n.className="search-input",n.style.width="100%",n.style.padding="1rem 1.5rem",n.style.fontSize="1.1rem",n.style.borderRadius="var(--radius-md)",n.style.border="2px solid rgba(197, 168, 128, 0.2)",n.style.backgroundColor="var(--color-bg)",n.style.fontFamily="var(--font-sans)",n.style.transition="var(--transition)",n.style.outline="none",n.disabled=!0,n.addEventListener("focus",()=>{n.style.borderColor="var(--color-accent)",n.style.boxShadow="0 0 10px rgba(212, 175, 55, 0.15)"}),n.addEventListener("blur",()=>{n.style.borderColor="rgba(197, 168, 128, 0.2)",n.style.boxShadow="none"}),r.appendChild(n),e.appendChild(r);const o=document.createElement("div");return o.className="search-results",e.appendChild(o),o.innerHTML=`
    <div style="text-align: center; padding: 3rem; color: var(--color-text-muted);">
      <p>Préparation de la recherche... (Preparing search database...)</p>
    </div>
  `,Ye().then(()=>{n.disabled=!1,n.placeholder="Rechercher... (e.g. sauce, roux, cut, culer, 刻む)";function m(i){var v;if(o.innerHTML="",!i.trim()){o.innerHTML=`
          <div style="text-align: center; padding: 3rem; color: var(--color-text-muted);">
            <span style="font-size: 3rem;">🔍</span>
            <p style="margin-top: 1rem;">Tapez un mot-clé pour commencer votre recherche.</p>
          </div>
        `;return}const u=i.toLowerCase().trim(),c=((v=C.db)==null?void 0:v.knowledge)||[],p=c.filter(g=>g.french&&g.japanese&&!g.grammar&&!g.cuisine),y=c.filter(g=>g.grammar),s=c.filter(g=>g.cuisine),b=[];if(p.forEach(g=>{`${g.french} ${g.english} ${g.japanese} ${g.category} ${g.context_fr} ${g.context_en} ${g.context_ja} ${(g.tags||[]).join(" ")}`.toLowerCase().includes(u)&&b.push({...g,type:"vocabulary",title:g.french,subtitle:`${g.category} • Vocabulary`})}),y.forEach(g=>{`${g.topic} ${g.explanation_en} ${g.explanation_ja} ${g.level} ${(g.tags||[]).join(" ")} ${g.examples.map(A=>`${A.fr} ${A.en} ${A.ja}`).join(" ")}`.toLowerCase().includes(u)&&b.push({...g,type:"grammar",title:g.topic,subtitle:`${g.level} • Grammar Lesson`})}),s.forEach(g=>{const w=g.cuisine;`${w.topic} ${g.category} ${w.content_fr} ${w.content_en} ${w.content_ja} ${(g.tags||[]).join(" ")}`.toLowerCase().includes(u)&&b.push({...g,type:"cuisine",title:w.topic,subtitle:`${g.category} • Culinary Theory`})}),b.length===0){o.innerHTML=`
          <div style="text-align: center; padding: 3rem; color: var(--color-text-muted);">
        ...
        `;return}b.forEach(g=>{const w=document.createElement("div");w.className="card search-result-card",w.style.marginBottom="1.2rem",w.style.borderLeft=`4px solid ${g.type==="vocabulary"?"var(--color-primary)":g.type==="grammar"?"var(--color-secondary)":"var(--color-accent)"}`;const A=fe(g.id);let j="";g.type==="vocabulary"?j=`
          ...
          `);const P=(g.tags||[]).map(f=>`<span class="tag-badge" style="background-color: rgba(197, 168, 128, 0.12); color: var(--color-accent); font-size: 0.75rem; padding: 0.2rem 0.6rem; border-radius: 20px; font-weight: 500;">#${f}</span>`).join(" "),d=g.type==="vocabulary"?Ie(g.french):"",l=d?`<div class="preposition-illustration-container" style="height: 130px; background-color: #fcfbfa; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; margin: 0.8rem 0; overflow: hidden; border: 1px solid rgba(0,0,0,0.03);">${d}</div>`:"";w.innerHTML=`
          <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 1rem;">
            ...
            <button class="fav-btn ${A?"active":""}" data-id="${g.id}">
              ${A?"★":"☆"}
            </button>
          </div>
          ${l}
          ${j}
          ${g.tags&&g.tags.length>0?`<div style="margin-top: 1rem; display: flex; flex-wrap: wrap; gap: 0.4rem;">${P}</div>`:""}
        `,w.querySelector(".fav-btn").addEventListener("click",f=>{f.stopPropagation(),be(g.id);const _=f.target,x=fe(g.id);_.classList.toggle("active",x),_.innerText=x?"★":"☆"}),o.appendChild(w)})}n.addEventListener("input",i=>{m(i.target.value)}),m("")}),e}function mn(){const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Configuration de l'Académie",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Customize your learning goals, target CEFR levels, and database options.",e.appendChild(t);const r=document.createElement("div");r.className="card",r.style.padding="2rem";const n=C.settings;r.innerHTML=`
  ...
  `;const o=r.querySelector("#target-level-select"),m=r.querySelector("#new-cards-goal"),i=r.querySelector("#max-reviews-goal"),u=r.querySelector("#include-general-checkbox"),c=r.querySelector("#settings-status");function p(){const y=o.value,s=parseInt(m.value)||5,b=parseInt(i.value)||20,v=u.checked;Ln({targetLevel:y,newCardsPerDay:s,maxReviewsPerDay:b,includeGeneral:v}),c.style.display="block",setTimeout(()=>{c.style.display="none"},3e3)}return o.addEventListener("change",p),m.addEventListener("input",p),i.addEventListener("input",p),u.addEventListener("change",p),r.querySelector("#reset-srs-btn").addEventListener("click",()=>{confirm("Voulez-vous vraiment réinitialiser toutes vos données de progression SRS ? Cette action est irréversible.")&&(localStorage.removeItem("cba_srs"),C.srs={},alert("Spaced Repetition System progress has been reset."),window.location.reload())}),r.querySelector("#clear-favs-btn").addEventListener("click",()=>{confirm("Voulez-vous vraiment supprimer tous vos favoris ?")&&(localStorage.removeItem("cba_favorites"),C.favorites=new Set,alert("All favorites have been cleared."),window.location.reload())}),r.querySelector("#share-app-btn").addEventListener("click",()=>{const y={title:"Académie de la Brigade",text:"フランス料理・厨房フランス語の統合学習PWAアプリ「Académie de la Brigade」で一緒に料理と語学を学びましょう！",url:window.location.origin+window.location.pathname};navigator.share?navigator.share(y).then(()=>console.log("Shared successfully")).catch(s=>console.log("Error sharing:",s)):navigator.clipboard.writeText(y.url).then(()=>{alert("App link copied to clipboard! Share it with your friends.")}).catch(s=>{console.error("Failed to copy link:",s)})}),e.appendChild(r),e}function un(){var o;const e=document.createElement("div"),a=document.createElement("h2");a.className="section-title",a.innerText="Dictée de Cuisine (Culinary Dictations)",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Listen to French kitchen instruction sentences, type what you hear, and master French spelling.",e.appendChild(t);const r=document.createElement("div");r.className="loading-placeholder",r.innerText="Chargement de la dictée... (Loading dictation...)",e.appendChild(r);const n=((o=C.settings)==null?void 0:o.targetLevel)||"ALL";return se("vocabulary",n).then(()=>{r.remove(),pn(e)}),e}function pn(e){var w,A;const a=((w=C.settings)==null?void 0:w.includeGeneral)||!1,n=(((A=C.db)==null?void 0:A.vocabulary)||[]).filter(j=>a||j.is_professional).filter(j=>j.context_fr);if(n.length===0){e.innerHTML+='<p style="color: var(--color-text-muted);">Aucun exercice disponible.</p>';return}const o=[...n].sort(()=>.5-Math.random()).slice(0,5);let m=0,i=!1,u=!1,c=!1,p=0,y=1;const s=document.createElement("div");s.className="dictation-container",s.style.maxWidth="600px",s.style.margin="1.5rem auto",e.appendChild(s);function b(j){return j.toLowerCase().trim().replace(/[.,\/#!$%\^&\*;:{}=\-_`~()'"?]/g,"").replace(/\s+/g," ")}function v(j){return j.normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function g(){if(s.innerHTML="",i=!1,Ne(),u=!1,c=!1,p=0,m>=o.length){const E=document.createElement("div");E.className="card",E.style.padding="2.5rem",E.style.textAlign="center",E.innerHTML=`
        <h3 style="font-family: var(--font-serif); font-size: 2rem; color: var(--color-primary); margin-bottom: 1rem;">Session Terminée !</h3>
      ...
      `,E.querySelector("#restart-dictation-btn").addEventListener("click",()=>{m=0,o.length=0,o.push(...[...n].sort(()=>.5-Math.random()).slice(0,5)),g()}),s.appendChild(E);return}const j=o[m],P=j.context_fr,d=document.createElement("div");d.className="card",d.style.padding="2rem",d.innerHTML=`
    ...
    `;const l=d.querySelector("#play-pause-btn"),f=d.querySelector("#stop-btn"),_=d.querySelector("#speed-normal-btn"),x=d.querySelector("#speed-slow-btn"),h=d.querySelector("#dictation-seekbar"),k=d.querySelector("#dictation-input"),S=d.querySelector("#check-btn"),T=d.querySelector("#next-dictation-btn"),L=d.querySelector("#dictation-feedback");function $(E,H){if(!i){const M=E/H*100;h.value=Math.round(M),p=E}}function q(){u=!1,c=!1,p=0,l.innerText="▶ Play",h.value=0}function z(){ct(P,y,$,q,p)}l.addEventListener("click",()=>{i||(u?c?(c=!1,l.innerText="⏸ Pause",At()):(c=!0,l.innerText="▶ Play",qt()):(u=!0,c=!1,l.innerText="⏸ Pause",z()))}),f.addEventListener("click",()=>{Ne(),q()}),h.addEventListener("change",E=>{if(i)return;const H=parseInt(E.target.value),M=P.replace(/["'➔]/g,"").trim();p=Math.floor(H/100*M.length);const J=M.indexOf(" ",p);J!==-1&&J-p<5&&(p=J+1),u=!0,c=!1,l.innerText="⏸ Pause",z()}),_.addEventListener("click",()=>{y!==1&&(y=1,_.classList.add("active"),_.style.backgroundColor="var(--color-primary)",_.style.color="#FFFFFF",x.classList.remove("active"),x.style.backgroundColor="transparent",x.style.color="var(--color-accent)",u&&!c&&z())}),x.addEventListener("click",()=>{y!==.75&&(y=.75,x.classList.add("active"),x.style.backgroundColor="var(--color-accent)",x.style.color="#FFFFFF",_.classList.remove("active"),_.style.backgroundColor="transparent",_.style.color="var(--color-accent)",u&&!c&&z())}),S.addEventListener("click",()=>{if(i)return;Ne(),q();const E=k.value,H=b(E),M=b(P),J=v(H),K=v(M);let te=!1,ie=!1;H===M?te=!0:J===K&&(ie=!0),L.style.display="block",k.disabled=!0,S.style.display="none",T.style.display="block",i=!0,te?(L.style.backgroundColor="#E8F5E9",L.style.borderLeft="4px solid var(--color-success)",L.style.color="var(--color-success)",L.innerHTML=`
        ...
        `):ie?(L.style.backgroundColor="#FFF3E0",L.style.borderLeft="4px solid var(--color-accent)",L.style.color="#E65100",L.innerHTML=`
        ...
        `):(L.style.backgroundColor="#FFEBEE",L.style.borderLeft="4px solid var(--color-error)",L.style.color="var(--color-error)",L.innerHTML=`
        ...
        `)}),T.addEventListener("click",()=>{m++,g()}),s.appendChild(d),k.focus()}g()}const gn={proprietress:1.5,kanetake:1.45,saeki:1.45,elodie:1.45,gael:1.45,jean_pierre:1.45,ピエール:1.45};let le=null;function fn(){le||(le=new(window.AudioContext||window.webkitAudioContext))}function Ce(e,a,t,r=.06){try{fn(),(!le||le.state==="suspended")&&le.resume();const n=le.createOscillator(),o=le.createGain();n.type=a||"sine",n.frequency.setValueAtTime(e,le.currentTime),o.gain.setValueAtTime(r,le.currentTime),o.gain.exponentialRampToValueAtTime(.001,le.currentTime+t),n.connect(o),o.connect(le.destination),n.start(),n.stop(le.currentTime+t)}catch{}}function hn(){Ce(780,"sine",.03,.04)}function je(){Ce(523.25,"sine",.08,.08),setTimeout(()=>Ce(659.25,"sine",.15,.08),80)}function Te(){Ce(180,"triangle",.3,.12)}function Be(){Ce(110,"sawtooth",.2,.1)}function yn(){const e=document.createElement("div");return e.className="story-mode-container",Et(e),e}async function Et(e){e.innerHTML=`
  ...
  `,e.querySelectorAll(".play-episode-btn").forEach(n=>{n.addEventListener("click",o=>{const m=o.target.getAttribute("data-chapter"),i=o.target.getAttribute("data-episode");zt(e,m,i)})});const a=e.querySelectorAll(".mode-tab-btn"),t=e.querySelector("#rpg-card-history"),r=e.querySelector("#rpg-card-story");a.forEach(n=>{n.addEventListener("click",()=>{a.forEach(m=>{m.classList.remove("active-tab"),m.style.background="none",m.style.color="var(--color-text-muted)",m.style.boxShadow="none"}),n.classList.add("active-tab"),n.style.background="var(--color-primary)",n.style.color="white",n.style.boxShadow="var(--shadow-sm)",n.getAttribute("data-mode")==="history"?(t.style.display="flex",r.style.display="none"):(t.style.display="none",r.style.display="flex")})})}async function zt(e,a,t){try{e.innerHTML='<div class="story-loader"><div class="spinner"></div><p>物語を読み込んでいます...</p></div>';const r=a==="career_0"?"rpg/story/chapter_career_0.json":`rpg/history/chapter_${a}.json`,[n,o,m]=await Promise.all([fetch(r),fetch("rpg/questions_db.json"),fetch("data/grammar_reference.json").catch(()=>null)]);if(!n.ok)throw new Error("Story file could not be loaded");if(!o.ok)throw new Error("Questions database could not be loaded");const i=await n.json(),u=await o.json();let c=[];m&&m.ok&&(c=await m.json()),C.questionsDb=u,C.grammarRefs=c;const p=i.episodes.find(y=>y.episodeId===t);if(!p)throw new Error("Episode data not found in chapter file");bn(e,p,a,i)}catch(r){e.innerHTML=`
    ...
    `}}function bn(e,a,t,r){let n=0;const o=a.sequence;e.innerHTML=`
  ...
  `;const m=e.querySelector("#rpg-viewport"),i=e.querySelector("#rpg-dialog-pane"),u=e.querySelector("#rpg-battle-pane"),c=e.querySelector("#rpg-reward-pane"),p=e.querySelector("#rpg-tutorial-overlay"),y=e.querySelector("#rpg-sidebar");let s=null,b=!1,v="";function g(){if(b){clearInterval(s);const f=e.querySelector("#dialog-text");f.innerText=v,b=!1;return}if(n>=o.length){Et(e);return}const l=o[n];l.type==="tutorial"?A(l):l.type==="dialog"?j(l):l.type==="fixedBattle"||l.type==="randomBattle"?P(l):l.type==="reward"&&d(l),w(l)}function w(l){let f=m.querySelector(".ai-policy-notice");l&&l.background==="bg_thief_caught.png"||m.style.background&&m.style.background.includes("bg_thief_caught.png")?f||(f=document.createElement("div"),f.className="ai-policy-notice",f.innerText="※AIポリシーの都合により、カミーユはうさぎの縫いぐるみに差し替えられました",m.appendChild(f)):f&&f.remove()}m.addEventListener("click",l=>{l.target.closest("button")||l.target.closest(".battle-question-box")||i.style.display==="none"||g()}),g();function A(l){i.style.display="none",u.style.display="none",c.style.display="none",y.style.opacity="0",y.style.pointerEvents="none";const f=e.querySelector("#rpg-character-layer");f&&(f.innerHTML=""),p.style.display="flex",p.style.flexDirection="column";function _(L,$){const q=$.findIndex(z=>z.includes("フランス語")||z.includes("Pronom")||z.includes("Exemple")||z.includes("活用形"));if(q!==-1){if($[q].includes("活用形")){const z=$.findIndex(E=>E.includes("人称")||E.includes("主語"));if(z!==-1){const E=L[z].split("(")[0].split("（")[0].trim(),H=L[q].trim();return`${E} ${H}`}}return L[q].split("(")[0].split("（")[0].trim()}return L[0].split("(")[0].split("（")[0].trim()}function x(L){if(L)if(typeof ne=="function")ne(L);else{const $=new SpeechSynthesisUtterance(L);$.lang="fr-FR",window.speechSynthesis.speak($)}}function h(L,$){const q=[...L],z=L.findIndex(E=>E.includes("発音")||E.includes("Pronunciation"));return z!==-1&&(q[z]="音声"),`
        <table class="tutorial-table" style="width: 100%; border-collapse: collapse; margin-top: 0.4rem; margin-bottom: 0.6rem; font-size: 0.8rem; box-shadow: var(--shadow-sm); border-radius: var(--radius-sm); overflow: hidden; border: 1px solid rgba(197, 168, 128, 0.2);">
           <thead>
             <tr style="border-bottom: 2px solid rgba(197, 168, 128, 0.3); background: rgba(197, 168, 128, 0.08); color: var(--color-primary);">
               ${q.map(E=>`<th style="padding: 0.4rem; text-align: left; font-weight: 600;">${E}</th>`).join("")}
             </tr>
           </thead>
           <tbody>
             ${$.map(E=>`<tr style="border-bottom: 1px solid rgba(197, 168, 128, 0.1); background: rgba(255,255,255,0.02);">${E.map((M,J)=>J===z?`<td style="padding: 0.4rem; text-align: center;"><button class="play-audio-btn" data-french="${_(E,L)}" style="background: none; border: none; cursor: pointer; font-size: 1.15rem; padding: 2px; line-height: 1; transition: transform 0.1s;" onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">🔊</button></td>`:`<td style="padding: 0.4rem; line-height: 1.4;">${M}</td>`).join("")}</tr>`).join("")}
           </tbody>
         </table>
      `}function k(L){if(!L)return"";let $="";return L.title&&($+=`<div class="ref-sec-title" style="font-weight: bold; margin-top: 0.6rem; margin-bottom: 0.3rem; color: var(--color-primary); font-size: 0.85rem;">${L.title}</div>`),L.text&&($+=`<p style="line-height: 1.4; margin-bottom: 0.4rem; font-size: 0.8rem; color: var(--color-text-main);">${L.text}</p>`),L.type==="table"&&L.headers&&L.rows?$+=h(L.headers,L.rows):L.type==="info"&&($+=`
          <div class="ref-sec-info-box" style="background: rgba(197, 168, 128, 0.08); border-left: 4px solid var(--color-accent); padding: 0.5rem; margin-top: 0.4rem; margin-bottom: 0.6rem; border-radius: 0 var(--radius-sm) var(--radius-sm) 0; font-size: 0.8rem; line-height: 1.45;">
            ${L.content_ja?`<div style="font-weight: 500;">${L.content_ja}</div>`:""}
            ${L.content_fr?`<div style="color: var(--color-text-muted); font-size: 0.75rem; margin-top: 0.2rem;">${L.content_fr}</div>`:""}
          </div>
        `),$}function S(L){L.querySelectorAll(".play-audio-btn").forEach($=>{$.addEventListener("click",q=>{q.stopPropagation();const z=$.getAttribute("data-french");x(z)})})}if(l.targets&&l.targets.length>0)p.innerHTML=`
          ...
          <div>
            ...
            <div class="tutorial-targets-container" style="background: rgba(197, 168, 128, 0.05); padding: 0.8rem; border-radius: var(--radius-md); border: 1px solid rgba(197,168,128,0.2); text-align: left; margin: 0.5rem 0; box-shadow: var(--shadow-sm); overflow-y: auto; max-height: 180px;">
              <ul style="list-style: none; padding-left: 0; display: flex; flex-direction: column; gap: 0.6rem; margin: 0;">
                ${l.targets.map(L=>`<li style="display: flex; gap: 0.4rem; line-height: 1.4; font-size: 0.85rem; font-weight: 500;"><span style="color: var(--color-accent);">🎯</span><span>${L}</span></li>`).join("")}
              </ul>
            </div>
          </div>
      ...
      `,p.querySelector(".start-tut-btn").addEventListener("click",()=>{p.style.display="none",n++,g()});else if(l.pages&&l.pages.length>0){let E=function(H){const M=l.pages[H],J=p.querySelector(".tutorial-page-content");let K=`<h4 style="color: var(--color-accent); font-family: var(--font-serif); font-size: 0.95rem; margin-top: 0; margin-bottom: 0.3rem; border-bottom: 1px solid rgba(197, 168, 128, 0.15); padding-bottom: 0.15rem; line-height: 1.25;">${M.title}</h4>`;if(M.type==="custom")M.text&&(K+=`<p style="white-space: pre-line; line-height: 1.4; font-size: 0.8rem; margin: 0 0 0.4rem 0; color: var(--color-text-main);">${M.text}</p>`),M.headers&&M.rows&&(K+=h(M.headers,M.rows));else if(M.referenceTopicId){const te=C.grammarRefs?C.grammarRefs.find(ie=>ie.id===M.referenceTopicId):null;te?(te.definition_ja&&(K+=`<p style="font-size: 0.75rem; color: var(--color-text-main); font-weight: 500; margin: 0 0 0.4rem 0; line-height: 1.4;">${te.definition_ja}</p>`),M.sectionIndices&&M.sectionIndices.length>0?M.sectionIndices.forEach(ie=>{const Se=te.sections[ie];Se&&(K+=k(Se))}):te.sections&&te.sections.forEach(ie=>{K+=k(ie)})):K+=`<p style="font-size: 0.8rem; color: var(--color-error);">解説データが見つかりませんでした。(${M.referenceTopicId})</p>`}J.innerHTML=K,p.querySelector("#tut-page-curr").innerText=H+1,S(J),L.style.visibility=H===0?"hidden":"visible",$.style.visibility=H===l.pages.length-1?"hidden":"visible",H===l.pages.length-1?q.style.display="block":q.style.display="none",J.scrollTop=0};var T=E;p.innerHTML=`
      ...
      `;const L=p.querySelector(".prev-page-btn"),$=p.querySelector(".next-page-btn"),q=p.querySelector(".start-battle-btn");let z=0;L.addEventListener("click",H=>{H.stopPropagation(),z>0&&(z--,E(z))}),$.addEventListener("click",H=>{H.stopPropagation(),z<l.pages.length-1&&(z++,E(z))}),q.addEventListener("click",H=>{H.stopPropagation(),p.style.display="none",n++,g()}),E(0)}else p.innerHTML=`
      ...
      `,p.querySelector(".start-tut-btn").addEventListener("click",()=>{p.style.display="none",n++,g()})}function j(l){p.style.display="none",u.style.display="none",c.style.display="none",i.style.display="block";const f=a.backgrounds[l.background]||"#000000";m.style.background=f,l.shake&&(m.classList.add("shake-vfx"),setTimeout(()=>m.classList.remove("shake-vfx"),400)),f.includes("url(")?(m.style.backgroundSize="cover",m.style.backgroundPosition="center",m.style.backgroundRepeat="no-repeat"):(m.style.backgroundSize="",m.style.backgroundPosition="",m.style.backgroundRepeat="");const _=e.querySelector("#rpg-character-layer");if(_){_.innerHTML="";const L=f.toLowerCase(),$=L.includes("bg_camille_cry.webp")||L.includes("bg_after_battle.webp")||L.includes("bg_father.webp")||L.includes("bg_room.webp");let q=[];$||(l.characters&&Array.isArray(l.characters)?q=l.characters:l.character&&(q=[{id:l.character,expression:l.expression||"default",position:l.position||"center"}])),q.forEach(z=>{const E=a.characters[z.id],H=z.expression||"default";let M=z.position||"center";q.length===1&&z.id==="proprietress"&&(M="center");let J=null;if(E&&E.images)if(E.images[H])J=E.images[H];else if(H==="default"&&E.images.normal)J=E.images.normal;else{const K=Object.keys(E.images);K.length>0&&(J=E.images[K[0]])}if(J){const K=document.createElement("img");K.src=J,K.className=`rpg-character-sprite pos-${M} sprite-${z.id}`;const te=gn[z.id]||1;K.style.setProperty("--char-scale",te),_.appendChild(K),setTimeout(()=>{K.classList.add("active")},50)}})}const x=l.character?a.characters[l.character]:null,h=e.querySelector("#dialog-name"),k=e.querySelector("#dialog-text");if(h.style.display="none",l.learningPoint){let L=e.querySelector("#lp-title"),$=e.querySelector("#lp-content");(!L||!$)&&(y.innerHTML=`
          <h3>💡 学習ポイント (Point d'Étude)</h3>
          <div class="sidebar-lp-title" id="lp-title"></div>
          <div class="sidebar-lp-content" id="lp-content"></div>
        `,L=e.querySelector("#lp-title"),$=e.querySelector("#lp-content")),L&&(L.innerText=l.learningPoint.title),$&&($.innerText=l.learningPoint.text),y.style.opacity="1",y.style.pointerEvents="auto"}else y.style.opacity="0",y.style.pointerEvents="none";const S=x?`${x.name}：${l.text}`:l.text;k.innerText="",v=S,b=!0;let T=0;clearInterval(s),s=setInterval(()=>{T<S.length?(k.innerText+=S[T],T++,T%2===0&&hn()):(clearInterval(s),b=!1)},30),n++}async function P(l){var ie,Se;i.style.display="none",p.style.display="none",c.style.display="none",y.style.opacity="0",y.style.pointerEvents="none",u.style.display="flex";const f=e.querySelector("#rpg-character-layer");f&&(f.innerHTML=""),u.innerHTML=`
      <div style="margin: auto; text-align: center;">
        <div class="spinner" style="margin: 0 auto 1rem;"></div>
        <p>試練を読み込んでいます...</p>
      </div>
    `;function _(F,O){const Z=C.questionsDb||[];let R=[];if(C.recentQuestionIds||(C.recentQuestionIds=JSON.parse(localStorage.getItem("cba_recent_questions")||"[]")),F&&F.length>0){F.forEach(N=>{const V=N.tag,G=N.count||1;let W=Z.filter(ee=>ee.tags&&ee.tags.includes(V)),Q=W.filter(ee=>!C.recentQuestionIds.includes(ee.id));Q.length===0&&(Q=W),Q=q(Q);const Y=Q.slice(0,G);R=R.concat(Y),Y.forEach(ee=>{C.recentQuestionIds.push(ee.id),C.recentQuestionIds.length>20&&C.recentQuestionIds.shift()})});const D=F.reduce((N,V)=>N+(V.count||1),0);if(R.length<D){const N=D-R.length,V=q(Z.filter(G=>!R.some(W=>W.id===G.id)));R=R.concat(V.slice(0,N))}localStorage.setItem("cba_recent_questions",JSON.stringify(C.recentQuestionIds))}else O&&O.length>0&&(R=q(O));return R}let x=[];if(l.type==="randomBattle")try{await Je();const F=((ie=l.conditions)==null?void 0:ie.level)||"ALL";F!=="ALL"&&await se("vocabulary",F);let O=[...C.db.quizzes];const Z=(Se=l.conditions)==null?void 0:Se.category;Z&&(O=O.filter(D=>D.category&&D.category.toLowerCase()===Z.toLowerCase())),O=q(O);const R=l.enemyHp||3;x=O.slice(0,R).map(D=>{const N=D.options.indexOf(D.answer);return{id:D.id,text:D.question,options:D.options,answerIndex:N!==-1?N:0,explanation:D.context||`正解は「${D.answer}」です。`,acceptedAnswers:[D.answer,D.answer.toLowerCase()]}})}catch(F){console.error("Failed to generate random questions:",F),x=[{id:"fb_err_1",text:"プロヴァンス地方の代表的なスープ料理は？",options:["Bouillabaisse","Bœuf bourguignon","Cassoulet","Choucroute"],answerIndex:0,acceptedAnswers:["Bouillabaisse","bouillabaisse"],explanation:"ブイヤベースはプロヴァンス地方（マルセイユ）の名物です。"}]}else x=_(l.criteria,l.questions);let h=x.map(F=>{let O=F.type||"choice";if((O==="choice"||O==="typing")&&(O=Math.random()>.15?"typing":"choice"),O==="typing"&&!F.acceptedAnswers&&F.options&&F.answerIndex!==void 0){const R=F.options[F.answerIndex].split("(")[0].split("（")[0].trim();return{...F,type:"typing",acceptedAnswers:[R,R.toLowerCase()]}}return{...F,type:O}}),k=l.enemyHp||h.length;const S=k;let T=10;const L=10;let $=0;function q(F){const O=[...F];for(let Z=O.length-1;Z>0;Z--){const R=Math.floor(Math.random()*(Z+1));[O[Z],O[R]]=[O[R],O[Z]]}return O}let z=null;async function E(){if(z)return z;try{return z=await(await fetch("data/grammar_reference.json")).json(),z}catch(F){return console.error("Failed to load battle reference:",F),[]}}async function H(F){if(y.style.opacity==="1")y.style.opacity="0",y.style.pointerEvents="none",F.innerText="📖 参考資料を表示";else{let N=function(G){const W=Z[G];if(!W)return;let Q=`<h4 style="color: var(--color-accent); border-bottom: 1px solid rgba(197,168,128,0.2); padding-bottom: 0.3rem; margin-bottom: 0.6rem;">${W.title_ja} (${W.title_fr})</h4>`;W.sections.forEach(Y=>{if(Q+='<div style="margin-bottom: 1rem;">',Y.title&&(Q+=`<div style="font-weight: bold; font-size: 0.85rem; color: var(--color-primary); margin-bottom: 0.3rem;">${Y.title}</div>`),Y.text&&(Q+=`<p style="white-space: pre-line; margin-bottom: 0.5rem; line-height: 1.4;">${Y.text}</p>`),Y.headers&&Y.rows){const ee=[],re=Y.headers.map((ae,Le)=>ae==="発音"?(ee.push(Le),"音声"):ae);Q+=`
                <table style="width: 100%; border-collapse: collapse; margin: 0.5rem 0; font-size: 0.75rem;">
                  <thead>
                    <tr style="border-bottom: 2px solid rgba(197,168,128,0.3);">
                      ${re.map(ae=>`<th style="padding: 0.3rem; text-align: left; background: rgba(197,168,128,0.05);">${ae}</th>`).join("")}
                    </tr>
                  </thead>
                  <tbody>
                    ${Y.rows.map(ae=>`
                      <tr style="border-bottom: 1px solid rgba(0,0,0,0.05);">
                        ${ae.map((Le,he)=>ee.includes(he)?`<td style="padding: 0.3rem; text-align: center;"><button class="ref-table-audio-btn" data-speak="${ae[he-1]?ae[he-1].split("(")[0].trim():""}" style="background: none; border: none; cursor: pointer; padding: 0; font-size: 0.85rem;">🔊</button></td>`:`<td style="padding: 0.3rem;">${Le}</td>`).join("")}
                      </tr>
                    `).join("")}
                  </tbody>
                </table>
              `}Q+="</div>"}),D.innerHTML=Q,D.querySelectorAll(".ref-table-audio-btn").forEach(Y=>{Y.addEventListener("click",ee=>{ee.stopPropagation();const re=Y.getAttribute("data-speak");if(re&&typeof ne=="function")ne(re);else if(re){const ae=new SpeechSynthesisUtterance(re);ae.lang="fr-FR",window.speechSynthesis.speak(ae)}})})};var O=N;y.style.opacity="1",y.style.pointerEvents="auto",F.innerText="📖 参考資料を隠す",y.innerHTML=`
        ...
        `;const Z=await E();y.innerHTML=`
          ...
          <div style="display: flex; flex-direction: column; gap: 0.5rem; height: calc(100% - 40px); overflow: hidden;">
            <select class="action-btn ref-topic-selector" style="width: 100%; padding: 0.4rem; border-radius: var(--radius-sm); font-size: 0.8rem;">
              ${Z.map((G,W)=>`<option value="${W}">${G.title_ja}</option>`).join("")}
            </select>
        ...
        `;const R=y.querySelector(".ref-topic-selector"),D=y.querySelector(".ref-topic-content");let V=0;if(a.episodeId==="career_ep_0_1"){const G=Z.findIndex(W=>W.id==="ref_essential_irregular_verbs");G!==-1&&(V=G)}else if(a.episodeId==="career_ep_0_2"){const G=Z.findIndex(W=>W.id==="ref_time_expressions");G!==-1&&(V=G)}R.value=V,N(V),R.addEventListener("change",G=>{N(parseInt(G.target.value))})}}function M(){if(k<=0){je(),y.style.opacity="0",y.style.pointerEvents="none",u.innerHTML=`
        ...
        `,u.querySelector(".proceed-battle-btn").addEventListener("click",()=>{n++,g()});return}if(T<=0){Te(),y.style.opacity="0",y.style.pointerEvents="none",u.innerHTML=`
        ...
        `,u.querySelector(".retry-battle-btn").addEventListener("click",()=>{P(l)}),u.querySelector(".exit-battle-btn").addEventListener("click",()=>{var D;const R=(D=l.conditions)==null?void 0:D.category;Ee(R==="grammar"?"grammar":"vocabulary")});return}if($>=h.length){k>0&&(k=0,M());return}const F=h[$],O=`
        <div class="battle-hud">
          <div class="hud-bar-container">
            <span class="hud-label">VOUS (あなた)</span>
            <div class="hud-hp-track">
              <div class="hud-hp-fill player-hp" style="width: ${T/L*100}%"></div>
            </div>
            <span class="hud-value">${T} / ${L}</span>
          </div>
          
          <div class="hud-bar-container">
            <span class="hud-label">${l.enemyName}</span>
            <div class="hud-hp-track">
              <div class="hud-hp-fill enemy-hp" style="width: ${k/S*100}%"></div>
            </div>
            <span class="hud-value">${k} / ${S}</span>
          </div>
        </div>
      `;if(F.type==="typing"){u.innerHTML=`
          ${O}
          <div class="battle-question-box">
            <div class="q-header">Question ${$+1} (スペル入力)</div>
            <div class="q-body" style="white-space: pre-line; line-height: 1.4; font-size: 0.95rem;">${F.text}</div>
        ...
        `;const R=u.querySelector(".battle-input-field"),D=u.querySelector(".submit-typing-btn"),N=u.querySelector(".toggle-battle-ref-btn");setTimeout(()=>R.focus(),150),R.addEventListener("keydown",V=>{V.key==="Enter"&&!D.disabled&&D.click()}),D.addEventListener("click",()=>{const V=R.value;K(V,F,R,D)}),N.addEventListener("click",()=>{H(N)})}else if(F.type==="scramble"){let R=[];const D=q(F.words);u.innerHTML=`
          ${O}
          <div class="battle-question-box">
            <div class="q-header">Question ${$+1} (並び替え)</div>
            <div class="q-body" style="font-size: 0.95rem; margin-bottom: 0.6rem;">${F.text}</div>
            ...
            <div class="scramble-words-pool" style="display: flex; gap: 0.4rem; flex-wrap: wrap; margin-bottom: 0.8rem; justify-content: center;">
              ${D.map((Q,Y)=>`<button class="scramble-word-btn" data-word="${Q}" style="padding: 0.35rem 0.7rem; font-size: 0.85rem; border-radius: 20px; border: 1px solid var(--color-accent); background: none; color: white; cursor: pointer;">${Q}</button>`).join("")}
            </div>
        ...
        `;const N=u.querySelector(".scramble-sentence-bar"),V=u.querySelectorAll(".scramble-word-btn"),G=u.querySelector(".verify-scramble-btn"),W=u.querySelector(".reset-scramble-btn");V.forEach(Q=>{Q.addEventListener("click",()=>{if(Q.disabled)return;const Y=Q.getAttribute("data-word");R.push(Y),Q.disabled=!0,Q.style.opacity="0.3",N.innerText=R.join(" ")})}),W.addEventListener("click",()=>{R=[],N.innerText="",V.forEach(Q=>{Q.disabled=!1,Q.style.opacity="1"})}),G.addEventListener("click",()=>{const Q=R.join(" ");V.forEach(ae=>ae.disabled=!0),G.disabled=!0,W.disabled=!0;const Y=Q.toLowerCase().replace(/[.,!?;:・]/g,"").replace(/\s+/g," ").trim(),ee=F.answer.toLowerCase().replace(/[.,!?;:・]/g,"").replace(/\s+/g," ").trim();te(Y===ee,F)})}else if(F.type==="cloze"){const D=(F.clozeText||F.text).replace(/\[([^\]]+)\]/g,"_______"),N=F.options&&F.options.length>0;u.innerHTML=`
          ${O}
          <div class="battle-question-box">
            <div class="q-header">Question ${$+1} (穴埋め)</div>
            <div class="q-body" style="font-size: 1.1rem; text-align: center; margin: 1rem 0;">${D}</div>
        ...
        `;const V=u.querySelector(".toggle-battle-ref-btn");if(V.addEventListener("click",()=>H(V)),N){const G=u.querySelectorAll(".battle-opt-btn");G.forEach(W=>{W.addEventListener("click",Q=>{const Y=parseInt(Q.target.getAttribute("data-idx"));J(Y,F,G)})})}else{const G=u.querySelector(".battle-input-field"),W=u.querySelector(".submit-typing-btn");setTimeout(()=>G.focus(),150),G.addEventListener("keydown",Q=>{Q.key==="Enter"&&W.click()}),W.addEventListener("click",()=>{const Q=G.value;K(Q,F,G,W)})}}else if(F.type==="matching"){let he=function(){if(!ee||!re)return;const X=ee.getAttribute("data-val"),ce=re.getAttribute("data-val");if(F.pairs.find(pe=>pe.left===X&&pe.right===ce))Ce(440,"sine",.1,.1),ee.style.background="#2E7D32",ee.style.borderColor="#A5D6A7",ee.disabled=!0,re.style.background="#2E7D32",re.style.borderColor="#A5D6A7",re.disabled=!0,ae++,ee=null,re=null,ae===Le&&(je(),k=Math.max(0,k-1),W.innerText="✅ すべてマッチしました！ (Très bien)",W.className="feedback-title text-success",Q.innerText=F.explanation,G.style.display="block",Y.innerText="次の試練へ",Y.onclick=()=>{$++,M()});else{Te(),T=Math.max(0,T-1);const pe=ee,qe=re;if(pe.style.background="#C62828",pe.style.borderColor="#EF9A9A",qe.style.background="#C62828",qe.style.borderColor="#EF9A9A",ee=null,re=null,m.classList.add("shake-vfx"),setTimeout(()=>m.classList.remove("shake-vfx"),400),T<=0){M();return}setTimeout(()=>{if(pe.disabled)return;pe.style.background="rgba(255,255,255,0.05)",pe.style.borderColor="rgba(255,255,255,0.15)",qe.style.background="rgba(255,255,255,0.05)",qe.style.borderColor="rgba(255,255,255,0.15)";const Ke=u.querySelector(".player-hp"),Ze=u.querySelectorAll(".hud-value")[0];Ke&&(Ke.style.width=`${T/L*100}%`),Ze&&(Ze.innerText=`${T} / ${L}`)},800)}};var Z=he;const R=q(F.pairs.map(X=>X.left)),D=q(F.pairs.map(X=>X.right));u.innerHTML=`
          ${O}
          <div class="battle-question-box">
            <div class="q-header">Question ${$+1} (マッチング)</div>
            ...
            <div class="matching-columns-container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.6rem; max-height: 160px; overflow-y: auto; padding: 0.2rem;">
              <div class="left-match-col" style="display: flex; flex-direction: column; gap: 0.4rem;">
                ${R.map((X,ce)=>`<button class="match-card-btn left-card" data-val="${X}" style="padding: 0.45rem; font-size: 0.8rem; border: 1px solid rgba(255,255,255,0.15); background: rgba(255,255,255,0.05); color: white; border-radius: var(--radius-sm); cursor: pointer; text-align: center; outline: none;">${X}</button>`).join("")}
              </div>
              <div class="right-match-col" style="display: flex; flex-direction: column; gap: 0.4rem;">
                ${D.map((X,ce)=>`<button class="match-card-btn right-card" data-val="${X}" style="padding: 0.45rem; font-size: 0.8rem; border: 1px solid rgba(255,255,255,0.15); background: rgba(255,255,255,0.05); color: white; border-radius: var(--radius-sm); cursor: pointer; text-align: center; outline: none;">${X}</button>`).join("")}
              </div>
            </div>
        ...
        `;const N=u.querySelectorAll(".left-card"),V=u.querySelectorAll(".right-card"),G=u.querySelector("#battle-feedback"),W=u.querySelector("#fb-title"),Q=u.querySelector("#fb-desc"),Y=u.querySelector("#next-q-btn");let ee=null,re=null,ae=0;const Le=F.pairs.length;N.forEach(X=>{X.addEventListener("click",()=>{X.disabled||(N.forEach(ce=>{ce.disabled||(ce.style.background="rgba(255,255,255,0.05)",ce.style.borderColor="rgba(255,255,255,0.15)")}),X.style.background="var(--color-accent)",X.style.borderColor="white",ee=X,he())})}),V.forEach(X=>{X.addEventListener("click",()=>{X.disabled||(V.forEach(ce=>{ce.disabled||(ce.style.background="rgba(255,255,255,0.05)",ce.style.borderColor="rgba(255,255,255,0.15)")}),X.style.background="var(--color-accent)",X.style.borderColor="white",re=X,he())})})}else{u.innerHTML=`
          ${O}
          <div class="battle-question-box">
            <div class="q-header">Question ${$+1}</div>
            <div class="q-body" style="white-space: pre-line;">${F.text}</div>
            
            <div class="battle-options-list">
              ${F.options.map((N,V)=>`
                <button class="battle-opt-btn" data-idx="${V}">${N}</button>
              `).join("")}
            </div>
        ...
        `;const R=u.querySelectorAll(".battle-opt-btn"),D=u.querySelector(".toggle-battle-ref-btn");R.forEach(N=>{N.addEventListener("click",V=>{const G=parseInt(V.target.getAttribute("data-idx"));J(G,F,R)})}),D.addEventListener("click",()=>{H(D)})}}function J(F,O,Z){Z.forEach(W=>W.disabled=!0);const R=u.querySelector("#battle-feedback"),D=u.querySelector("#fb-title"),N=u.querySelector("#fb-desc"),V=u.querySelector("#next-q-btn");if(F===O.answerIndex){je(),k=Math.max(0,k-1),D.innerText="✅ 正解！ (Très bien)",D.className="feedback-title text-success",V.innerText="次の試練へ";const W=u.querySelector(".enemy-hp");W&&W.classList.add("flash-white"),V.onclick=()=>{$++,M()}}else Te(),Be(),T=Math.max(0,T-l.enemyDamage),D.innerText="❌ 不正解！",D.className="feedback-title text-error",V.innerText="もう一度挑戦する",m.classList.add("shake-vfx"),setTimeout(()=>m.classList.remove("shake-vfx"),400),V.onclick=()=>{M()};N.innerText=O.explanation,R.style.display="block"}function K(F,O,Z,R){Z.disabled=!0,R.disabled=!0;const D=u.querySelector("#battle-feedback"),N=u.querySelector("#fb-title"),V=u.querySelector("#fb-desc"),G=u.querySelector("#next-q-btn"),W=F.toLowerCase().replace(/[.,!?;:・]/g,"").trim();if(O.acceptedAnswers.some(Y=>W===Y.toLowerCase().replace(/[.,!?;:・]/g,"").trim())){je(),k=Math.max(0,k-1),N.innerText="✅ 正解！ (Très bien)",N.className="feedback-title text-success",G.innerText="次の試練へ";const Y=u.querySelector(".enemy-hp");Y&&Y.classList.add("flash-white"),G.onclick=()=>{$++,M()}}else Te(),Be(),T=Math.max(0,T-2),N.innerText=`❌ 不正解！ (正解: ${O.acceptedAnswers[0]})`,N.className="feedback-title text-error",G.innerText="もう一度挑戦する",m.classList.add("shake-vfx"),setTimeout(()=>m.classList.remove("shake-vfx"),400),G.onclick=()=>{M()};V.innerText=O.explanation,D.style.display="block"}function te(F,O){const Z=u.querySelector("#battle-feedback"),R=u.querySelector("#fb-title"),D=u.querySelector("#fb-desc"),N=u.querySelector("#next-q-btn");if(F){je(),k=Math.max(0,k-1),R.innerText="✅ 正解！ (Très bien)",R.className="feedback-title text-success",N.innerText="次の試練へ";const V=u.querySelector(".enemy-hp");V&&V.classList.add("flash-white"),N.onclick=()=>{$++,M()}}else Te(),Be(),T=Math.max(0,T-2),R.innerText=`❌ 不正解！ (正解: ${O.answer})`,R.className="feedback-title text-error",N.innerText="もう一度挑戦する",m.classList.add("shake-vfx"),setTimeout(()=>m.classList.remove("shake-vfx"),400),N.onclick=()=>{M()};D.innerText=O.explanation,Z.style.display="block"}M()}function d(l){i.style.display="none",u.style.display="none",p.style.display="none",y.style.opacity="0",y.style.pointerEvents="none",c.style.display="block";const f=e.querySelector("#rpg-character-layer");f&&(f.innerHTML=""),localStorage.setItem(`cba_story_${a.episodeId}_cleared`,"true");const x=a.episodeId.startsWith("career_")?"assets/story/career_story/group_photo.webp":"assets/story/chapter_0/bg_after_battle.webp";c.innerHTML=`
      <div class="reward-card animate-fade-in">
        ...
        <p style="text-align: center; margin-bottom: 1rem; font-size: 0.9rem; color: var(--color-text-main);">エピソード「${a.episodeTitle}」をクリアしました！</p>
    ...
    `,c.querySelector(".claim-reward-btn").addEventListener("click",()=>{h()});function h(){c.innerHTML=`
      ...
      `;const T=c.querySelector(".stamp-ink-overlay");setTimeout(()=>{T.style.display="flex",T.classList.add("animate-stamp-stomp"),Be(),m.classList.add("shake-vfx"),setTimeout(()=>m.classList.remove("shake-vfx"),450)},700),setTimeout(()=>{S()},2300)}const k=function(T){let L=document.querySelector(".cba-toast");L&&L.remove(),L=document.createElement("div"),L.className="cba-toast",L.innerText=T,document.body.appendChild(L),setTimeout(()=>{L.classList.add("fade-out"),setTimeout(()=>L.remove(),400)},2500)};function S(){const T=r&&r.episodes?r.episodes.findIndex(E=>E.episodeId===a.episodeId):-1,L=T!==-1&&r.episodes[T+1]?r.episodes[T+1]:null;c.innerHTML=`
        <div class="reward-card end-screen-card animate-fade-in">
          ...
          <p style="text-align: center; margin-bottom: 1.5rem; font-size: 0.9rem; color: var(--color-text-muted);">エピソード「${a.episodeTitle}」をすべてクリアしました！</p>
      ...
      `;const $=c.querySelector(".home-btn"),q=c.querySelector(".share-btn"),z=c.querySelector(".next-ep-btn");$.addEventListener("click",()=>{Ee("home")}),L&&z&&z.addEventListener("click",()=>{zt(e,t,L.episodeId)}),q.addEventListener("click",()=>{const E=`CHEF BRIGADE ACADEMYでフランス語と料理の修行中！「${a.episodeTitle}」をクリアしました！みんなも一緒に楽しく学習しよう！ #ChefBrigadeAcademy`;navigator.share?navigator.share({title:"Chef Brigade Academy",text:E,url:window.location.href}).catch(H=>{console.log("Error sharing:",H)}):navigator.clipboard.writeText(E).then(()=>{k("シェア用テキストをクリップボードにコピーしました！")}).catch(H=>{console.error("Could not copy text: ",H)})})}}}let Re=null,ue="preview",oe=0,we=null;function _n(){const e=document.createElement("div");e.className="reading-container-view",C.settings||(C.settings={}),C.settings.readingHelper||(C.settings.readingHelper={outlines:!0,translations:!0,targetOnly:!1,pureText:!1});const a=document.createElement("h2");a.className="section-title",a.innerText="Lecture de Cuisine (Culinary Reading)",e.appendChild(a);const t=document.createElement("p");t.className="section-subtitle",t.innerText="Immerse yourself in authentic French culinary articles. Decode grammar and vocabulary interactively as you read.",e.appendChild(t);const r=document.createElement("div");return r.className="loading-placeholder",r.innerText="Chargement des articles... (Loading articles...)",e.appendChild(r),se("knowledge","ALL").then(()=>{fetch("data/articles.json").then(n=>{if(!n.ok)throw new Error("Could not load articles");return n.json()}).then(n=>{if(C.db.articles=n,r.remove(),Re){const o=n.find(m=>m.id===Re.id)||n[0];ge(e,o)}else Ue(e,n)}).catch(n=>{r.innerText="Erreur de chargement. (Loading error.)",console.error(n)})}),document.addEventListener("click",vn),e}function vn(e){we&&!e.target.closest(".anatomy-tooltip")&&!e.target.closest(".anatomy-token")&&!e.target.closest(".learning-badge")&&(we.remove(),we=null)}function Ue(e,a){Re=null,ue="preview",oe=0;const t=document.createElement("div");t.className="magazine-grid",t.style.display="grid",t.style.gridTemplateColumns="repeat(auto-fit, minmax(320px, 1fr))",t.style.gap="2rem",t.style.marginTop="2rem",a.forEach(r=>{const n=document.createElement("div");n.className="magazine-card",n.style.cursor="pointer";const o=r.image?`<img src="${r.image}" class="magazine-cover" style="width: 100%; height: 200px; object-fit: cover; border-radius: var(--radius-md) var(--radius-md) 0 0;" onerror="this.src='assets/cheese_wine.png'">`:'<div class="magazine-cover-placeholder" style="width: 100%; height: 200px; background-color: var(--color-primary); border-radius: var(--radius-md) var(--radius-md) 0 0; display: flex; align-items: center; justify-content: center; color: white; font-family: var(--font-serif); font-size: 1.5rem; font-weight: bold;">Cuisine</div>';n.innerHTML=`
      ${o}
      <div style="padding: 1.5rem; display: flex; flex-direction: column; gap: 0.8rem;">
        <span class="card-category" style="margin: 0; width: fit-content;">${r.category}</span>
        <h3 class="magazine-card-title" style="font-family: var(--font-serif); font-size: 1.35rem; color: var(--color-primary);">${r.title_fr}</h3>
        <p style="font-size: 0.85rem; color: var(--color-text-muted); font-style: italic;">${r.title_ja}</p>
        <p style="font-size: 0.9rem; line-height: 1.5; color: var(--color-text-main);">${r.overview.context_ja}</p>
    ...
    `,n.addEventListener("click",()=>{Re=r,ue="preview",oe=0,ge(e,r)}),t.appendChild(n)}),e.appendChild(t)}function ge(e,a){e.innerHTML="",ue==="preview"?xn(e,a):ue==="practice"?kn(e,a):ue==="complete"&&wn(e,a)}function me(e){const a=C.settings.readingHelper;e.classList.toggle("hide-outlines",!a.outlines||a.pureText),e.classList.toggle("hide-translations",!a.translations||a.pureText),e.classList.toggle("highlight-target-only",a.targetOnly),e.classList.toggle("pure-text-mode",a.pureText)}function xn(e,a){var x;const t=((x=C.settings)==null?void 0:x.targetLevel)||"ALL";let r="débutant";["B1","B2","intermédiaire"].includes(t)?r="intermédiaire":["C1","C2","avancé"].includes(t)&&(r="avancé");const n=r==="débutant",o=r==="intermédiaire",m=r==="avancé",i=document.createElement("button");i.className="next-btn",i.style.backgroundColor="transparent",i.style.border="1px solid var(--color-primary)",i.style.color="var(--color-primary)",i.style.padding="0.4rem 1rem",i.style.marginBottom="1.5rem",i.innerText="← Retour aux articles (Back)",i.addEventListener("click",()=>{Ue(e,[a])}),e.appendChild(i);const u=document.createElement("div");u.className="magazine-header",u.style.textAlign="center",u.style.marginBottom="2.5rem",u.innerHTML=`
    ...
    <span style="display: block; font-size: 0.8rem; font-weight: bold; letter-spacing: 1.5px; text-transform: uppercase; color: var(--color-accent); margin: 0.5rem auto 0.6rem auto; width: fit-content;">${a.category}</span>
    <h1 style="font-family: var(--font-serif); font-size: 2.2rem; font-weight: 700; color: var(--color-primary); line-height: 1.25; margin-bottom: 0.5rem;">${a.title_fr}</h1>
    <h2 style="font-size: 1.1rem; color: var(--color-text-muted); font-weight: 500; font-style: italic; margin-bottom: 1rem;">${a.title_ja}</h2>
  ...
  `,e.appendChild(u);const c=document.createElement("div");c.className="reading-helper-panel",c.innerHTML=`
  ...
  `,e.appendChild(c);const p=new Map,y=new Map;a.sessions.forEach(h=>{h.tokens.forEach(k=>{if(k.vocab_id){const S=C.db.knowledge.find(T=>T.id===k.vocab_id);S&&p.set(k.vocab_id,S.french)}if(k.gram_id){const S=C.db.knowledge.find(T=>T.id===k.gram_id);S&&S.grammar&&y.set(k.gram_id,S.grammar.topic)}})});const s=document.createElement("div");s.className="card",s.style.backgroundColor="#f7f9fc",s.style.border="1px solid rgba(0,0,91,0.06)",s.style.padding="1.5rem",s.style.borderRadius="10px",s.style.marginBottom="2rem";let b="";p.forEach((h,k)=>{b+=`<button class="learning-badge" data-id="${k}" style="margin: 0.2rem; padding: 0.25rem 0.6rem; font-size: 0.78rem; border-radius: 4px; border: 1px solid rgba(0,0,91,0.1); background-color: #ffffff; color: var(--color-primary); font-weight: 600; cursor: pointer; transition: all 0.2s;">${h}</button>`});let v="";y.forEach((h,k)=>{v+=`<button class="learning-badge" data-id="${k}" style="margin: 0.2rem; padding: 0.25rem 0.6rem; font-size: 0.78rem; border-radius: 4px; border: 1px solid rgba(107,156,104,0.15); background-color: #ffffff; color: var(--color-success); font-weight: 600; cursor: pointer; transition: all 0.2s;">${h}</button>`}),s.innerHTML=`
    ...
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      <div>
        ...
        <div style="display: flex; flex-wrap: wrap;">${b||'<span style="font-size:0.8rem; color:#888;">Aucun vocabulaire</span>'}</div>
      </div>
      <div>
  ...
  `,s.querySelectorAll(".learning-badge").forEach(h=>{h.addEventListener("click",k=>{k.stopPropagation();const S=h.getAttribute("data-id"),T=S.startsWith("gram_")?{gram_id:S}:{vocab_id:S};Ve(h,T,"")})}),e.appendChild(s);const g=document.createElement("div");g.style.textAlign="center",g.style.marginTop="3.5rem",g.style.marginBottom="3.5rem";const w=document.createElement("div");w.style.display="inline-flex",w.style.alignItems="center",w.style.justifyContent="center",w.style.gap="1.2rem",w.style.flexWrap="wrap";const A=document.createElement("button");A.className="start-practice-btn",A.innerText="🎓 Commencer l'entraînement (問題を解くモードに入る)",A.addEventListener("click",()=>{ue="practice",oe=0,ge(e,a)});const j=document.createElement("div");j.style.display="inline-flex",j.style.alignItems="center",j.style.gap="0.5rem";const P=document.createElement("span");P.style.fontSize="0.8rem",P.style.fontWeight="bold",P.style.color="var(--color-text-muted)",P.innerText="Niveau (Level) :";const d=document.createElement("select");d.style.padding="0.6rem 1.2rem",d.style.fontSize="0.9rem",d.style.borderRadius="50px",d.style.border="1px solid rgba(0,0,0,0.15)",d.style.backgroundColor="#FFFFFF",d.style.cursor="pointer",d.style.fontFamily="var(--font-sans)",d.style.fontWeight="600",d.style.color="var(--color-primary)",d.style.outline="none",[{val:"débutant",label:"Débutant (初級)"},{val:"intermédiaire",label:"Intermédiaire (中級)"},{val:"avancé",label:"Avancé (上級)"}].forEach(h=>{const k=document.createElement("option");k.value=h.val,k.text=h.label,h.val===r&&(k.selected=!0),d.appendChild(k)}),d.addEventListener("change",h=>{C.settings.targetLevel=h.target.value,ge(e,a)}),j.appendChild(P),j.appendChild(d),w.appendChild(A),w.appendChild(j),g.appendChild(w),e.appendChild(g);const f=document.createElement("div");f.className="magazine-body-container",f.style.maxWidth="720px",f.style.margin="0 auto",f.style.display="flex",f.style.flexDirection="column",f.style.gap="2.2rem",a.sessions.forEach((h,k)=>{const S=document.createElement("div");S.className="ref-session-card",S.style.borderLeft="4px solid var(--color-accent)",S.style.padding="1.8rem",S.style.backgroundColor="#ffffff";const T=`
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.6rem;">
        <span style="font-size: 0.72rem; text-transform: uppercase; font-weight: bold; letter-spacing: 1px; color: var(--color-text-muted);">Section ${k+1}: ${h.title}</span>
        <button class="section-audio-btn" data-text="${h.text_fr.replace(/"/g,"&quot;")}" style="background: none; border: none; font-size: 1.15rem; cursor: pointer; color: var(--color-accent); padding: 0.2rem; line-height: 1;" title="Lire la section">🔊</button>
      </div>
    `,L=document.createElement("div");L.className="ref-para-fr",L.style.fontSize="1.18rem",L.style.lineHeight="1.8",L.style.fontFamily="var(--font-serif)",L.style.marginBottom="1rem",L.style.color="var(--color-primary)",k===0&&L.classList.add("editorial-dropcap"),h.tokens.forEach((q,z)=>{const E=document.createElement("span");E.className=`anatomy-token token-pos-${q.pos} has-definition`,E.innerText=q.word+" ";const H=h.tokens.slice(z).map(M=>M.word).join(" ");(q.vocab_id||q.gram_id)&&(E.setAttribute("data-has-db","true"),n?q.pos==="noun"?E.style.borderBottom="2px solid rgba(0, 0, 91, 0.25)":q.pos==="verb"?E.style.borderBottom="2px solid rgba(107, 156, 104, 0.35)":q.pos==="article_partitive"?E.style.borderBottom="2px dashed rgba(220, 38, 38, 0.35)":q.pos==="preposition"&&(E.style.borderBottom="2px dotted rgba(197, 168, 128, 0.5)"):o?E.style.borderBottom="1px solid rgba(0, 0, 0, 0.12)":m&&(E.style.borderBottom="none")),E.addEventListener("click",M=>{M.stopPropagation(),Ve(E,q,H)}),L.appendChild(E)});const $=document.createElement("div");if($.className="ref-para-ja",$.style.fontSize="0.94rem",$.style.lineHeight="1.6",$.style.color="var(--color-text-muted)",$.style.paddingTop="0.8rem",$.style.borderTop="1px dashed #eaeaea",$.innerHTML=h.text_ja.split(`
`).join("<br>"),S.appendChild(document.createRange().createContextualFragment(T)),S.appendChild(L),n)S.appendChild($);else{const q=document.createElement("a");q.href="#",q.className="toggle-translation-link",q.style.fontSize="0.78rem",q.style.color="var(--color-accent)",q.style.textDecoration="underline",q.style.display="block",q.style.marginTop="0.5rem",q.innerText="Afficher la traduction (日本語訳を表示)",$.style.display="none",q.addEventListener("click",z=>{z.preventDefault(),$.style.display==="none"?($.style.display="block",q.innerText="Masquer la traduction (翻訳を非表示)"):($.style.display="none",q.innerText="Afficher la traduction (日本語訳を表示)")}),S.appendChild(q),S.appendChild($)}f.appendChild(S)}),f.querySelectorAll(".section-audio-btn").forEach(h=>{h.addEventListener("click",k=>{k.stopPropagation(),ne(h.getAttribute("data-text"))})}),(()=>{c.querySelector("#helper-toggle-outlines").addEventListener("change",h=>{C.settings.readingHelper.outlines=h.target.checked,h.target.checked&&(C.settings.readingHelper.pureText=!1,c.querySelector("#helper-toggle-pure").checked=!1),me(f)}),c.querySelector("#helper-toggle-translations").addEventListener("change",h=>{C.settings.readingHelper.translations=h.target.checked,h.target.checked&&(C.settings.readingHelper.pureText=!1,c.querySelector("#helper-toggle-pure").checked=!1),me(f)}),c.querySelector("#helper-toggle-target").addEventListener("change",h=>{C.settings.readingHelper.targetOnly=h.target.checked,me(f)}),c.querySelector("#helper-toggle-pure").addEventListener("change",h=>{C.settings.readingHelper.pureText=h.target.checked,h.target.checked&&(C.settings.readingHelper.outlines=!1,C.settings.readingHelper.translations=!1,c.querySelector("#helper-toggle-outlines").checked=!1,c.querySelector("#helper-toggle-translations").checked=!1),me(f)})})(),me(f),e.appendChild(f)}function kn(e,a){var s;const t=((s=C.settings)==null?void 0:s.targetLevel)||"ALL";let r="débutant";["B1","B2","intermédiaire"].includes(t)?r="intermédiaire":["C1","C2","avancé"].includes(t)&&(r="avancé");const n=r==="débutant",o=r==="intermédiaire",m=r==="avancé",i=document.createElement("button");i.className="next-btn",i.style.backgroundColor="transparent",i.style.border="1px solid var(--color-secondary)",i.style.color="var(--color-secondary)",i.style.padding="0.4rem 1rem",i.style.marginBottom="1.5rem",i.innerText="← Quitter l'entraînement (戻る)",i.addEventListener("click",()=>{ue="preview",ge(e,a)}),e.appendChild(i);const u=document.createElement("div");u.className="magazine-header",u.style.textAlign="center",u.style.marginBottom="2.5rem",u.innerHTML=`
  ...
  `,e.appendChild(c);const p=document.createElement("div");p.className="magazine-body-container",p.style.maxWidth="720px",p.style.margin="0 auto",p.style.display="flex",p.style.flexDirection="column",p.style.gap="2rem",a.sessions.forEach((b,v)=>{const g=document.createElement("div");g.id=`session-card-${v}`;let w="ref-locked-session";v===oe?w="ref-active-session":v<oe&&(w="ref-completed-session"),g.className=`ref-session-card ${w}`;const A=document.createElement("div");A.style.display="flex",A.style.justifyContent="space-between",A.style.alignItems="center",A.style.marginBottom="0.8rem",A.innerHTML=`
      <div style="display: flex; align-items: center; gap: 0.6rem;">
        <span style="font-size: 0.75rem; text-transform: uppercase; font-weight: bold; letter-spacing: 1px; color: var(--color-text-muted);">Section ${v+1}: ${b.title}</span>
        ${v<=oe?`<button class="section-audio-btn" data-text="${b.text_fr.replace(/"/g,"&quot;")}" style="background: none; border: none; font-size: 1rem; cursor: pointer; color: var(--color-accent); padding: 0.1rem; line-height: 1;" title="Lire la section">🔊</button>`:""}
      </div>
      ${v<oe?'<span style="color: var(--color-success); font-size: 0.8rem; font-weight: 700;">✓ Complétée</span>':""}
    `,g.appendChild(A);const j=document.createElement("div");if(j.className="ref-text-block",v<oe)j.innerHTML=`
...
`).join("<br>")}
      ...
      `;else if(v===oe){const P=document.createElement("div");P.className="ref-para-fr",P.style.fontSize="1.15rem",P.style.lineHeight="1.8",P.style.fontFamily="var(--font-serif)",P.style.marginBottom="1.5rem",v===0&&P.classList.add("editorial-dropcap"),b.tokens.forEach((f,_)=>{const x=document.createElement("span");x.className=`anatomy-token token-pos-${f.pos} has-definition`,x.innerText=f.word+" ";const h=b.tokens.slice(_).map(k=>k.word).join(" ");(f.vocab_id||f.gram_id)&&(x.setAttribute("data-has-db","true"),n?f.pos==="noun"?x.style.borderBottom="2px solid var(--color-primary)":f.pos==="verb"?x.style.borderBottom="2px solid var(--color-success)":f.pos==="article_partitive"?x.style.borderBottom="2px dashed var(--color-secondary)":f.pos==="preposition"&&(x.style.borderBottom="2px dotted var(--color-accent)"):o?x.style.borderBottom="1px solid rgba(0,0,0,0.12)":m&&(x.style.borderBottom="none")),x.addEventListener("click",k=>{k.stopPropagation(),Ve(x,f,h)}),P.appendChild(x)}),j.appendChild(P);const d=document.createElement("div");d.className="ref-quiz-container",d.style.marginTop="1.5rem",d.style.padding="1.2rem",d.style.backgroundColor="#fdfcf7",d.style.border="1px solid var(--color-accent)",d.style.borderRadius="8px";const l=b.quizzes.find(f=>f.target_level===r)||b.quizzes[0];if(l){let f="";if(l.type==="choice"||l.type==="structure_analysis"){const _=m&&l.options_fr,x=_?l.options_fr:l.options,h=_?l.answer_fr:l.answer;f=`
            <div style="display: flex; flex-direction: column; gap: 0.5rem; margin-top: 0.8rem;">
              ${x.map(T=>`
                <label style="display: flex; align-items: center; gap: 0.6rem; font-size: 0.9rem; cursor: pointer;">
                  <input type="radio" name="quiz-${l.id}" value="${T}">
                  <span>${T}</span>
                </label>
              `).join("")}
            </div>
          ...
          `;const k=d.querySelector(".quiz-submit-btn"),S=d.querySelector(".quiz-feedback-msg");k.addEventListener("click",()=>{const T=d.querySelector(`input[name="quiz-${l.id}"]:checked`);T&&T.value===h?(S.style.color="var(--color-success)",S.innerText="✓ Correct ! Excellent !",k.style.display="none",setTimeout(()=>{ke(e,a,v)},1e3)):(S.style.color="var(--color-error)",S.innerText="❌ Incorrect. Réessayez !")})}else if(l.type==="preposition"){f=`
            <div style="margin-top: 0.8rem;">
              <select id="preposition-select-${l.id}" style="padding: 0.5rem 1rem; font-size: 0.9rem; border-radius: 4px; border: 1px solid rgba(0,0,91,0.15); background-color: white; outline: none; width: 100%; max-width: 250px; font-weight: 600;">
                ...
                ${l.options.map(h=>`<option value="${h}">${h}</option>`).join("")}
              </select>
            </div>
          `,d.innerHTML=`
          ...
          `;const _=d.querySelector(".quiz-submit-btn"),x=d.querySelector(".quiz-feedback-msg");_.addEventListener("click",()=>{d.querySelector(`#preposition-select-${l.id}`).value===l.answer?(x.style.color="var(--color-success)",x.innerText="✓ Correct ! Très bien !",_.style.display="none",setTimeout(()=>{ke(e,a,v)},1e3)):(x.style.color="var(--color-error)",x.innerText="❌ Incorrect. Réessayez !")})}else if(l.type==="word_order"){d.innerHTML=`
          ...
          `;const _=d.querySelector(".selected-chips-area"),x=d.querySelector(".shuffled-chips-area"),h=d.querySelector(".quiz-submit-btn"),k=d.querySelector(".quiz-feedback-msg");let S=[],T=[...l.options].sort(()=>Math.random()-.5);const L=()=>{_.innerHTML="",x.innerHTML="",S.length===0&&(_.innerHTML='<span style="font-size: 0.8rem; color: #888; font-style: italic; align-self: center;">Cliquez sur les mots ci-dessous...</span>'),S.forEach(($,q)=>{const z=document.createElement("span");z.className="word-chip selected",z.innerText=$,z.addEventListener("click",()=>{S.splice(q,1),T.push($),L()}),_.appendChild(z)}),T.forEach(($,q)=>{const z=document.createElement("span");z.className="word-chip",z.innerText=$,z.addEventListener("click",()=>{T.splice(q,1),S.push($),L()}),x.appendChild(z)})};L(),h.addEventListener("click",()=>{const $=S.join(" "),q=l.answer_words.join(" ");$===q?(k.style.color="var(--color-success)",k.innerText="✓ Correct ! Formidable !",h.style.display="none",_.style.pointerEvents="none",x.style.pointerEvents="none",setTimeout(()=>{ke(e,a,v)},1e3)):(k.style.color="var(--color-error)",k.innerText="❌ Ordre incorrect. Réessayez !")})}else if(l.type==="kitchen_situation"){f=`
          ...
          `;const _=d.querySelector(".quiz-submit-btn"),x=d.querySelector(".quiz-feedback-msg");_.addEventListener("click",()=>{d.querySelector(`#quiz-input-${l.id}`).value.trim().toLowerCase()===l.blank_word.toLowerCase()?(x.style.color="var(--color-success)",x.innerText="✓ Oui, Chef ! Correct !",_.style.display="none",setTimeout(()=>{ke(e,a,v)},1e3)):(x.style.color="var(--color-error)",x.innerText="❌ Ce n'est pas tout à fait ça. Réessayez !")})}else if(l.type==="input"||l.type==="conjugation"){f=`
            <div style="margin-top: 0.8rem;">
          ...
          `;const _=d.querySelector(".quiz-submit-btn"),x=d.querySelector(".quiz-feedback-msg");let h=0;_.addEventListener("click",()=>{if(d.querySelector(`#quiz-input-${l.id}`).value.trim().toLowerCase()===l.blank_word.toLowerCase())x.style.color="var(--color-success)",x.innerText="✓ Correct ! Excellent !",_.style.display="none",setTimeout(()=>{ke(e,a,v)},1e3);else if(h++,x.style.color="var(--color-error)",n&&h>=2){const S=l.blank_word[0].toUpperCase();x.innerText=`❌ Incorrect. Indice : commence par "${S}"`}else x.innerText="❌ Incorrect. Réessayez !"})}}else d.innerHTML=`
        ...
        `,d.querySelector(".validate-session-btn").addEventListener("click",()=>{ke(e,a,v)});j.appendChild(d)}else j.innerHTML=`
...
`).join("<br>")}
      ...
      `;g.appendChild(j),p.appendChild(g)}),p.querySelectorAll(".section-audio-btn").forEach(b=>{b.addEventListener("click",v=>{v.stopPropagation(),ne(b.getAttribute("data-text"))})}),(()=>{c.querySelector("#helper-toggle-outlines").addEventListener("change",b=>{C.settings.readingHelper.outlines=b.target.checked,b.target.checked&&(C.settings.readingHelper.pureText=!1,c.querySelector("#helper-toggle-pure").checked=!1),me(p)}),c.querySelector("#helper-toggle-translations").addEventListener("change",b=>{C.settings.readingHelper.translations=b.target.checked,b.target.checked&&(C.settings.readingHelper.pureText=!1,c.querySelector("#helper-toggle-pure").checked=!1),me(p)}),c.querySelector("#helper-toggle-target").addEventListener("change",b=>{C.settings.readingHelper.targetOnly=b.target.checked,me(p)}),c.querySelector("#helper-toggle-pure").addEventListener("change",b=>{C.settings.readingHelper.pureText=b.target.checked,b.target.checked&&(C.settings.readingHelper.outlines=!1,C.settings.readingHelper.translations=!1,c.querySelector("#helper-toggle-outlines").checked=!1,c.querySelector("#helper-toggle-translations").checked=!1),me(p)})})(),me(p),e.appendChild(p)}function ke(e,a,t){oe=t+1,oe>=a.sessions.length?(ue="complete",ge(e,a)):(ge(e,a),setTimeout(()=>{const r=document.getElementById(`session-card-${oe}`);r&&r.scrollIntoView({behavior:"smooth",block:"center"})},100))}function wn(e,a){const t=document.createElement("div");t.className="magazine-header",t.style.textAlign="center",t.style.marginBottom="2.5rem",t.innerHTML=`
    <div style="font-family: var(--font-serif); font-size: 0.85rem; letter-spacing: 2px; text-transform: uppercase; color: var(--color-text-muted); margin-bottom: 0.5rem; border-bottom: 2px double rgba(0,0,91,0.1); padding-bottom: 0.4rem; font-weight: bold;">
      Lecteur Complet — Version Prémice
    </div>
    <h1 style="font-family: var(--font-serif); font-size: 2.5rem; font-weight: 700; color: var(--color-primary); line-height: 1.25; margin-top: 1rem; margin-bottom: 0.5rem;">${a.title_fr}</h1>
    <h2 style="font-size: 1.1rem; color: var(--color-text-muted); font-weight: 500; font-style: italic; margin-bottom: 1.5rem;">${a.title_ja}</h2>
  ...
  `,e.appendChild(t);const r=document.createElement("div");r.className="newspaper-columns",r.style.fontSize="1.18rem",r.style.lineHeight="1.8",r.style.fontFamily="var(--font-serif)",r.style.color="var(--color-primary)",r.style.marginBottom="2.5rem";let n="";a.sessions.forEach((u,c)=>{n+=`
      <p class="${c===0?"editorial-dropcap":""}" style="margin-bottom: 1.5rem; text-align: justify; text-justify: inter-word;">
        ${u.text_fr.split(`
`).join("<br>")}
      </p>
    `}),r.innerHTML=n,e.appendChild(r);const o=document.createElement("div");o.style.display="flex",o.style.justifyContent="center",o.style.gap="1rem",o.style.marginTop="2rem";const m=document.createElement("button");m.className="next-btn",m.innerText="← Retour à l'aperçu (予習モードに戻る)",m.addEventListener("click",()=>{ue="preview",oe=0,ge(e,a)});const i=document.createElement("button");i.className="next-btn",i.style.backgroundColor="transparent",i.style.border="1px solid var(--color-primary)",i.style.color="var(--color-primary)",i.innerText="📚 Liste des articles (目次へ戻る)",i.addEventListener("click",()=>{Ue(e,[a])}),o.appendChild(m),o.appendChild(i),e.appendChild(o)}function Ve(e,a,t){we&&we.remove();const r=document.createElement("div");r.className="anatomy-tooltip card",r.style.position="absolute",r.style.zIndex="1000",r.style.padding="1rem",r.style.width="290px",r.style.boxShadow="var(--shadow-lg)",r.style.border="1px solid rgba(0, 0, 91, 0.15)",r.style.borderRadius="8px",r.style.backgroundColor="#FFFFFF";const n=a.vocab_id||a.gram_id,o=C.db.knowledge.find(v=>v.id===n),i={noun:"Nom (名詞)",verb:"Verbe (動詞)",preposition:"Préposition (前置詞)",article_partitive:"Article partitif (部分冠詞)",article:"Article (冠詞)",pronoun_subject:"Pronom (代名詞)",conjunction:"Conjonction (接続詞)",other:"Autre (その他)"}[a.pos]||a.pos||"Autre (その他)";let u="";if(a.analysis&&(u=`
      <div style="font-size: 0.78rem; background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 0.5rem; border-radius: 4px; margin-top: 0.5rem; margin-bottom: 0.5rem;">
        ...
        <strong>Base:</strong> ${a.analysis.lemma} (${a.analysis.group})<br>
        <strong>Forme:</strong> ${a.analysis.tense}<br>
        <span style="font-size: 0.75rem; color: var(--color-text-main); display: block; margin-top: 0.3rem; font-style: italic;">
          🇯🇵 ${a.analysis.context_ja}
        </span>
      </div>
    `),o){const v=!!o.french,g=`<span style="font-size: 0.85rem; font-weight: bold; color: var(--color-secondary);">${o.level}</span>`;if(v){const w=o.gender?o.gender==="m"?"Masculin":o.gender==="f"?"Féminin":"M/F":"",A=w?`<span style="font-size: 0.7rem; font-weight: 600; padding: 0.05rem 0.3rem; border-radius: 3px; background-color: #f0f4f8; color: var(--color-primary); border: 1px solid rgba(0,0,91,0.1);">${w}</span>`:"",j=o.verb_group?o.verb_group===1?"1er groupe":o.verb_group===2?"2e groupe":"3e groupe":"",P=j?`<span style="font-size: 0.7rem; font-weight: 600; padding: 0.05rem 0.3rem; border-radius: 3px; background-color: rgba(107,156,104,0.08); color: var(--color-success); border: 1px solid rgba(107,156,104,0.15);">${j}</span>`:"";r.innerHTML=`
      ...
      <strong style="font-size: 1.1rem; color: var(--color-primary); margin-top: 0.4rem; display: block;">${a.word}</strong>
      ${u}
      <div style="border-top: 1px solid #f0f0f0; padding-top: 0.6rem; display: flex; gap: 0.4rem; justify-content: space-between;">
        <button class="next-btn play-here-btn" style="padding: 0.35rem 0.5rem; font-size: 0.72rem; flex: 1; display: inline-flex; align-items: center; justify-content: center; gap: 0.2rem; background-color: transparent; border: 1px solid var(--color-accent); color: var(--color-accent);">単語を聴く</button>
        <button class="next-btn play-from-here-btn" style="padding: 0.35rem 0.5rem; font-size: 0.72rem; flex: 1.2; display: inline-flex; align-items: center; justify-content: center; gap: 0.2rem; background-color: var(--color-accent); border-color: var(--color-accent);">ここから朗読</button>
      </div>
    `;document.body.appendChild(r),we=r;const c=e.getBoundingClientRect(),p=c.bottom+window.scrollY+8,y=Math.max(10,Math.min(window.innerWidth-300,c.left+window.scrollX-100));r.style.top=`${p}px`,r.style.left=`${y}px`;const s=r.querySelector(".play-here-btn");s&&s.addEventListener("click",v=>{v.stopPropagation();const g=a.word.replace(/^[^\wÀ-ÿ]+|[^\wÀ-ÿ]+$/g,"");ne(g)});const b=r.querySelector(".play-from-here-btn");b&&t&&b.addEventListener("click",v=>{v.stopPropagation(),ne(t)})}const C={meta:null,db:{knowledge:[],quizzes:[]},loaded:{knowledge:new Set,quizzes:!1},favorites:new Set(JSON.parse(localStorage.getItem("cba_favorites")||"[]")),wrongAnswers:JSON.parse(localStorage.getItem("cba_wrong")||"[]"),streak:parseInt(localStorage.getItem("cba_streak")||"0"),lastStudyDate:localStorage.getItem("cba_last_study")||"",srs:JSON.parse(localStorage.getItem("cba_srs")||"{}"),settings:JSON.parse(localStorage.getItem("cba_settings")||JSON.stringify({targetLevel:"ALL",newCardsPerDay:5,maxReviewsPerDay:20,includeGeneral:!1}))};function be(e){C.favorites.has(e)?C.favorites.delete(e):C.favorites.add(e),localStorage.setItem("cba_favorites",JSON.stringify(Array.from(C.favorites)))}function fe(e){return C.favorites.has(e)}function st(e){C.wrongAnswers.includes(e)||(C.wrongAnswers.push(e),localStorage.setItem("cba_wrong",JSON.stringify(C.wrongAnswers)))}function Cn(e){C.wrongAnswers=C.wrongAnswers.filter(a=>a!==e),localStorage.setItem("cba_wrong",JSON.stringify(C.wrongAnswers))}function Sn(){const e=new Date().toISOString().split("T")[0];if(C.lastStudyDate!==e){if(C.lastStudyDate){const a=new Date(C.lastStudyDate),t=new Date(e),r=Math.abs(t-a),n=Math.ceil(r/(1e3*60*60*24));n===1?C.streak+=1:n>1&&(C.streak=1)}else C.streak=1;C.lastStudyDate=e,localStorage.setItem("cba_streak",C.streak.toString()),localStorage.setItem("cba_last_study",e)}}function He(e,a){const t=new Date().toISOString().split("T")[0],r=C.srs[e]||{easiness:2.5,interval:0,repetitions:0,dueDate:t};let n=Math.max(0,Math.min(5,a));n>=3?(r.repetitions===0?r.interval=1:r.repetitions===1?r.interval=6:r.interval=Math.round(r.interval*r.easiness),r.repetitions++):(r.repetitions=0,r.interval=1),r.easiness=r.easiness+(.1-(5-n)*(.08+(5-n)*.02)),r.easiness<1.3&&(r.easiness=1.3);const o=new Date;o.setDate(o.getDate()+r.interval),r.dueDate=o.toISOString().split("T")[0],r.lastRated=t,C.srs[e]=r,localStorage.setItem("cba_srs",JSON.stringify(C.srs))}function Ln(e){C.settings={...C.settings,...e},localStorage.setItem("cba_settings",JSON.stringify(C.settings))}async function se(e,a){const t=a==="ALL"?["A1","A2","B1","B2","C1","C2"]:[a];for(const r of t)if(!C.loaded.knowledge.has(r))try{const n=await fetch(`data/knowledge_${r}.json`);if(!n.ok){console.warn(`Could not load data/knowledge_${r}.json`);continue}const o=await n.json(),m=new Set(C.db.knowledge.map(i=>i.id));for(const i of o)m.has(i.id)||(!i.context_fr&&i.examples&&i.examples.length>0&&(i.context_fr=i.examples[0].fr,i.context_en=i.examples[0].en,i.context_ja=i.examples[0].ja),C.db.knowledge.push(i));C.loaded.knowledge.add(r)}catch(n){console.error(`Failed to load knowledge level ${r}:`,n)}}async function Je(){if(!C.loaded.quizzes)try{const e=await fetch("data/quizzes.json");if(!e.ok)throw new Error("Network response was not ok");C.db.quizzes=await e.json(),C.loaded.quizzes=!0}catch(e){console.error("Failed to load quizzes:",e)}}async function Ye(){await Promise.all([se("vocabulary","ALL"),se("grammar","ALL"),se("cuisine","ALL"),Je()])}const lt={home:Pt,vocabulary:Bt,grammar:Ht,reference:It,cuisine:tn,quiz:an,favorites:$e,review:ln,search:dn,settings:mn,dictation:un,story:yn,reading:_n};function Ee(e){const a=document.getElementById("main-content");if(lt[e]){Sn(),a.innerHTML="";const t=lt[e]();t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t,document.querySelectorAll(".nav-link").forEach(r=>{r.getAttribute("data-tab")===e?r.classList.add("active"):r.classList.remove("active")})}}async function jn(){if(!window.__app_initialized){window.__app_initialized=!0;try{const e=await fetch("data/meta.json");C.meta=await e.json();const a=document.getElementById("hamburger-menu-toggle"),t=document.querySelector(".nav-band");a&&t&&(a.addEventListener("click",r=>{r.stopPropagation(),t.classList.toggle("mobile-open"),a.classList.toggle("active")}),document.addEventListener("click",r=>{!r.target.closest(".nav-band")&&!r.target.closest("#hamburger-menu-toggle")&&(t.classList.remove("mobile-open"),a.classList.remove("active"))})),document.querySelectorAll(".nav-link").forEach(r=>{r.addEventListener("click",n=>{const o=n.target.closest(".nav-link").getAttribute("data-tab");Ee(o),t&&t.classList.contains("mobile-open")&&(t.classList.remove("mobile-open"),a&&a.classList.remove("active"))})}),Ee("home"),Tn()}catch(e){console.error("Failed to load database metadata:",e),document.getElementById("main-content").innerHTML=`
      <div class="alert alert-info" style="border-left-color: var(--color-error); background-color: #FFEBEE; color: var(--color-error)">
        <h3>Error: Métadonnées inaccessibles</h3>
        <p>Could not load curriculum metadata. Please reload or check your local setup.</p>
      </div>
    `}}}function Tn(){const e=document.getElementById("youglish-sidebar"),a=document.getElementById("youglish-sidebar-toggle"),t=document.getElementById("youglish-search-input"),r=document.getElementById("youglish-search-btn"),n=document.getElementById("yg-widget-container");if(!e||!a||!t||!r||!n)return;a.addEventListener("click",i=>{i.stopPropagation(),e.classList.toggle("open"),e.classList.contains("open")&&t.focus()}),document.addEventListener("click",i=>{e.classList.contains("open")&&!e.contains(i.target)&&e.classList.remove("open")});let o=null;function m(){const i=t.value.trim();if(i)if(n.innerHTML='<div id="yg-widget" style="width: 100%;"></div>',window.YG)try{o=new YG("yg-widget",{width:230,components:9,accentColor:"#C5A880",autoStart:1,search:i,language:"french"})}catch(u){console.error("Failed to load YouGlish widget:",u),n.innerHTML=`
      ...
      `}r.addEventListener("click",m),t.addEventListener("keypress",i=>{i.key==="Enter"&&m()})}"serviceWorker"in navigator&&window.addEventListener("load",()=>{window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?navigator.serviceWorker.getRegistrations().then(e=>{for(let a of e)a.unregister().then(()=>{console.log("Local ServiceWorker unregistered successfully.")})}):navigator.serviceWorker.register("sw.js").then(e=>console.log("ServiceWorker registered:",e.scope)).catch(e=>console.warn("ServiceWorker registration failed:",e))});document.addEventListener("DOMContentLoaded",jn);
