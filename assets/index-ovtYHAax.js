(function(){const u=document.createElement("link").relList;if(u&&u.supports&&u.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const y of c.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&n(y)}).observe(document,{childList:!0,subtree:!0});function l(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(a){if(a.ep)return;a.ep=!0;const c=l(a);fetch(a.href,c)}})();let Y=null,X="",Z=0,W=null,D=null;function F(e,u=1){ie(e,u)}function ie(e,u=1,l=null,n=null,a=0){if(!("speechSynthesis"in window)){console.warn("Speech synthesis not supported on this browser.");return}window.speechSynthesis.cancel();const c=e.replace(/["'➔]/g,"").trim();X=c,Z=a,W=l,D=n;const y=c.substring(a);if(!y.trim()){D&&D();return}const C=new SpeechSynthesisUtterance(y);C.lang="fr-FR",C.rate=u;const x=window.speechSynthesis.getVoices().find(r=>r.lang==="fr-FR"||r.lang.startsWith("fr"));x&&(C.voice=x),C.onboundary=r=>{if(r.name==="word"&&W){const m=Z+r.charIndex;W(m,X.length)}},C.onend=()=>{Y===C&&D&&D()},C.onerror=r=>{console.warn("SpeechSynthesis error:",r),D&&D()},Y=C,window.speechSynthesis.speak(C)}function le(){"speechSynthesis"in window&&window.speechSynthesis.pause()}function de(){"speechSynthesis"in window&&window.speechSynthesis.resume()}function K(){"speechSynthesis"in window&&window.speechSynthesis.cancel()}"speechSynthesis"in window&&(window.speechSynthesis.getVoices(),window.speechSynthesis.onvoiceschanged=()=>{window.speechSynthesis.getVoices()});function ue(){var k,L,f,v,h,w,S;const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Tableau de Bord",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Welcome back, Commis. Here is your kitchen curriculum status.",e.appendChild(l);const n=new Date().toISOString().split("T")[0],a=Object.values(g.srs),c=a.filter(j=>j.dueDate<=n).length,y=a.length,C=document.createElement("div");C.className="dashboard-grid";const i=document.createElement("div");i.style.display="flex",i.style.flexDirection="column",i.style.gap="1.5rem";const x=document.createElement("div");x.className="card",x.style.padding="1.5rem",x.innerHTML=`
    ...
    <ul style="list-style: none; display: flex; flex-direction: column; gap: 0.8rem;">
      <li style="display: flex; align-items: center; gap: 0.8rem; font-size: 0.95rem;">
        <input type="checkbox" id="mission-vocab" style="transform: scale(1.2); cursor: pointer;" ${y>0?"checked":""}>
        <label for="mission-vocab" style="cursor: pointer;">Study new terms in the Vocabulary deck</label>
      </li>
      <li style="display: flex; align-items: center; gap: 0.8rem; font-size: 0.95rem;">
        <input type="checkbox" id="mission-srs" style="transform: scale(1.2); cursor: pointer;" ${c===0&&y>0?"checked":""}>
  ...
  `,i.appendChild(x);const r=document.createElement("div");r.className="card",r.style.padding="1.5rem";const m=((k=g.meta)==null?void 0:k.featured)||null;r.innerHTML=`
    ...
    `:"<p>No data loaded.</p>"}
  `,m&&r.querySelectorAll(".audio-btn").forEach(j=>{j.addEventListener("click",b=>{b.stopPropagation();const q=b.target.closest(".audio-btn").getAttribute("data-text");F(q)})}),i.appendChild(r),C.appendChild(i);const s=document.createElement("div");s.style.display="flex",s.style.flexDirection="column",s.style.gap="1.5rem";const o=document.createElement("div");o.className="streak-card",o.innerHTML=`
  ...
  `,s.appendChild(o);const d=document.createElement("div");d.className="card",d.style.padding="1.5rem";const p=((f=(L=g.meta)==null?void 0:L.counts)==null?void 0:f.vocabulary)||0,t=((h=(v=g.meta)==null?void 0:v.counts)==null?void 0:h.grammar)||0,_=((S=(w=g.meta)==null?void 0:w.counts)==null?void 0:S.cuisine)||0;return d.innerHTML=`
    ...
    <div style="display: flex; flex-direction: column; gap: 0.8rem; font-size: 0.9rem;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <strong style="color: var(--color-primary);">${y} cards</strong>
      </div>
      <div style="display: flex; justify-content: space-between; align-items: center;">
  ...
  `,s.appendChild(d),C.appendChild(s),e.appendChild(C),e}function me(){var c;const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Vocabulaire Professionnel",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Essential culinary terminology for kitchen brigade communications. Filter by category, tag, or difficulty level.",e.appendChild(l);const n=document.createElement("div");n.className="loading-placeholder",n.innerText="Chargement du vocabulaire... (Loading vocabulary...)",e.appendChild(n);const a=((c=g.settings)==null?void 0:c.targetLevel)||"ALL";return A("vocabulary",a).then(()=>{n.remove(),pe(e,a)}),e}function pe(e,u){var d,p;const l=((d=g.settings)==null?void 0:d.includeGeneral)||!1,a=(((p=g.db)==null?void 0:p.vocabulary)||[]).filter(t=>l||t.is_professional),c=["ALL",...new Set(a.map(t=>t.category))],y=["ALL",...new Set(a.flatMap(t=>t.tags||[]))],C=["ALL","A1","A2","B1","B2","C1","C2"];let i="ALL",x="ALL",r=u;const m=document.createElement("div");m.className="card",m.style.padding="1.2rem",m.style.marginBottom="2rem",m.style.display="flex",m.style.flexDirection="column",m.style.gap="1rem",m.innerHTML=`
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
      ...
      <div>
        ...
        <select id="vocab-tag-select" style="padding: 0.5rem; font-size: 0.9rem; border-radius: var(--radius-sm); border: 1px solid rgba(0,0,0,0.1); width: 100%; background: var(--color-bg);">
          ${y.map(t=>`<option value="${t}" ${t===x?"selected":""}>${t==="ALL"?"ALL TAGS":"#"+t}</option>`).join("")}
        </select>
      </div>
      <div>
        ...
        <select id="vocab-level-select" style="padding: 0.5rem; font-size: 0.9rem; border-radius: var(--radius-sm); border: 1px solid rgba(0,0,0,0.1); width: 100%; background: var(--color-bg);">
          ${C.map(t=>`<option value="${t}" ${t===r?"selected":""}>${t==="ALL"?"ALL LEVELS":t}</option>`).join("")}
        </select>
      </div>
    </div>
  `,e.appendChild(m);const s=document.createElement("div");s.className="card-grid",e.appendChild(s);function o(){var L;s.innerHTML="";const k=(((L=g.db)==null?void 0:L.vocabulary)||[]).filter(f=>l||f.is_professional).filter(f=>{const v=i==="ALL"||f.category===i,h=x==="ALL"||f.tags&&f.tags.includes(x),w=r==="ALL"||f.level===r;return v&&h&&w});if(k.length===0){s.innerHTML='<p style="color: var(--color-text-muted); grid-column: 1 / -1; text-align: center; padding: 2rem;">Aucun terme trouvé correspondant à vos critères de filtrage.</p>';return}k.forEach(f=>{const v=document.createElement("div");v.className="card";const h=B(f.id),w=g.srs[f.id],S=!!w;v.innerHTML=`
        <div style="display: flex; flex-direction: column; height: 100%; justify-content: space-between; gap: 1.5rem;">
          <div>
            ...
            <div class="term-header">
              ...
              <button class="fav-btn ${h?"active":""}" data-id="${f.id}">
                ${h?"★":"☆"}
              </button>
            </div>
            ...
            <div class="term-context" style="margin-top: 1rem;">
              <div class="context-fr" style="display: flex; align-items: flex-start; gap: 0.4rem; font-style: italic; color: var(--color-secondary);">
                ...
                <button class="audio-btn" data-text="${f.context_fr}" title="Listen context sentence" style="background: none; border: none; font-size: 0.9rem; cursor: pointer; color: var(--color-text-muted); padding: 0.15rem; margin-top: 0.15rem;">🔊</button>
              </div>
              <div class="context-ja">${f.context_ja}</div>
            </div>
            
            ${f.tags&&f.tags.length>0?`
              <div style="margin-top: 1rem; display: flex; flex-wrap: wrap; gap: 0.3rem;">
                ${f.tags.map(b=>`<span class="tag-badge" style="background-color: rgba(197, 168, 128, 0.08); color: var(--color-accent); font-size: 0.75rem; padding: 0.1rem 0.5rem; border-radius: 12px;">#${b}</span>`).join("")}
              </div>
            `:""}
          </div>
      ...
      `;const j=v.querySelector(".flip-translation-container");j.addEventListener("click",b=>{b.stopPropagation(),j.querySelector(".flip-translation-card").classList.toggle("flipped")}),v.querySelector(".fav-btn").addEventListener("click",b=>{b.stopPropagation(),H(f.id);const q=b.target,z=B(f.id);q.classList.toggle("active",z),q.innerText=z?"★":"☆"}),v.querySelectorAll(".audio-btn").forEach(b=>{b.addEventListener("click",q=>{q.stopPropagation();const z=q.target.closest(".audio-btn").getAttribute("data-text");F(z)})}),v.querySelectorAll(".srs-action-btn").forEach(b=>{b.addEventListener("click",q=>{q.stopPropagation();const z=q.target.getAttribute("data-action"),$=q.target.getAttribute("data-id");z==="start"?O($,4):z==="memorized"?O($,5):z==="reset"&&O($,0),o()})}),s.appendChild(v)})}m.querySelector("#vocab-category-select").addEventListener("change",t=>{i=t.target.value,o()}),m.querySelector("#vocab-tag-select").addEventListener("change",t=>{x=t.target.value,o()}),m.querySelector("#vocab-level-select").addEventListener("change",async t=>{var j;r=t.target.value,s.innerHTML=`<div style="grid-column: 1 / -1; text-align: center; padding: 2rem; color: var(--color-text-muted);">Chargement (Loading level ${r})...</div>`,await A("vocabulary",r);const k=(((j=g.db)==null?void 0:j.vocabulary)||[]).filter(b=>l||b.is_professional),L=["ALL",...new Set(k.map(b=>b.category))],f=["ALL",...new Set(k.flatMap(b=>b.tags||[]))],v=m.querySelector("#vocab-category-select"),h=v.value;v.innerHTML=L.map(b=>`<option value="${b}" ${b===h?"selected":""}>${b}</option>`).join(""),i=v.value;const w=m.querySelector("#vocab-tag-select"),S=w.value;w.innerHTML=f.map(b=>`<option value="${b}" ${b===S?"selected":""}>${b==="ALL"?"ALL TAGS":"#"+b}</option>`).join(""),x=w.value,o()}),o()}function ge(){var c;const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Grammaire de la Cuisine",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="French grammar concepts framed through recipe instructions and professional dialogues.",e.appendChild(l);const n=document.createElement("div");n.className="loading-placeholder",n.innerText="Chargement de la grammaire... (Loading grammar...)",e.appendChild(n);const a=((c=g.settings)==null?void 0:c.targetLevel)||"ALL";return A("grammar",a).then(()=>{n.remove(),fe(e,a)}),e}function fe(e,u){var a;const n=(((a=g.db)==null?void 0:a.grammar)||[]).filter(c=>u==="ALL"||c.level===u);if(n.length===0){const c=document.createElement("p");c.style.color="var(--color-text-muted)",c.innerText="Aucune leçon de grammaire chargée pour ce niveau.",e.appendChild(c);return}n.forEach(c=>{const y=document.createElement("div");y.className="grammar-card";const C=B(c.id),i=c.topic.match(/\(([^)]+)\)/),x=i?i[1]:c.topic;y.innerHTML=`
      <div class="grammar-header">
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
          <span class="grammar-badge">${c.level}</span>
          <span class="grammar-title">${c.topic}</span>
          <button class="audio-btn" data-text="${x}" title="Listen topic pronunciation" style="background: none; border: none; font-size: 0.9rem; cursor: pointer; color: var(--color-accent); padding: 0.15rem; line-height: 1;">🔊</button>
        </div>
        <div style="display: flex; align-items: center; gap: 1rem;">
          <button class="fav-btn ${C?"active":""}" data-id="${c.id}" style="font-size: 1.1rem; padding: 0.2rem;">
            ${C?"★":"☆"}
          </button>
  ...
  `,e.appendChild(n);const a=document.createElement("div");a.className="cuisine-content-wrapper",e.appendChild(a),n.querySelectorAll(".cuisine-tab-btn").forEach(r=>{r.addEventListener("click",m=>{n.querySelectorAll(".cuisine-tab-btn").forEach(o=>o.classList.remove("active")),m.target.classList.add("active");const s=m.target.getAttribute("data-tab");c(s)})});function c(r){a.innerHTML="",r==="theory"?y():r==="meat"?C():r==="map"&&x()}function y(){var m;a.innerHTML='<div style="text-align: center; padding: 2rem; color: var(--color-text-muted);">Chargement de la théorie... (Loading theory...)</div>';const r=((m=g.settings)==null?void 0:m.targetLevel)||"ALL";A("cuisine",r).then(()=>{var p;a.innerHTML="";const o=(((p=g.db)==null?void 0:p.cuisine)||[]).filter(t=>r==="ALL"||t.level===r);if(o.length===0){a.innerHTML='<p style="color: var(--color-text-muted);">Aucun document de théorie culinaire disponible pour ce niveau.</p>';return}const d=document.createElement("div");d.style.display="flex",d.style.flexDirection="column",d.style.gap="2rem",o.forEach(t=>{const _=document.createElement("div");_.className="card",_.style.display="block",_.style.padding="2rem";const k=B(t.id),L=t.topic.match(/^([^(]+)/),f=L?L[1].trim():t.topic;_.innerHTML=`
          ...
          <div class="term-header" style="border-bottom: 1px solid rgba(197, 168, 128, 0.15); padding-bottom: 0.8rem; margin-bottom: 1.5rem;">
            ...
            <button class="fav-btn ${k?"active":""}" data-id="${t.id}" style="font-size: 1.3rem;">
              ${k?"★":"☆"}
            </button>
          </div>
        ...
        `,_.querySelector(".fav-btn").addEventListener("click",v=>{v.stopPropagation(),H(t.id);const h=v.target,w=B(t.id);h.classList.toggle("active",w),h.innerText=w?"★":"☆"}),_.querySelectorAll(".audio-btn").forEach(v=>{v.addEventListener("click",h=>{h.stopPropagation();const w=h.target.closest(".audio-btn").getAttribute("data-text");F(w)})}),d.appendChild(_)}),a.appendChild(d)})}function C(){const r=document.createElement("div");r.className="meat-section-container";const m=document.createElement("div");m.className="meat-type-tabs",m.innerHTML=`
    ...
    `,r.appendChild(m);const s=document.createElement("div");s.className="meat-display-area",r.appendChild(s),a.appendChild(r),m.querySelectorAll(".meat-tab-btn").forEach(o=>{o.addEventListener("click",d=>{m.querySelectorAll(".meat-tab-btn").forEach(_=>_.classList.remove("active"));const p=d.target.closest(".meat-tab-btn");p.classList.add("active");const t=p.getAttribute("data-type");i(t,s)})}),i("beef",s)}function i(r,m){m.innerHTML="";const o={beef:{cuts:ve,pdf:"beef_maff_guide.pdf",pdfText:"📄 日本農水省 牛肉部位基準 (PDF)",quote:"",img:"assets/beef_cuts.png",alt:"French Beef Cuts Diagram",placeholder:"Coupe+de+Boeuf",label:"Coupe de Bœuf",propName:"beef"},porc:{cuts:be,pdf:"pork_maff_guide.pdf",pdfText:"📄 日本農水省 豚肉部位基準 (PDF)",quote:'"Tout est bon dans le cochon" (豚はすべてが使える食材である)',img:"assets/porc_cuts.png",alt:"French Pork Cuts Diagram",placeholder:"Coupe+de+Porc",label:"Coupe de Porc",propName:"pork"},volaille:{cuts:he,pdf:"poultry_maff_guide.pdf",pdfText:"📄 日本農水省 鶏肉部位基準 (PDF)",quote:'"La volaille est la reine des cuisines et la directrice des banquets" (鶏肉は厨房の女王であり、宴の演出家である)',img:"assets/poultry_cuts.png",alt:"French Poultry Cuts Diagram",placeholder:"Coupe+de+Volaille",label:"Coupe de Volaille",propName:"poultry"},poisson:{cuts:ye,pdf:"",pdfText:"",quote:"",img:"assets/fish_cuts.png",alt:"French Fish Cuts Diagram",placeholder:"Coupe+de+Poisson",label:"Coupe de Poisson",propName:"fish"},autre:{cuts:_e,pdf:"",pdfText:"",quote:"",img:"assets/other_cuts.png",alt:"French Other Meats Cuts Diagram",placeholder:"Autres+Viandes",label:"Autres Viandes",propName:"other"}}[r];if(!o)return;const d=document.createElement("div");let p="";o.quote&&(p+=`
      ...
      <div class="interactive-canvas-container" style="position: relative;">
        ...
        <svg class="interactive-svg-overlay" viewBox="0 0 100 100">
          ${o.cuts.map(k=>`
            <polygon class="interactive-area" points="${k.points}" data-id="${k.id}" />
          `).join("")}
        </svg>
      </div>
    ...
    `,d.innerHTML=p,m.appendChild(d);const t=d.querySelector(`#${o.propName}-detail-drawer`),_=d.querySelectorAll(".interactive-area");_.forEach(k=>{k.addEventListener("click",L=>{_.forEach(h=>h.classList.remove("active")),L.target.classList.add("active");const f=L.target.getAttribute("data-id"),v=o.cuts.find(h=>h.id===f);if(v){d.querySelector(`#${o.propName}-cut-title`).innerText=`${v.name_fr} (${v.name_ja})`,d.querySelector(`#${o.propName}-cut-sub`).innerText=`Cut #${v.number} • ${v.name_en}`,d.querySelector(`#${o.propName}-prop-tenderness`).innerText=v.properties.tenderness,d.querySelector(`#${o.propName}-prop-fat`).innerText=v.properties.fat,d.querySelector(`#${o.propName}-prop-collagen`).innerText=v.properties.collagen,d.querySelector(`#${o.propName}-cooking`).innerText=v.cooking,d.querySelector(`#${o.propName}-classification`).innerText=v.classification,d.querySelector(`#${o.propName}-logic`).innerText=v.logic,d.querySelector(`#${o.propName}-science`).innerText=v.science,d.querySelector(`#${o.propName}-chef-note`).innerText=v.chef_note;const h=d.querySelector(`#${o.propName}-relations-container`),w=d.querySelector(`#${o.propName}-relations-content`),S=te(f,"cut");S?(w.innerHTML=S,h.style.display="block"):h.style.display="none";const j=d.querySelector(`#${o.propName}-audio-title-btn`);j.style.display="inline-block",j.onclick=()=>F(v.name_fr),t.style.display="block"}})})}function x(){const r=document.createElement("div");r.innerHTML=`
      <div class="interactive-canvas-container" style="position: relative;">
    ...
    `,a.appendChild(r);const m=r.querySelector("#map-detail-drawer"),s=r.querySelectorAll(".interactive-area");s.forEach(o=>{o.addEventListener("click",d=>{s.forEach(_=>_.classList.remove("active")),d.target.classList.add("active");const p=d.target.getAttribute("data-id"),t=ee.find(_=>_.id===p);if(t){r.querySelector("#map-region-title").innerText=`${t.name_fr} (${t.name_ja})`,r.querySelector("#map-region-sub").innerText=`${t.name_en} Region`,r.querySelector("#map-desc-fr").innerText=t.desc_fr,r.querySelector("#map-desc-en").innerText=t.desc_en,r.querySelector("#map-desc-ja").innerText=t.desc_ja;const _=r.querySelector("#map-relations-container"),k=r.querySelector("#map-relations-content"),L=te(p,"region");L?(k.innerHTML=L,_.style.display="block"):_.style.display="none";const f=r.querySelector("#map-audio-title-btn");f.style.display="inline-block",f.onclick=()=>F(t.name_fr);const v=r.querySelector("#map-audio-desc-btn");v.style.display="inline-block",v.onclick=()=>F(t.desc_fr),m.style.display="block"}})})}return c("theory"),e}function T(e){const u=[...e];for(let l=u.length-1;l>0;l--){const n=Math.floor(Math.random()*(l+1));[u[l],u[n]]=[u[n],u[l]]}return u}function ae(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/[-\s]+/g," ")}function $e(){if(document.getElementById("quiz-dynamic-styles"))return;const e=document.createElement("style");e.id="quiz-dynamic-styles",e.innerHTML=`
    .quiz-mode-selector {
      display: flex;
  ...
  `,document.head.appendChild(e)}function qe(){var c,y,C;const e=[],u=((c=g.db)==null?void 0:c.vocabulary)||[],l=((y=g.db)==null?void 0:y.grammar)||[],n=((C=g.db)==null?void 0:C.cuisine)||[];function a(i,x,r,m="japanese"){const o=i.filter(p=>p.id!==r).map(p=>p[m]).sort(()=>.5-Math.random()),d=[...new Set(o)].filter(Boolean).slice(0,x);for(;d.length<x;)d.push("Autre option "+(d.length+1));return d}return u.forEach(i=>{var s,o,d,p,t;if(!i.french||!i.japanese)return;let x="vocabulary";(s=i.tags)!=null&&s.includes("meat")?x="meat":(o=i.tags)!=null&&o.includes("sauces")||(d=i.tags)!=null&&d.includes("sauce")?x="sauces":(p=i.tags)!=null&&p.includes("cutting")?x="cuts":(t=i.tags)!=null&&t.includes("science")&&(x="science");const r=a(u,3,i.id,"japanese");e.push({id:`dyn_vocab_fr_ja_${i.id}`,type:"choice",category:x,question:`Que signifie le mot français "${i.french}" ? / What does the French word "${i.french}" mean?`,question_fr:`Que signifie le mot français "${i.french}" ?`,question_en:`What does the French word "${i.french}" mean?`,context:i.definition_fr||`Usage: ${i.context_fr}`,options:T([i.japanese,...r]),answer:i.japanese});const m=a(u,3,i.id,"french");e.push({id:`dyn_vocab_ja_fr_${i.id}`,type:"choice",category:x,question:`Quel est le mot français pour "${i.japanese}" ? / What is the French word for "${i.japanese}"?`,question_fr:`Quel est le mot français pour "${i.japanese}" ?`,question_en:`What is the French word for "${i.japanese}"?`,context:i.definition_fr||`Usage: ${i.context_fr}`,options:T([i.french,...m]),answer:i.french})}),l.forEach(i=>{if(!i.topic||!i.examples||i.examples.length===0)return;const x=a(l,3,i.id,"topic");e.push({id:`dyn_gram_topic_${i.id}`,type:"choice",category:"grammar",question:`De quel concept de grammaire s'agit-il : "${i.explanation_ja}" ? / Which grammar concept is this: "${i.explanation_en}"?`,question_fr:"De quel concept de grammaire s'agit-il ?",question_en:`Which grammar concept is this: "${i.explanation_en}"?`,context:`Niveau : ${i.level}. Indispensable pour la cuisine.`,options:T([i.topic,...x]),answer:i.topic}),i.examples.forEach((r,m)=>{const o=l.flatMap(d=>d.examples||[]).filter(d=>d.fr!==r.fr).sort(()=>.5-Math.random()).map(d=>d.ja).slice(0,3);for(;o.length<3;)o.push("Option de traduction "+(o.length+1));e.push({id:`dyn_gram_ex_${i.id}_${m}`,type:"choice",category:"grammar",question:`Traduisez la phrase : "${r.fr}" / Translate the sentence: "${r.fr}"`,question_fr:`Traduisez la phrase : "${r.fr}"`,question_en:`Translate the sentence: "${r.fr}"`,context:`Grammaire: ${i.topic} (${i.level})`,options:T([r.ja,...o]),answer:r.ja})})}),n.forEach(i=>{var m,s,o,d,p,t;if(!i.topic||!i.content_ja)return;const x=a(n,3,i.id,"topic");let r="sauces";(m=i.tags)!=null&&m.includes("knife-cuts")||(s=i.tags)!=null&&s.includes("cuts")?r="cuts":(o=i.tags)!=null&&o.includes("meat")?r="meat":((d=i.tags)!=null&&d.includes("molecular")||(p=i.tags)!=null&&p.includes("chemistry")||(t=i.tags)!=null&&t.includes("science"))&&(r="science"),e.push({id:`dyn_cuis_topic_${i.id}`,type:"choice",category:r,question:`De quel concept culinaire s'agit-il : "${i.content_ja.substring(0,120)}..." ? / Which culinary concept is described: "${i.content_en.substring(0,120)}..."?`,question_fr:"De quel concept culinaire s'agit-il ?",question_en:"Which culinary concept is described here?",context:`Niveau : ${i.level}. Mots-clés : ${i.tags.join(", ")}`,options:T([i.topic,...x]),answer:i.topic})}),e}function ze(){var y,C;const e=[],u=((y=g.db)==null?void 0:y.grammar)||[],l=((C=g.db)==null?void 0:C.vocabulary)||[],n=[];u.forEach(i=>{(i.examples||[]).forEach(x=>{n.push({fr:x.fr,ja:x.ja})})}),l.forEach(i=>{i.context_fr&&!i.context_fr.includes("Exemple avec le mot")&&n.push({fr:i.context_fr,ja:i.context_ja})});const a=n.sort(()=>.5-Math.random());for(const i of a){if(e.length>=4)break;const x=i.fr.replace(/^➔\s*/,"").trim();if(x.includes(" - ")){const r=x.split(" - ");e.push({id:`pair_${e.length}`,left:`🗣️ ${r[0].trim()}`,right:`💬 ${r[1].trim()}`,context:i.ja})}else if(x.includes(",")){const r=x.split(",");e.push({id:`pair_${e.length}`,left:`${r[0].trim()} ,`,right:`... ${r[1].trim()}`,context:i.ja})}else{const r=x.split(" ");if(r.length>=4){const m=Math.floor(r.length/2),s=r.slice(0,m).join(" "),o=r.slice(m).join(" ");e.push({id:`pair_${e.length}`,left:`${s} ...`,right:`... ${o}`,context:i.ja})}}}const c=[{left:"🗣️ Chaud devant !",right:"💬 Oui, chef !",context:"お通りです！ / はい、シェフ！"},{left:"🗣️ Entrée prête ?",right:"💬 Oui, j'envoie.",context:"前菜はできていますか？ / はい、送ります。"},{left:"🗣️ Combien de couverts ?",right:"💬 Vingt couverts.",context:"何名様（何席）ですか？ / 20席です。"},{left:"🗣️ Envoyez la sauce !",right:"💬 Tout de suite !",context:"ソースを出して！ / ただちに！"}];for(;e.length<4;){const i=c[e.length%c.length];e.push({id:`default_${e.length}`,left:i.left,right:i.right,context:i.context})}return e}function Ee(){var a;const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Vérification des Connaissances",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Test your professional French vocabulary, kitchen commands, and classical cuisine theory.",e.appendChild(l);const n=document.createElement("div");return n.className="loading-placeholder",n.innerText="Chargement du quiz... (Loading quiz...)",e.appendChild(n),$e(),(a=g.settings)!=null&&a.targetLevel,Promise.all([se(),A("vocabulary","ALL"),A("grammar","ALL"),A("cuisine","ALL")]).then(()=>{n.remove(),Te(e)}),e}function Te(e){let u="multiple",l="ALL";const n=document.createElement("div");n.className="quiz-mode-selector",n.innerHTML=`
  ...
  `,e.appendChild(a);const c=a.querySelector("#quiz-cat-select");c.addEventListener("change",o=>{l=o.target.value,C()});const y=document.createElement("div");y.className="quiz-game-wrapper",e.appendChild(y),n.querySelectorAll(".mode-tab-btn").forEach(o=>{o.addEventListener("click",d=>{n.querySelectorAll(".mode-tab-btn").forEach(p=>p.classList.remove("active")),d.target.classList.add("active"),u=d.target.getAttribute("data-mode"),u==="matching_taking"?(c.disabled=!0,c.style.opacity="0.5"):(c.disabled=!1,c.style.opacity="1.0"),C()})});function C(){y.innerHTML="",u==="multiple"?i():u==="matching_vocab"?x():u==="matching_taking"?r():u==="spelling"&&s()}function i(){var v;const o=((v=g.db)==null?void 0:v.quizzes)||[],d=qe();let p=[...o,...d];if(l!=="ALL"&&(p=p.filter(h=>h.category===l)),p.length===0){y.innerHTML=`
      ...
      `;return}const t=T(p).slice(0,10);let _=0,k=0,L=!1;function f(){if(y.innerHTML="",L=!1,_>=t.length){const z=Math.round(k/t.length*100);let $="Apprenti (Apprentice)";z>=90?$="Chef de Partie (Station Chef)":z>=70&&($="Commis de Cuisine (Line Cook)"),y.innerHTML=`
          <div class="quiz-card" style="text-align: center;">
            ...
            <p style="font-size: 1.1rem; margin-bottom: 1.5rem;">Your Score: <strong>${k} / ${t.length}</strong> (${z}%)</p>
        ...
        `,y.querySelector("#restart-choice-btn").addEventListener("click",()=>{i()});return}const h=t[_],w=document.createElement("div");w.className="quiz-card",w.innerHTML=`
        <div class="quiz-meta">
          <span>Question ${_+1} of ${t.length}</span>
      ...
      `;const S=w.querySelector(".quiz-hint-flip-container");S&&S.addEventListener("click",()=>{const z=S.querySelector(".q-en-hint-text"),$=z.style.display==="none";z.style.display=$?"block":"none",S.querySelector(".q-en-card").innerText=$?"💡 Hide English Hint":"💡 Translate (Show English Hint)"});const j=w.querySelectorAll(".quiz-btn"),b=w.querySelector(".quiz-feedback"),q=w.querySelector("#next-q-btn");j.forEach(z=>{z.addEventListener("click",$=>{if(L)return;L=!0;const I=$.target.innerText===h.answer;j.forEach(M=>{M.disabled=!0,M.innerText===h.answer&&M.classList.add("correct")}),I?k++:($.target.classList.add("incorrect"),ne(h.id)),b.style.display="block",q.style.display="block"})}),q.addEventListener("click",()=>{_++,f()}),y.appendChild(w)}f()}function x(){var f,v;const o=((f=g.settings)==null?void 0:f.includeGeneral)||!1;let p=(((v=g.db)==null?void 0:v.vocabulary)||[]).filter(h=>o||h.is_professional);if(l!=="ALL"&&(l==="meat"?p=p.filter(h=>{var w,S,j,b;return((w=h.tags)==null?void 0:w.includes("meat"))||((S=h.tags)==null?void 0:S.includes("beef"))||((j=h.tags)==null?void 0:j.includes("pork"))||((b=h.tags)==null?void 0:b.includes("poultry"))||/viande|boeuf|porc|poulet/i.test(h.french)}):l==="sauces"?p=p.filter(h=>{var w,S,j;return((w=h.tags)==null?void 0:w.includes("sauce"))||((S=h.tags)==null?void 0:S.includes("sauces"))||((j=h.tags)==null?void 0:j.includes("stocks"))||/sauce|fond|jus|bouillon/i.test(h.french)}):l==="cuts"?p=p.filter(h=>{var w,S;return((w=h.tags)==null?void 0:w.includes("cutting"))||((S=h.tags)==null?void 0:S.includes("vegetables"))||/coupe|tailler|ciseler|mincer|brunoise|julienne/i.test(h.french)}):l==="science"?p=p.filter(h=>{var w;return((w=h.tags)==null?void 0:w.includes("science"))||/réaction|émulsion|liaison/i.test(h.french)}):l==="grammar"&&(p=[])),p.length<4){y.innerHTML=`
        <div class="quiz-card" style="text-align: center; padding: 2rem;">
      ...
      `;return}const t=T(p).slice(0,4),_=T(t),k=T(t),L=document.createElement("div");L.className="quiz-card",L.innerHTML=`
    ...
    `,y.appendChild(L),m(L,4,x)}function r(){const o=ze(),d=document.createElement("div");d.className="quiz-card",d.innerHTML=`
      <div class="quiz-meta" style="margin-bottom: 1rem;">
    ...
    `,y.appendChild(d),m(d,4,r)}function m(o,d,p){let t=null,_=null,k=0;const L=o.querySelectorAll(".drag-card"),f=o.querySelectorAll(".drop-zone"),v=o.querySelector("#matching-completion-panel");L.forEach(S=>{S.addEventListener("dragstart",j=>{t=j.target.closest(".drag-card").getAttribute("data-id"),j.target.closest(".drag-card").classList.add("dragging")}),S.addEventListener("dragend",j=>{j.target.closest(".drag-card").classList.remove("dragging")}),S.addEventListener("click",j=>{const b=j.target.closest(".drag-card");b.classList.contains("matched")||(L.forEach(q=>q.style.borderColor="rgba(10,25,49,0.08)"),_=b.getAttribute("data-id"),b.style.borderColor="var(--color-accent)")})}),f.forEach(S=>{S.addEventListener("dragover",j=>{j.preventDefault(),S.classList.contains("matched")||S.classList.add("hovered")}),S.addEventListener("dragleave",()=>{S.classList.remove("hovered")}),S.addEventListener("drop",j=>{j.preventDefault(),S.classList.remove("hovered");const b=S.getAttribute("data-id");t===b?w(t,S):h(t)}),S.addEventListener("click",()=>{if(S.classList.contains("matched")||!_)return;const j=S.getAttribute("data-id");_===j?(w(_,S),_=null):(h(_),_=null,L.forEach(b=>b.style.borderColor="rgba(10,25,49,0.08)"))})});function h(S){const j=o.querySelector(`#drag-${S}`);j&&(j.style.animation="shake-anim 0.4s ease-in-out",setTimeout(()=>j.style.animation="",400))}function w(S,j){const b=o.querySelector(`#drag-${S}`);b.classList.add("matched"),b.style.borderColor="var(--color-success)",j.classList.add("matched"),k++,k===d&&(v.style.display="block")}o.querySelector("#restart-match-btn").addEventListener("click",()=>{p()})}function s(){var S,j;const o=((S=g.settings)==null?void 0:S.includeGeneral)||!1;let p=(((j=g.db)==null?void 0:j.vocabulary)||[]).filter(b=>o||b.is_professional);if(l!=="ALL"&&(l==="meat"?p=p.filter(b=>{var q,z,$,N;return((q=b.tags)==null?void 0:q.includes("meat"))||((z=b.tags)==null?void 0:z.includes("beef"))||(($=b.tags)==null?void 0:$.includes("pork"))||((N=b.tags)==null?void 0:N.includes("poultry"))||/viande|boeuf|porc|poulet/i.test(b.french)}):l==="sauces"?p=p.filter(b=>{var q,z,$;return((q=b.tags)==null?void 0:q.includes("sauce"))||((z=b.tags)==null?void 0:z.includes("sauces"))||(($=b.tags)==null?void 0:$.includes("stocks"))||/sauce|fond|jus|bouillon/i.test(b.french)}):l==="cuts"?p=p.filter(b=>{var q,z;return((q=b.tags)==null?void 0:q.includes("cutting"))||((z=b.tags)==null?void 0:z.includes("vegetables"))||/coupe|tailler|ciseler|mincer|brunoise|julienne/i.test(b.french)}):l==="science"?p=p.filter(b=>{var q;return((q=b.tags)==null?void 0:q.includes("science"))||/réaction|émulsion|liaison/i.test(b.french)}):l==="grammar"&&(p=[])),p.length===0){y.innerHTML=`
        <div class="quiz-card" style="text-align: center; padding: 2rem;">
      ...
      `;return}let t=T(p)[0];const _=document.createElement("div");_.className="quiz-card",_.innerHTML=`
    ...
    `,y.appendChild(_);const k=_.querySelector("#spelling-input-field"),L=_.querySelector("#spelling-submit-btn"),f=_.querySelector("#spelling-next-btn"),v=_.querySelector("#spelling-feedback-panel"),h=_.querySelector("#spelling-feedback-title"),w=_.querySelector("#spelling-feedback-msg");k.addEventListener("keydown",b=>{b.key==="Enter"&&L.click()}),L.addEventListener("click",()=>{const b=k.value,q=t.french,z=ae(b),$=ae(q),N=z===$;k.disabled=!0,L.style.display="none",f.style.display="block",v.style.display="block",N?(k.style.borderColor="var(--color-success)",k.style.backgroundColor="#E8F5E9",v.style.backgroundColor="#E8F5E9",v.style.color="var(--color-success)",h.innerText="✓ Félicitations ! (Correct)",w.innerText=`You correctly spelled: "${q}"`):(k.style.borderColor="var(--color-error)",k.style.backgroundColor="#FFEBEE",v.style.backgroundColor="#FFEBEE",v.style.color="var(--color-error)",h.innerText="✗ Incorrect",w.innerHTML=`Correct spelling is: <strong>${q}</strong>.<br><em style="font-size:0.85rem;">You typed: "${b}"</em>`,ne(t.id))}),f.addEventListener("click",()=>{s()})}C()}function G(){const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Coups de Cœur (Favorites)",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Your bookmarked vocabulary terms, grammar guides, and culinary theories.",e.appendChild(l);const n=Array.from(g.favorites);if(n.length===0)return e.innerHTML+=`
      <div class="alert alert-info">
        <p>No favorites saved yet. Browse Vocabulary, Grammar, or Cuisine and click the star (☆) button to save items here.</p>
      </div>
    `,e;const a=document.createElement("div");return a.className="loading-placeholder",a.innerText="Chargement des favoris... (Loading favorites...)",e.appendChild(a),J().then(()=>{a.remove(),Ae(e,n)}),e}function Ae(e,u){var C,i,x;const l=(((C=g.db)==null?void 0:C.vocabulary)||[]).filter(r=>u.includes(r.id)),n=(((i=g.db)==null?void 0:i.grammar)||[]).filter(r=>u.includes(r.id)),a=(((x=g.db)==null?void 0:x.cuisine)||[]).filter(r=>u.includes(r.id)),c=document.createElement("div");c.className="card-grid",e.appendChild(c);function y(){c.innerHTML="",l.forEach(r=>{const m=document.createElement("div");m.className="card",m.innerHTML=`
        <div>
      ...
      `,m.querySelector(".fav-btn").addEventListener("click",s=>{H(r.id),G(),e.innerHTML="",e.appendChild(G())}),c.appendChild(m)}),n.forEach(r=>{var s,o;const m=document.createElement("div");m.className="card",m.innerHTML=`
        <div>
      ...
      `,m.querySelector(".fav-btn").addEventListener("click",d=>{H(r.id),e.innerHTML="",e.appendChild(G())}),c.appendChild(m)}),a.forEach(r=>{const m=document.createElement("div");m.className="card",m.innerHTML=`
        <div>
      ...
      `,m.querySelector(".fav-btn").addEventListener("click",s=>{H(r.id),e.innerHTML="",e.appendChild(G())}),c.appendChild(m)})}y()}function Me(){const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Pont d'Études (SRS Review Deck)",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Review and grade yourself on items scheduled for active recall today.",e.appendChild(l);const n=document.createElement("div");return n.className="loading-placeholder",n.innerText="Chargement des révisions... (Loading reviews...)",e.appendChild(n),J().then(()=>{n.remove(),Fe(e)}),e}function Fe(e){var i,x,r,m;const u=new Date().toISOString().split("T")[0],n=[...(((i=g.db)==null?void 0:i.vocabulary)||[]).map(s=>({...s,type:"vocabulary",front:s.french})),...(((x=g.db)==null?void 0:x.grammar)||[]).map(s=>({...s,type:"grammar",front:s.topic})),...(((r=g.db)==null?void 0:r.cuisine)||[]).map(s=>({...s,type:"cuisine",front:s.topic})),...(((m=g.db)==null?void 0:m.quizzes)||[]).map(s=>({...s,type:"quiz",front:s.question_fr||s.question||""}))].filter(s=>{const o=g.srs[s.id];return g.wrongAnswers.includes(s.id)||o&&o.dueDate<=u}),a=n.length;let c=0;const y=document.createElement("div");y.className="srs-review-container",e.appendChild(y);function C(){if(y.innerHTML="",n.length===0||c>=n.length){y.innerHTML=`
      ...
      `;return}const s=n[c];g.srs[s.id];const o=g.wrongAnswers.includes(s.id),d=document.createElement("div");d.className="card srs-flip-card",d.style.padding="2rem",d.style.minHeight="300px",d.style.display="flex",d.style.flexDirection="column",d.style.justifyContent="space-between";let p=s.category||s.level||"Theory";s.type==="quiz"&&(p="Quiz Mistake");let t=`
      <div>
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
          <span class="card-category">${p} • ${s.type.toUpperCase()}</span>
    ...
    `;d.innerHTML=t;let _="";s.type==="vocabulary"?_=`
      ...
      `),d.querySelector("#reveal-btn").addEventListener("click",()=>{d.innerHTML=`
        <div>
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
            <span class="card-category">${p} • ${s.type.toUpperCase()}</span>
            <span style="font-size: 0.8rem; color: var(--color-text-muted);">Card ${c+1} of ${a}</span>
          </div>
      ...
      `;const k=d.querySelector(".flip-translation-container");k&&k.addEventListener("click",L=>{L.stopPropagation(),k.querySelector(".flip-translation-card").classList.toggle("flipped")}),d.querySelectorAll(".audio-btn").forEach(L=>{L.addEventListener("click",f=>{f.stopPropagation();const v=f.target.closest(".audio-btn").getAttribute("data-text");F(v)})}),d.querySelectorAll(".srs-score-btn").forEach(L=>{L.addEventListener("click",f=>{const v=parseInt(f.target.getAttribute("data-score"));O(s.id,v),v>=4&&o&&He(s.id),c++,C()})})}),y.appendChild(d)}C()}function Be(){const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Recherche Globale",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Search terms across the entire curriculum: Vocabulary, Grammar, and Culinary Theory.",e.appendChild(l);const n=document.createElement("div");n.className="search-box-wrapper",n.style.marginBottom="2rem",n.style.position="relative";const a=document.createElement("input");a.type="text",a.placeholder="Chargement de la base de données... (Loading database...)",a.className="search-input",a.style.width="100%",a.style.padding="1rem 1.5rem",a.style.fontSize="1.1rem",a.style.borderRadius="var(--radius-md)",a.style.border="2px solid rgba(197, 168, 128, 0.2)",a.style.backgroundColor="var(--color-bg)",a.style.fontFamily="var(--font-sans)",a.style.transition="var(--transition)",a.style.outline="none",a.disabled=!0,a.addEventListener("focus",()=>{a.style.borderColor="var(--color-accent)",a.style.boxShadow="0 0 10px rgba(212, 175, 55, 0.15)"}),a.addEventListener("blur",()=>{a.style.borderColor="rgba(197, 168, 128, 0.2)",a.style.boxShadow="none"}),n.appendChild(a),e.appendChild(n);const c=document.createElement("div");return c.className="search-results",e.appendChild(c),c.innerHTML=`
    <div style="text-align: center; padding: 3rem; color: var(--color-text-muted);">
      <p>Préparation de la recherche... (Preparing search database...)</p>
    </div>
  `,J().then(()=>{a.disabled=!1,a.placeholder="Rechercher... (e.g. sauce, roux, cut, culer, 刻む)";function y(C){var o,d,p;if(c.innerHTML="",!C.trim()){c.innerHTML=`
          <div style="text-align: center; padding: 3rem; color: var(--color-text-muted);">
            <span style="font-size: 3rem;">🔍</span>
            <p style="margin-top: 1rem;">Tapez un mot-clé pour commencer votre recherche.</p>
          </div>
        `;return}const i=C.toLowerCase().trim(),x=((o=g.db)==null?void 0:o.vocabulary)||[],r=((d=g.db)==null?void 0:d.grammar)||[],m=((p=g.db)==null?void 0:p.cuisine)||[],s=[];if(x.forEach(t=>{`${t.french} ${t.english} ${t.japanese} ${t.category} ${t.context_fr} ${t.context_en} ${t.context_ja} ${(t.tags||[]).join(" ")}`.toLowerCase().includes(i)&&s.push({...t,type:"vocabulary",title:t.french,subtitle:`${t.category} • Vocabulary`})}),r.forEach(t=>{`${t.topic} ${t.explanation_en} ${t.explanation_ja} ${t.level} ${(t.tags||[]).join(" ")} ${t.examples.map(k=>`${k.fr} ${k.en} ${k.ja}`).join(" ")}`.toLowerCase().includes(i)&&s.push({...t,type:"grammar",title:t.topic,subtitle:`${t.level} • Grammar Lesson`})}),m.forEach(t=>{`${t.topic} ${t.category} ${t.content_fr} ${t.content_en} ${t.content_ja} ${(t.tags||[]).join(" ")}`.toLowerCase().includes(i)&&s.push({...t,type:"cuisine",title:t.topic,subtitle:`${t.category} • Culinary Theory`})}),s.length===0){c.innerHTML=`
          <div style="text-align: center; padding: 3rem; color: var(--color-text-muted);">
            <p>Aucun résultat trouvé pour "<strong>${C}</strong>".</p>
            <p style="font-size: 0.9rem; margin-top: 0.5rem;">Check your spelling or try another keyword.</p>
          </div>
        `;return}s.forEach(t=>{const _=document.createElement("div");_.className="card search-result-card",_.style.marginBottom="1.2rem",_.style.borderLeft=`4px solid ${t.type==="vocabulary"?"var(--color-primary)":t.type==="grammar"?"var(--color-secondary)":"var(--color-accent)"}`;const k=B(t.id);let L="";t.type==="vocabulary"?L=`
          ...
          `:t.type==="grammar"?L=`
            ...
            <div class="examples-list" style="margin-top: 1rem; border-top: 1px solid rgba(0,0,0,0.05); padding-top: 0.8rem;">
              ${t.examples.slice(0,2).map(v=>`
                <div class="example-item" style="margin-bottom: 0.5rem;">
                  <div class="example-fr" style="font-weight: 500;">➔ ${v.fr}</div>
                  <div class="example-ja" style="font-size: 0.8rem; color: var(--color-text-muted);">${v.ja}</div>
                </div>
              `).join("")}
            </div>
          `:t.type==="cuisine"&&(L=`
          ...
          `);const f=(t.tags||[]).map(v=>`<span class="tag-badge" style="background-color: rgba(197, 168, 128, 0.12); color: var(--color-accent); font-size: 0.75rem; padding: 0.2rem 0.6rem; border-radius: 20px; font-weight: 500;">#${v}</span>`).join(" ");_.innerHTML=`
          <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 1rem;">
            ...
            <button class="fav-btn ${k?"active":""}" data-id="${t.id}">
              ${k?"★":"☆"}
            </button>
          </div>
          ${L}
          ${t.tags&&t.tags.length>0?`<div style="margin-top: 1rem; display: flex; flex-wrap: wrap; gap: 0.4rem;">${f}</div>`:""}
        `,_.querySelector(".fav-btn").addEventListener("click",v=>{v.stopPropagation(),H(t.id);const h=v.target,w=B(t.id);h.classList.toggle("active",w),h.innerText=w?"★":"☆"}),c.appendChild(_)})}a.addEventListener("input",C=>{y(C.target.value)}),y("")}),e}function Ne(){const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Configuration de l'Académie",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Customize your learning goals, target CEFR levels, and database options.",e.appendChild(l);const n=document.createElement("div");n.className="card",n.style.padding="2rem";const a=g.settings;n.innerHTML=`
  ...
  `;const c=n.querySelector("#target-level-select"),y=n.querySelector("#new-cards-goal"),C=n.querySelector("#max-reviews-goal"),i=n.querySelector("#include-general-checkbox"),x=n.querySelector("#settings-status");function r(){const m=c.value,s=parseInt(y.value)||5,o=parseInt(C.value)||20,d=i.checked;Ie({targetLevel:m,newCardsPerDay:s,maxReviewsPerDay:o,includeGeneral:d}),x.style.display="block",setTimeout(()=>{x.style.display="none"},3e3)}return c.addEventListener("change",r),y.addEventListener("input",r),C.addEventListener("input",r),i.addEventListener("change",r),n.querySelector("#reset-srs-btn").addEventListener("click",()=>{confirm("Voulez-vous vraiment réinitialiser toutes vos données de progression SRS ? Cette action est irréversible.")&&(localStorage.removeItem("cba_srs"),g.srs={},alert("Spaced Repetition System progress has been reset."),window.location.reload())}),n.querySelector("#clear-favs-btn").addEventListener("click",()=>{confirm("Voulez-vous vraiment supprimer tous vos favoris ?")&&(localStorage.removeItem("cba_favorites"),g.favorites=new Set,alert("All favorites have been cleared."),window.location.reload())}),n.querySelector("#share-app-btn").addEventListener("click",()=>{const m={title:"Académie de la Brigade",text:"フランス料理・厨房フランス語の統合学習PWAアプリ「Académie de la Brigade」で一緒に料理と語学を学びましょう！",url:window.location.origin+window.location.pathname};navigator.share?navigator.share(m).then(()=>console.log("Shared successfully")).catch(s=>console.log("Error sharing:",s)):navigator.clipboard.writeText(m.url).then(()=>{alert("App link copied to clipboard! Share it with your friends.")}).catch(s=>{console.error("Failed to copy link:",s)})}),e.appendChild(n),e}function Pe(){var c;const e=document.createElement("div"),u=document.createElement("h2");u.className="section-title",u.innerText="Dictée de Cuisine (Culinary Dictations)",e.appendChild(u);const l=document.createElement("p");l.className="section-subtitle",l.innerText="Listen to French kitchen instruction sentences, type what you hear, and master French spelling.",e.appendChild(l);const n=document.createElement("div");n.className="loading-placeholder",n.innerText="Chargement de la dictée... (Loading dictation...)",e.appendChild(n);const a=((c=g.settings)==null?void 0:c.targetLevel)||"ALL";return A("vocabulary",a).then(()=>{n.remove(),De(e)}),e}function De(e){var t,_;const u=((t=g.settings)==null?void 0:t.includeGeneral)||!1,a=(((_=g.db)==null?void 0:_.vocabulary)||[]).filter(k=>u||k.is_professional).filter(k=>k.context_fr);if(a.length===0){e.innerHTML+='<p style="color: var(--color-text-muted);">Aucun exercice disponible.</p>';return}const c=[...a].sort(()=>.5-Math.random()).slice(0,5);let y=0,C=!1,i=!1,x=!1,r=0,m=1;const s=document.createElement("div");s.className="dictation-container",s.style.maxWidth="600px",s.style.margin="1.5rem auto",e.appendChild(s);function o(k){return k.toLowerCase().trim().replace(/[.,\/#!$%\^&\*;:{}=\-_`~()'"?]/g,"").replace(/\s+/g," ")}function d(k){return k.normalize("NFD").replace(/[\u0300-\u036f]/g,"")}function p(){if(s.innerHTML="",C=!1,K(),i=!1,x=!1,r=0,y>=c.length){const E=document.createElement("div");E.className="card",E.style.padding="2.5rem",E.style.textAlign="center",E.innerHTML=`
        <h3 style="font-family: var(--font-serif); font-size: 2rem; color: var(--color-primary); margin-bottom: 1rem;">Session Terminée !</h3>
      ...
      `,E.querySelector("#restart-dictation-btn").addEventListener("click",()=>{y=0,c.length=0,c.push(...[...a].sort(()=>.5-Math.random()).slice(0,5)),p()}),s.appendChild(E);return}const k=c[y],L=k.context_fr,f=document.createElement("div");f.className="card",f.style.padding="2rem",f.innerHTML=`
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; border-bottom: 1px solid rgba(0,0,0,0.05); padding-bottom: 0.8rem;">
        <span class="card-category" style="margin: 0;">Drill ${y+1} of ${c.length}</span>
    ...
    `;const v=f.querySelector("#play-pause-btn"),h=f.querySelector("#stop-btn"),w=f.querySelector("#speed-normal-btn"),S=f.querySelector("#speed-slow-btn"),j=f.querySelector("#dictation-seekbar"),b=f.querySelector("#dictation-input"),q=f.querySelector("#check-btn"),z=f.querySelector("#next-dictation-btn"),$=f.querySelector("#dictation-feedback");function N(E,R){if(!C){const P=E/R*100;j.value=Math.round(P),r=E}}function I(){i=!1,x=!1,r=0,v.innerText="▶ Play",j.value=0}function M(){ie(L,m,N,I,r)}v.addEventListener("click",()=>{C||(i?x?(x=!1,v.innerText="⏸ Pause",de()):(x=!0,v.innerText="▶ Play",le()):(i=!0,x=!1,v.innerText="⏸ Pause",M()))}),h.addEventListener("click",()=>{K(),I()}),j.addEventListener("change",E=>{if(C)return;const R=parseInt(E.target.value),P=L.replace(/["'➔]/g,"").trim();r=Math.floor(R/100*P.length);const V=P.indexOf(" ",r);V!==-1&&V-r<5&&(r=V+1),i=!0,x=!1,v.innerText="⏸ Pause",M()}),w.addEventListener("click",()=>{m!==1&&(m=1,w.classList.add("active"),w.style.backgroundColor="var(--color-primary)",w.style.color="#FFFFFF",S.classList.remove("active"),S.style.backgroundColor="transparent",S.style.color="var(--color-accent)",i&&!x&&M())}),S.addEventListener("click",()=>{m!==.75&&(m=.75,S.classList.add("active"),S.style.backgroundColor="var(--color-accent)",S.style.color="#FFFFFF",w.classList.remove("active"),w.style.backgroundColor="transparent",w.style.color="var(--color-accent)",i&&!x&&M())}),q.addEventListener("click",()=>{if(C)return;K(),I();const E=b.value,R=o(E),P=o(L),V=d(R),ce=d(P);let Q=!1,U=!1;R===P?Q=!0:V===ce&&(U=!0),$.style.display="block",b.disabled=!0,q.style.display="none",z.style.display="block",C=!0,Q?($.style.backgroundColor="#E8F5E9",$.style.borderLeft="4px solid var(--color-success)",$.style.color="var(--color-success)",$.innerHTML=`
        ...
        `)}),z.addEventListener("click",()=>{y++,p()}),s.appendChild(f),b.focus()}p()}const g={meta:null,db:{vocabulary:[],grammar:[],cuisine:[],quizzes:[]},loaded:{vocabulary:new Set,grammar:new Set,cuisine:new Set,quizzes:!1},favorites:new Set(JSON.parse(localStorage.getItem("cba_favorites")||"[]")),wrongAnswers:JSON.parse(localStorage.getItem("cba_wrong")||"[]"),streak:parseInt(localStorage.getItem("cba_streak")||"0"),lastStudyDate:localStorage.getItem("cba_last_study")||"",srs:JSON.parse(localStorage.getItem("cba_srs")||"{}"),settings:JSON.parse(localStorage.getItem("cba_settings")||JSON.stringify({targetLevel:"ALL",newCardsPerDay:5,maxReviewsPerDay:20,includeGeneral:!1}))};function H(e){g.favorites.has(e)?g.favorites.delete(e):g.favorites.add(e),localStorage.setItem("cba_favorites",JSON.stringify(Array.from(g.favorites)))}function B(e){return g.favorites.has(e)}function ne(e){g.wrongAnswers.includes(e)||(g.wrongAnswers.push(e),localStorage.setItem("cba_wrong",JSON.stringify(g.wrongAnswers)))}function He(e){g.wrongAnswers=g.wrongAnswers.filter(u=>u!==e),localStorage.setItem("cba_wrong",JSON.stringify(g.wrongAnswers))}function Re(){const e=new Date().toISOString().split("T")[0];if(g.lastStudyDate!==e){if(g.lastStudyDate){const u=new Date(g.lastStudyDate),l=new Date(e),n=Math.abs(l-u),a=Math.ceil(n/(1e3*60*60*24));a===1?g.streak+=1:a>1&&(g.streak=1)}else g.streak=1;g.lastStudyDate=e,localStorage.setItem("cba_streak",g.streak.toString()),localStorage.setItem("cba_last_study",e)}}function O(e,u){const l=new Date().toISOString().split("T")[0],n=g.srs[e]||{easiness:2.5,interval:0,repetitions:0,dueDate:l};let a=Math.max(0,Math.min(5,u));a>=3?(n.repetitions===0?n.interval=1:n.repetitions===1?n.interval=6:n.interval=Math.round(n.interval*n.easiness),n.repetitions++):(n.repetitions=0,n.interval=1),n.easiness=n.easiness+(.1-(5-a)*(.08+(5-a)*.02)),n.easiness<1.3&&(n.easiness=1.3);const c=new Date;c.setDate(c.getDate()+n.interval),n.dueDate=c.toISOString().split("T")[0],n.lastRated=l,g.srs[e]=n,localStorage.setItem("cba_srs",JSON.stringify(g.srs))}function Ie(e){g.settings={...g.settings,...e},localStorage.setItem("cba_settings",JSON.stringify(g.settings))}async function A(e,u){const l=u==="ALL"?["A1","A2","B1","B2","C1","C2"]:[u];for(const n of l)if(!g.loaded[e].has(n))try{const a=await fetch(`data/${e}_${n}.json`);if(!a.ok){console.warn(`Could not load data/${e}_${n}.json`);continue}const c=await a.json(),y=new Set(g.db[e].map(C=>C.id));for(const C of c)y.has(C.id)||g.db[e].push(C);g.loaded[e].add(n)}catch(a){console.error(`Failed to load ${e} level ${n}:`,a)}}async function se(){if(!g.loaded.quizzes)try{const e=await fetch("data/quizzes.json");if(!e.ok)throw new Error("Network response was not ok");g.db.quizzes=await e.json(),g.loaded.quizzes=!0}catch(e){console.error("Failed to load quizzes:",e)}}async function J(){await Promise.all([A("vocabulary","ALL"),A("grammar","ALL"),A("cuisine","ALL"),se()])}const re={home:ue,vocabulary:me,grammar:ge,cuisine:je,quiz:Ee,favorites:G,review:Me,search:Be,settings:Ne,dictation:Pe};function oe(e){const u=document.getElementById("main-content");if(re[e]){Re(),u.innerHTML="";const l=re[e]();l instanceof HTMLElement?u.appendChild(l):u.innerHTML=l,document.querySelectorAll(".nav-link").forEach(n=>{n.getAttribute("data-tab")===e?n.classList.add("active"):n.classList.remove("active")})}}async function Ve(){try{const e=await fetch("data/meta.json");g.meta=await e.json(),document.querySelectorAll(".nav-link").forEach(u=>{u.addEventListener("click",l=>{const n=l.target.closest(".nav-link").getAttribute("data-tab");oe(n)})}),oe("home")}catch(e){console.error("Failed to load database metadata:",e),document.getElementById("main-content").innerHTML=`
