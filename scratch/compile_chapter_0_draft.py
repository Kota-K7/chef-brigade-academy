...
ep1_part1_pages = [
    {
        "title": "基本語順と平叙文・否定文の作り方",
        "referenceTopicId": "ref_sentence_structure",
        "sectionIndices": [0, 1, 2]
    },
    {
        "title": "基本の平叙文 (自己紹介・出身)",
        "type": "custom",
        "text": "être や venir を使った、自己紹介や出身を表すもっとも基本的な平叙文（肯定文）です。",
        "headers": ["フランス語", "意味", "文法ポイント"],
        "rows": [
